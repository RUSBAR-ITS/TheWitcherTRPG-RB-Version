...
Команды pack/extract относятся также к packsJson/combat; сборка/извлечение не выполнялись. Изолированные Node-сценарии использовали установленное ядро и существующие зависимости без установки пакетов или изменения репозитория.
