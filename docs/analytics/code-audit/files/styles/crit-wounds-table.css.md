...
[54](../../../../issues/closed/issue-00054.md) дополнена: дублирование сохраняется независимо от старых табличных CSS-правил. Отсутствующие HTML-потребители и неиспользуемые правила не зарегистрированы отдельными проблемами.
...
Текущая вкладка содержит partial травм и повторный цикл; CSS оформляет обе строки, не создаёт второй Item. Старые селекторы .crit-wounds-table не совпадают с текущей div-разметкой. Две important-ширины относятся к полям, а не ограничениям лечения/дней. Дублирование00054 принадлежит HBS, не обработчику CSS.

Сопоставленные определения и потребители: [templates/sheets/actor/partials/character/tab-effects.hbs](../templates/sheets/actor/partials/character/tab-effects.hbs.md), [templates/partials/crit-wounds-table.hbs](../templates/partials/crit-wounds-table.hbs.md), [templates/sheets/item/criticalWound-sheet.hbs](../templates/sheets/item/criticalWound-sheet.hbs.md).
