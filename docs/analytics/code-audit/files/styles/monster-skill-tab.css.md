...
Текущая статическая сверка завершена; прежние пофайловые опыты сохраняют свои даты и фасады. Текущий Monster использует общий Character skills partial. td span не охватывает одинаково normal и custom skill, если различаются a/span; старые skill-list не считаются единственным действующим путём. Непроверенные границы и следующий критерий: [U016-05](../../cross-check-0002.md#u016-05). Полный браузерный цикл, мир, HTTP и запись в БД не выполнялись; смысл перевода/игровых правил не оценивался.

## Связанные проблемы

[issue-00018](../../../../issues/potential/issue-00018.md), [issue-00187](../../../../issues/closed/issue-00187.md), [issue-00192](../../../../issues/closed/issue-00192.md). Связь с конкретным условием, шаблоном или каскадом описана выше. Статусы остаются potential; CSS-анализ не подтверждает исправление или закрытие.
...
Текущий Monster использует общий Character skills partial. td span не охватывает одинаково normal и custom skill, если различаются a/span; старые skill-list не считаются единственным действующим путём. Подключение: импорт № 10 в общем CSS; 7 правил / 22 деклараций.
