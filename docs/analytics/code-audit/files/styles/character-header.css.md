...
Текущая статическая сверка завершена; прежние пофайловые опыты сохраняют свои даты и фасады. 128 правил / 352 декларации обслуживают не только header Character, но и общие ресурсы/sidebar обоих Actor. current healthState checkbox-slider сопоставлен с named-полями; старые right-* не приняты за текущие PARTS. Непроверенные границы и следующий критерий: [U016-05](../../cross-check-0002.md#u016-05). Полный браузерный цикл, мир, HTTP и запись в БД не выполнялись; смысл перевода/игровых правил не оценивался.

## Связанные проблемы

[issue-00187](../../../../issues/closed/issue-00187.md), [issue-00198](../../../../issues/potential/issue-00198.md), [issue-00199](../../../../issues/potential/issue-00199.md), [issue-00202](../../../../issues/potential/issue-00202.md), [issue-00203](../../../../issues/closed/issue-00203.md), [issue-00205](../../../../issues/closed/issue-00205.md). Связь с конкретным условием, шаблоном или каскадом описана выше. Статусы остаются potential; CSS-анализ не подтверждает исправление или закрытие.
...
128 правил / 352 декларации обслуживают не только header Character, но и общие ресурсы/sidebar обоих Actor. current healthState checkbox-slider сопоставлен с named-полями; старые right-* не приняты за текущие PARTS. Подключение: импорт № 1 в общем CSS; 128 правил / 352 деклараций.

Сопоставленные определения и потребители: [templates/partials/character-header.hbs](../templates/partials/character-header.hbs.md), [templates/sheets/actor/partials/character/sidebar.hbs](../templates/sheets/actor/partials/character/sidebar.hbs.md), [lang/en.json](../lang/en.json.md), [lang/ru.json](../lang/ru.json.md), [styles/witcher-styles.css](witcher-styles.css.md).

[Протокол и границы](../../review-log.md#task-0004016) — TASK-0004.016; процессы [R016-15](../../cross-check-0002.md#r016-15). В этой порции выполнена статическая сверка; прежние опыты сохраняют свои даты и фасады. Новых поведенческих запусков нет; браузер, мир, сеть и запись в БД не запускались.
