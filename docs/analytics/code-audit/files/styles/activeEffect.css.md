...
[56](../../../../issues/closed/issue-00056.md) уточнена: описание Item скрывает общий .invisible; данный CSS не добавляет отсутствующий listener. [54](../../../../issues/closed/issue-00054.md) относится к соседнему списку травм, не к повторной отрисовке эффектов. Новых issues нет.
...
Общий effect-part создаёт .effects/.effect-row/.effect-display и имя в p; селектор .effect-name > h4 не адресует это имя. Сетка/отступы не определяют phase/target/операцию эффекта. Скрытие description обеспечивает .invisible из system-styles, переключение на Actor — listener примеси.

Сопоставленные определения и потребители: [templates/partials/effect-part.hbs](../templates/partials/effect-part.hbs.md), [module/actor/sheets/mixins/activeEffectMixin.js](../module/actor/sheets/mixins/activeEffectMixin.js.md), [styles/system-styles.css](system-styles.css.md).
