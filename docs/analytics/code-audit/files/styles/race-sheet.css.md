...
Правило .perk .editor-content задаёт height150px внутри особенности. .perk создают Item race-sheet и Actor tab-profession, а editor-content у текущего prose-mirror добавляет ядро динамически. Поэтому отсутствие буквального класса в Item HBS не доказывает отсутствие потребителя; настоящий _buildElements проверялся в .047 с фасадом DOM.

Сопоставленные определения и потребители: [templates/sheets/item/race-sheet.hbs](../templates/sheets/item/race-sheet.hbs.md), [templates/partials/character/tab-profession.hbs](../templates/partials/character/tab-profession.hbs.md).
