...
Текущая статическая сверка завершена; прежние пофайловые опыты сохраняют свои даты и фасады. Три секции inventory сопоставлены с актуальным partial; две active в разметке отмечены в прежнем структурном опыте. Ширина export 100% действует внутри inventory, не на header export. Непроверенные границы и следующий критерий: [U016-05](../../../cross-check-0002.md#u016-05). Полный браузерный цикл, мир, HTTP и запись в БД не выполнялись; смысл перевода/игровых правил не оценивался.

## Связанные проблемы

[issue-00177](../../../../../issues/potential/issue-00177.md), [issue-00206](../../../../../issues/closed/issue-00206.md), [issue-00207](../../../../../issues/closed/issue-00207.md), [issue-00208](../../../../../issues/closed/issue-00208.md). Связь с конкретным условием, шаблоном или каскадом описана выше. Статусы остаются potential; CSS-анализ не подтверждает исправление или закрытие.
...
Три секции inventory сопоставлены с актуальным partial; две active в разметке отмечены в прежнем структурном опыте. Ширина export 100% действует внутри inventory, не на header export. Подключение: импорт № 31 в общем CSS; 4 правил / 4 деклараций.
