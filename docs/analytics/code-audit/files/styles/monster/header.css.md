...
Текущая статическая сверка завершена; прежние пофайловые опыты сохраняют свои даты и фасады. Текущий .monster-header и его actions/125px параметры отделены от старого .monster-header-center. Конфигурационный лист без класса monster не удовлетворяет этому scope. Непроверенные границы и следующий критерий: [U016-04](../../../cross-check-0002.md#u016-04). Полный браузерный цикл, мир, HTTP и запись в БД не выполнялись; смысл перевода/игровых правил не оценивался.
...
Текущий .monster-header и его actions/125px параметры отделены от старого .monster-header-center. Конфигурационный лист без класса monster не удовлетворяет этому scope. Подключение: импорт № 30 в общем CSS; 12 правил / 33 деклараций.
