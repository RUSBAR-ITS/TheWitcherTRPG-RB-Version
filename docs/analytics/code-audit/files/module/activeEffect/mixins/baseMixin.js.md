...
Применимость произвольной операции/поля и внешних расширений — [U005-05](../../../../cross-check-0002.md#u005-05); условия конкретных атак/магии/урона — [U005-04](../../../../cross-check-0002.md#u005-04). Прежняя пометка о ещё не прочитанных целиком боевых mixin снята.
...
Восемь методов создают подсказки, а не правила применения. statMap задаёт origin и totalModifiers, skillMap — activeEffectModifiers; группы сериализуются списком путей через запятую. Два lifepath.attacks пути ведут в SchemaField, три damage-поля имеют разные типы, commonspeech не соответствует commonsp модели. Наличие варианта в select не гарантирует пригодность ADD для его поля. Полные пофайловые описания боевых потребителей уже завершены; новые сквозные границы закреплены за .009/.010/.011.

Сопоставленные определения и потребители: [module/setup/config.js](../../setup/config.js.md), [module/data/actor/templates/common/lifepathData.js](../../data/actor/templates/common/lifepathData.js.md), [module/data/actor/templates/common/skills/skillData.js](../../data/actor/templates/common/skills/skillData.js.md), [module/activeEffect/WitcherActiveEffectSheet.js](../WitcherActiveEffectSheet.js.md).

[Протокол и границы](../../../../review-log.md#task-0004005) — TASK-0004.005; процессы [R005-02](../../../../cross-check-0002.md#r005-02), [R005-05](../../../../cross-check-0002.md#r005-05), [R005-06](../../../../cross-check-0002.md#r005-06). В этой порции выполнена статическая сверка; поведенческие опыты принадлежат датированным прежним протоколам, а не новому прогону.
