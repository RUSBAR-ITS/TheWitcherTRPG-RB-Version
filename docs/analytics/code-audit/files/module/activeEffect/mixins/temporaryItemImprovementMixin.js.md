...
Все варианты строковых формул не исполнялись; передачу source/system, поле и последующий урон разделяют [U005-04](../../../../cross-check-0002.md#u005-04)/[U005-05](../../../../cross-check-0002.md#u005-05).

## Связанные проблемы

Собственная ошибка трёх путей не выявлена. Применение связано с [issue-00042](../../../../../../issues/closed/issue-00042.md) и [issue-00050](../../../../../../issues/closed/issue-00050.md); мастер — с [issue-00052](../../../../../../issues/closed/issue-00052.md).
...
Три значения мастера — system.damage, system.damageProperties.oilEffect и silverDamage — разрешаются в StringField WeaponData. Они не являются числовыми характеристиками и не определяют порядок математических операций: обычный ADD строки склеивает текст, итоговую формулу читает потребитель оружия. Выбор этого каталога определяется type temporaryItemImprovement; передача и Item-применение выполняются другими файлами.

Сопоставленные определения и потребители: [module/activeEffect/WitcherActiveEffectSheet.js](../WitcherActiveEffectSheet.js.md), [module/data/item/weaponData.js](../../data/item/weaponData.js.md), [module/data/item/templates/combat/damagePropertiesData.js](../../data/item/templates/combat/damagePropertiesData.js.md), [module/actor/mixins/temporaryEffectMixin.js](../../actor/mixins/temporaryEffectMixin.js.md).

[Протокол и границы](../../../../review-log.md#task-0004005) — TASK-0004.005; процессы [R005-02](../../../../cross-check-0002.md#r005-02), [R005-05](../../../../cross-check-0002.md#r005-05), [R005-08](../../../../cross-check-0002.md#r005-08). В этой порции выполнена статическая сверка; поведенческие опыты принадлежат датированным прежним протоколам, а не новому прогону.
