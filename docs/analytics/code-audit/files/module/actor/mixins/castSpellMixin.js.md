...
2026-09-19, TASK-0011.007. castSpell ожидает update STA; отменённая запись прекращает действие до броска. После roll.toMessage сохраняет полученный ChatMessage, при !fumble передаёт все self-статусы/applySelf AE/onCastEffects/applyOnTarget AE через **collectSpellEffects → createEffectDelivery** из [effectDelivery.js](../../../../../../../module/scripts/effectDelivery.js). Прямые вызовы четырёх старых обёрток удалены. Новая карточка получает исходные raw duration и выбранных Actor; повтор не вызывает castSpell. Ошибка карточки предупреждает и сохраняет возврат исходного Roll. createSpellRegion остаётся отдельным optional вызовом без await, вне повторной отправки. Компенсация EV из .005 и формулы прежние.

[Проверки](../../../../../task-0011-static-checks.md#task-0011007): реальный castSpell/нативный Roll в локальном harness, хранилище/сеть/DOM заменены; B07 впереди. Следующие датированные разделы — история, прежние утверждения о четырёх независимых вызовах и неожидаемом STA заменены этим разделом.

## Текущее состояние — 14.3.1.00105

2026-09-19, TASK-0011.005. После getArmorEcumbrance компенсация вычисляется min(EV,max(0,ignoredEvWhenCasting)); в формуле −EV + только ограниченная компенсация. Общая ignoredArmorEncumbrance уже учтена один раз в Actor. EV0 не даёт бонуса, EV1/ignore3 даёт0; manual/optional и prepareCheck прежние. Подписи существующими ключами локализации, затраты/доставка не менялись.
...
2026-09-18. **Назначение:** Бросок заклинания и доставка его эффектов.

**Методы, сущности, действия и зависимости:** Текущий parser текста сохранён: извлечённые цифры превращаются в Number, пустой результат остаётся отсутствующим; validateEffectDuration проверяет значение до ChatMessage. AE self/target ожидаются. Разбор единиц текста, статусы и temporaryHP не рефакторились.
...
**14.3.1.00066, TASK-0010.008.** getUsedSkill определяет actual builtin key/характеристику. prepareCheck(action attack,manual) после исходного диалога и до расхода STA/длительности/доставки. Сохраняет EV и прочие обстоятельства, без повторного manual. Остальные payload/region/доставка .009 и known variable heal не изменены.

[Исходник](../../../../../../../module/actor/mixins/castSpellMixin.js); [проверка и пределы](../../../../../task-0010-008-checks.md).
...
- `162`: `templateInfo.spellSource = spellItem.system.source ? 'WITCHER.Spell.' + (spellItem.system.source === 'Water' ? 'water' : spellItem.system.source) : null;`
...
Исходник и указанные связи сопоставлены в TASK-0004.009. Полное тело castSpell уже исследовано в .039, а не оставлено будущей порцией. Не проверены общий lifecycle Actor/ChatMessage/AE, запись ресурсов и реальная доставка/область. Остаток: [U009-02](../../../../cross-check-0002.md#u009-02), [U009-03](../../../../cross-check-0002.md#u009-03), [U009-04](../../../../cross-check-0002.md#u009-04), [U009-08](../../../../cross-check-0002.md#u009-08). Новых поведенческих запусков нет; прежние протоколы сохраняют даты и фасады.

## Связанные проблемы

[issue-00003](../../../../../../issues/potential/issue-00003.md), [issue-00008](../../../../../../issues/potential/issue-00008.md), [issue-00009](../../../../../../issues/potential/issue-00009.md), [issue-00033](../../../../../../issues/closed/issue-00033.md), [issue-00044](../../../../../../issues/closed/issue-00044.md), [issue-00064](../../../../../../issues/potential/issue-00064.md), [issue-00128](../../../../../../issues/potential/issue-00128.md), [issue-00133](../../../../../../issues/potential/issue-00133.md), [issue-00134](../../../../../../issues/potential/issue-00134.md), [issue-00135](../../../../../../issues/potential/issue-00135.md), [issue-00137](../../../../../../issues/closed/issue-00137.md), [issue-00138](../../../../../../issues/potential/issue-00138.md), [issue-00139](../../../../../../issues/potential/issue-00139.md), [issue-00142](../../../../../../issues/potential/issue-00142.md), [issue-00146](../../../../../../issues/potential/issue-00146.md), [issue-00186](../../../../../../issues/closed/issue-00186.md), [issue-00245](../../../../../../issues/potential/issue-00245.md), [issue-00246](../../../../../../issues/potential/issue-00246.md), [issue-00247](../../../../../../issues/potential/issue-00247.md), [issue-00248](../../../../../../issues/potential/issue-00248.md), [issue-00249](../../../../../../issues/potential/issue-00249.md), [issue-00250](../../../../../../issues/potential/issue-00250.md), [issue-00251](../../../../../../issues/potential/issue-00251.md), [issue-00252](../../../../../../issues/potential/issue-00252.md), [issue-00253](../../../../../../issues/potential/issue-00253.md), [issue-00254](../../../../../../issues/closed/issue-00254.md). Все регистрации остаются potential. Ранние проблемы областей/длительности не переименованы в новые; новая карточка ожидания относится к собственному castSpell.
...
Сотворение прослежено от useItem и getUsedSkill до прямых эффектов и Region. Различены подготовленный WILL/навык, компенсация EV, оплаченная STA и origStaCost, формула, сырые damage и очищаемая схема сообщения. STA update вызывается до разбора duration/variable heal; HBS готовится до броска, Region вызывается после сообщения до fumble guard, статусы/AE — после guard. Не ожидаемые записи и потеря onCastEffects у Hex/Ritual остаются отдельными причинами; показ кнопок не является проверкой успеха.

Сопоставленные определения и потребители: [module/chatMessage/chatMessageData.js](../../chatMessage/chatMessageData.js.md), [module/scripts/temporaryEffects/applyActiveEffect.js](../../scripts/temporaryEffects/applyActiveEffect.js.md), [module/scripts/statusEffects/applyStatusEffect.js](../../scripts/statusEffects/applyStatusEffect.js.md), [module/scripts/rollConfig.js](../../scripts/rollConfig.js.md), [module/scripts/rolls/extendedRoll.js](../../scripts/rolls/extendedRoll.js.md), [module/item/mixins/damageUtilMixin.js](../../item/mixins/damageUtilMixin.js.md), [module/item/witcherItem.js](../../item/witcherItem.js.md), [module/data/item/spellData.js](../../data/item/spellData.js.md), [module/data/item/hexData.js](../../data/item/hexData.js.md), [module/data/item/ritualData.js](../../data/item/ritualData.js.md), [module/data/actor/commonActorData.js](../../data/actor/commonActorData.js.md), [module/data/actor/templates/common/focusData.js](../../data/actor/templates/common/focusData.js.md), [module/data/actor/templates/common/skills/willData.js](../../data/actor/templates/common/skills/willData.js.md), [module/data/actor/templates/common/lifepathData.js](../../data/actor/templates/common/lifepathData.js.md), [module/actor/mixins/modifierMixin.js](modifierMixin.js.md), [module/actor/mixins/armorMixin.js](armorMixin.js.md), [module/actor/mixins/locationMixin.js](locationMixin.js.md), [module/actor/witcherActor.js](../witcherActor.js.md), [module/data/item/templates/combat/damagePropertiesData.js](../../data/item/templates/combat/damagePropertiesData.js.md), [module/data/item/templates/itemEffectData.js](../../data/item/templates/itemEffectData.js.md), [module/data/item/mixin/spellRegionMixin.js](../../data/item/mixin/spellRegionMixin.js.md), [templates/dialog/combat/spell-attack.hbs](../../../templates/dialog/combat/spell-attack.hbs.md), [templates/chat/combat/spellItem.hbs](../../../templates/chat/combat/spellItem.hbs.md), [module/setup/config.js](../../setup/config.js.md), [module/setup/settings.js](../../setup/settings.js.md), [module/data/chatMessage/attackMessageData.js](../../data/chatMessage/attackMessageData.js.md), [module/data/chatMessage/templates/damageData.js](../../data/chatMessage/templates/damageData.js.md), [module/scripts/chat.js](../../scripts/chat.js.md), [module/scripts/combat/combat.js](../../scripts/combat/combat.js.md), [module/actor/mixins/defenseMixin.js](defenseMixin.js.md), [lang/en.json](../../../lang/en.json.md), [lang/ru.json](../../../lang/ru.json.md), [module/actor/sheets/mixins/itemMixin.js](../sheets/mixins/itemMixin.js.md).

[Протокол и границы](../../../../review-log.md#task-0004009) — TASK-0004.009; процессы [R009-07](../../../../cross-check-0002.md#r009-07), [R009-08](../../../../cross-check-0002.md#r009-08), [R009-09](../../../../cross-check-0002.md#r009-09), [R009-10](../../../../cross-check-0002.md#r009-10), [R009-11](../../../../cross-check-0002.md#r009-11), [R009-12](../../../../cross-check-0002.md#r009-12), [R009-13](../../../../cross-check-0002.md#r009-13), [R009-14](../../../../cross-check-0002.md#r009-14). В этой порции выполнена статическая сверка; прежние опыты сохраняют свои даты и фасады. Новых поведенческих запусков нет; браузер, мир, сеть и запись в БД не запускались.
