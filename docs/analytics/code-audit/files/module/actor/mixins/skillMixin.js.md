...
Подготовка характеристик разобрана в .003, прямые формулы и цена — в .029 и этой сверке. Полные бой/эффекты требуют [U004-02](../../../../cross-check-0002.md#u004-02)/[U004-07](../../../../cross-check-0002.md#u004-07); запись IP и конкурентные клиенты — [U004-04](../../../../cross-check-0002.md#u004-04). Правило максимума навыка и допустимость отрицательных IP аудит не устанавливает.
...
Сопоставлены четыре разных адреса: ключ skillMap, entry.name в system.skills, Item.id из DOM и произвольное Item.name. Встроенный бросок берёт подготовленную характеристику и базовый уровень, затем отдельные добавки; собственного потолка/округления здесь нет. commonspeech/commonsp расходятся на lookup и на повторном вызове addActiveEffects. Прямой custom-бросок игнорирует Item.activeEffectModifiers и использует имя как встроенный ключ. levelUpSkill расходует IP через настоящий Log и отдельный update: затенённый magicalCost создаёт конфликт payload, а ни один запрос не ожидается. Применены .029 группы03–12 и M07 промежуточной сверки; новой записи Actor не выполнялось.

Сопоставленные определения и потребители: [module/setup/config.js](../../setup/config.js.md), [module/actor/mixins/modifierMixin.js](modifierMixin.js.md), [module/data/actor/templates/character/logData.js](../../data/actor/templates/character/logData.js.md), [module/data/item/skillItemData.js](../../data/item/skillItemData.js.md), [module/scripts/investigation/rollClue.js](../../scripts/investigation/rollClue.js.md).

[Протокол и границы](../../../../review-log.md#task-0004004) — TASK-0004.004; процессы [R004-01](../../../../cross-check-0002.md#r004-01), [R004-02](../../../../cross-check-0002.md#r004-02), [R004-07](../../../../cross-check-0002.md#r004-07), [R004-09](../../../../cross-check-0002.md#r004-09), [R004-12](../../../../cross-check-0002.md#r004-12). В этой порции выполнена статическая сверка; поведенческие опыты принадлежат датированным прежним протоколам, а не новому прогону.
