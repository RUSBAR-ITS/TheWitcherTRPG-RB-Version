...
2026-09-20, dev. updateDerivedStat выполняет одну withParameterChanges: сначала запоминает текущий ресурс, для hp расходует spendTemporaryHp, затем вычитает только остаток. Обычные ресурсы сохраняют прежний путь. Старый перебор Actor.temporaryEffects/всех строк с JSON.parse заменён точным сборщиком source.

Связанные потребители/границы: temporaryHp, parameterPersistence. Статические проверки выполнены; браузер и БД не запускались. [Исходник](../../../../../../../module/actor/mixins/damageMixin.js) · [TASK-0012](../../../../../../tasks/task-0012-temporary-hp.md) · [Проверки](../../../../../task-0012-checks.md).
...
2026-09-19. applyDamage принимает необязательный пятый message для видимости/ссылки последствия. После прежнего численного урона Item AE идут в createItemEffectDelivery(applyOnDamage, damageObject.duration). Повторяет только сохранённый AE-пакет, не HP/STA/щит/броню. Независимые статусы properties.effects сохраняют прежний путь и не повторяются карточкой. Методы расчёта, щит, отчёт и фоновые записи здесь не перерабатывались.
...
2026-09-18. **Назначение:** Применение урона и эффектов после урона.

**Методы, сущности, действия и зависимости:** applyDamage ожидает applyActiveEffectToActorViaId для applyOnDamage, передавая duration после чтения сообщения. Расчёт урона/броня/статусы не изменялись.
...
Прежние: [00023](../../../../../../issues/closed/issue-00023.md), [00025](../../../../../../issues/potential/issue-00025.md), [00026](../../../../../../issues/potential/issue-00026.md), [00027](../../../../../../issues/potential/issue-00027.md), [00032](../../../../../../issues/potential/issue-00032.md), [00043](../../../../../../issues/closed/issue-00043.md), [00073](../../../../../../issues/potential/issue-00073.md), [00117](../../../../../../issues/closed/issue-00117.md), [00257](../../../../../../issues/closed/issue-00257.md), [00258](../../../../../../issues/closed/issue-00258.md), [00280](../../../../../../issues/potential/issue-00280.md), [00282](../../../../../../issues/potential/issue-00282.md), [00283](../../../../../../issues/potential/issue-00283.md).

Новые: [00284](../../../../../../issues/potential/issue-00284.md) обход щита; [00285](../../../../../../issues/potential/issue-00285.md) общие экземпляры локаций; [00286](../../../../../../issues/potential/issue-00286.md) отсутствующий тип flat/oil; [00287](../../../../../../issues/potential/issue-00287.md) контекст сообщений; [00288](../../../../../../issues/closed/issue-00288.md) повтор травмы; [00289](../../../../../../issues/closed/issue-00289.md) незавершённый выбор травмы; [00290](../../../../../../issues/potential/issue-00290.md) эффекты при полном SP; [00291](../../../../../../issues/potential/issue-00291.md) отрицательный урон и щит; [00292](../../../../../../issues/potential/issue-00292.md) повторный расход прежнего щита; [00294](../../../../../../issues/closed/issue-00294.md) объект value после миграции.
...
Повторный applyCritWound на очищенном индексе всех 94 Item проверен для 48 сочетаний: четыре уровня × шесть обычных локаций × critEffect 4/6. В [Deadly](../../../packsJson/criticalWounds/Deadly_uofXQEP6HBtekOAO/_Folder.json.md): head выбирает Eye/Decapitation, torso — Spetic/Heart; у четырёх конечностей одна исходная запись, lesserEffect не влияет. Для tailWing в каждом уровне пустой список заканчивается TypeError до addItem ([issue-00289](../../../../../../issues/closed/issue-00289.md)). Ошибочные Complex-кандидаты и зависимость torso от порядка индекса остались [issue-00324](../../../../../../issues/closed/issue-00324.md); это свойства данных/потребителя, а не чтение текстовых Combat Critical.
