...
#exportLoot импортирует parseItemQuantity/parseLootQuantityFormula из module/data/item/commonItemData.js. До создания папки/loot Actor проверяет quantity и синтаксис формулы у моделей с quantity. Пустая формула: quantity×multiplier; непустая: независимые броски, Math.floor каждого неотрицательного конечного результата, затем сумма. Обычные исходные стопки обрабатываются до генераторов, полученные из таблиц Items повторно не обрабатываются.

Ветка not-found у WitcherItem.checkIfItemHasRollTable сохраняет числовой quantity и очищает lootQuantityFormula; no-op разрешён лишь при совпадении обоих исходных полей. Нужная неподтверждённая запись остаётся ошибкой, сохраняется частичный результат без повторов/отката. Исходный монстр не меняется; модели без quantity копируются без вычисления количества.
...
[Согласование и 6/6 изолированных проверок](../../../../../../issues/closed/issue-00207.md#noop-fix); [игровая приёмка .00030](../../../../../../issues/closed/issue-00207.md#acceptance-00030) пройдена после перезапуска. Остальные методы не менялись; исторические записи ниже относятся к своим версиям.
...
static #exportLoot обрабатывает снимок исходных Items. Сначала нормализует обычные стопки, затем генераторы: multiplier не должен повторно умножить уже выданные предметы. Каждый helper/update ожидается; fallback количества разрешён только для not-found. При failed/partial цикл прекращается с отчётом, сохранённая часть остаётся для проверки; render листа выполняется после цикла. Новые Items не обходятся как генераторы. Это последовательность одного экспорта, не транзакция и не защита от двух клиентов.

Непосредственные зависимости и потребители: [module/item/witcherItem.js](../../../../../../../module/item/witcherItem.js), [lang/ru.json](../../../../../../../lang/ru.json), [lang/en.json](../../../../../../../lang/en.json).
...
Включённый общий tab-effects теперь выводит один список травм с enriched-описанием. Категоризатор базового листа исключает повтор UUID; Item-конфигурация имеет отдельное действие описания. Собственный класс не менялся. См. [issue-00334](../../../../../../issues/closed/issue-00334.md). Статическая сверка дополнена приёмкой .00022 в связанной issue-00334. Для V1 проверен прямой вызов общей примеси; регистрации и открытия старого листа не было.
...
[issue-00004](../../../../../../issues/closed/issue-00004.md), [issue-00013](../../../../../../issues/potential/issue-00013.md), [issue-00018](../../../../../../issues/potential/issue-00018.md), [issue-00030](../../../../../../issues/potential/issue-00030.md), [issue-00032](../../../../../../issues/potential/issue-00032.md), [issue-00039](../../../../../../issues/closed/issue-00039.md), [issue-00040](../../../../../../issues/closed/issue-00040.md), [issue-00167](../../../../../../issues/closed/issue-00167.md), [issue-00177](../../../../../../issues/potential/issue-00177.md), [issue-00180](../../../../../../issues/potential/issue-00180.md), [issue-00192](../../../../../../issues/closed/issue-00192.md), [issue-00199](../../../../../../issues/potential/issue-00199.md), [issue-00203](../../../../../../issues/closed/issue-00203.md), [issue-00205](../../../../../../issues/closed/issue-00205.md), [issue-00206](../../../../../../issues/closed/issue-00206.md), [issue-00207](../../../../../../issues/closed/issue-00207.md), [issue-00208](../../../../../../issues/closed/issue-00208.md), [issue-00209](../../../../../../issues/potential/issue-00209.md). Прежние наблюдения дополнены по фактическим маршрутам. Новые остаются potential; игровые правила и код не изменялись.
