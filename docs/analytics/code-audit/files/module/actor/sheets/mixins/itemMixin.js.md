...
| [templates/sheets/actor/partials/character/inventory/tab-inventory-armors.hbs](../../../../../../../../templates/sheets/actor/partials/character/inventory/tab-inventory-armors.hbs) | Equip/Message/Enhancement | data-type=armor; freeEnhancements имеет класс enhancement-weapon-slot | Решение о типе берётся из data-type, поэтому имя CSS-класса само по себе не выбирает weapon |
