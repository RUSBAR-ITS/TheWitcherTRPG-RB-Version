...
| --- | --- | --- | --- |
| Функции и подключения | 42 строки полностью; поиск импортов и четырёх селекторов | 3 метода; два базовых листа и конфигурация; CharacterSheet использует сумму | Класс конфигурации целиком оставлен TASK-0003.030 |
