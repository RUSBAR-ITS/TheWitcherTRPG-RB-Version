...
Спасброски восьми характеристик используют value, удачи — max; это порог reversal, а не слагаемое броска. Репутация использует value; сумма характеристик складывает девять max без toxicity. Luck reset копирует фактический max, включая прежний двойной вклад 00012. Убывание удачи/адреналина ждёт update, плюс адреналина — нет. SavingThrow отсутствует только в ru после expandObject (актуальная 00193); семь старых заголовков навыков не являются пропусками.

Сопоставленные определения и потребители: [module/actor/witcherActor.js](../../witcherActor.js.md), [module/data/actor/commonActorData.js](../../../data/actor/commonActorData.js.md), [module/scripts/rolls/extendedRoll.js](../../../scripts/rolls/extendedRoll.js.md), [module/scripts/helper.js](../../../scripts/helper.js.md), [module/scripts/rollConfig.js](../../../scripts/rollConfig.js.md), [templates/partials/character/tab-stats.hbs](../../../../templates/partials/character/tab-stats.hbs.md).
