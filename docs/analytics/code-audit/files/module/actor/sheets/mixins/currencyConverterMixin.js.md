...
Обработчик V2-action конвертера валют. Изменение 2026-09-17 по [issue-00334](../../../../../../../issues/closed/issue-00334.md); основание — исходники, а не новая браузерная приёмка.
...
[issue-00230](../../../../../../../issues/closed/issue-00230.md). Потенциальный повторный listener отделён от same-currency и конкурирующих записей кошелька. Код не исправлялся.
