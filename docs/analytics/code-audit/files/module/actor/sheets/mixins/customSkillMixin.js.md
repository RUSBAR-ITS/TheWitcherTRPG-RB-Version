...
Отсутствие текущих кнопок CRUD не доказывает отсутствие внешних callers. Сохранение Item и расширения модели — [U004-03](../../../../../cross-check-0002.md#u004-03); браузерные повторные listeners — [U004-01](../../../../../cross-check-0002.md#u004-01). Удаление последней строки при неизвестном id проверялось только на массиве, явно внедрённом в обход схемы.

## Связанные проблемы

[issue-00187](../../../../../../../issues/closed/issue-00187.md), [issue-00189](../../../../../../../issues/potential/issue-00189.md). Ошибка текущего DOM и рассогласование старого CRUD со схемой разделены; оба наблюдения остаются potential.
...
Шесть регистраций сверены с двумя вариантами HBS. Локальный html=$(html) не меняет глобальный jQuery; .item/itemId есть в старом monster partial, но отсутствует в текущем character partial. isOpened является полем SkillItemData; modifiers — нет. Добавление не создаёт id, удаление неизвестного id использует −1, редактирование берёт строку. Это результаты вызываемых методов из .029 групп15–16, а не доступные кнопки современного листа. update/delete не включены в завершение обработчиков.

Сопоставленные определения и потребители: [module/actor/mixins/skillMixin.js](../../mixins/skillMixin.js.md), [module/data/item/skillItemData.js](../../../data/item/skillItemData.js.md), [templates/partials/character/custom-skill-display.hbs](../../../../templates/partials/character/custom-skill-display.hbs.md), [templates/partials/monster/monster-custom-skill-display.hbs](../../../../templates/partials/monster/monster-custom-skill-display.hbs.md).
