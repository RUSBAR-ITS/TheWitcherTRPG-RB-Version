...
[Исходник](../../../../../../../module/actor/sheets/WitcherCharacterSheet.js); [проверка и пределы](../../../../../task-0010-008-checks.md).
...
| alchemyMixin._prepareAlchemyComponentsList | [module/actor/sheets/mixins/alchemyMixin.js](../../../../../../../module/actor/sheets/mixins/alchemyMixin.js) | named import, Object.assign | Девять иконок/ключей/количеств | 5, 131, 481; полная карточка и сверка выполнены в .034 |
...
[issue-00015](../../../../../../issues/closed/issue-00015.md), [issue-00024](../../../../../../issues/potential/issue-00024.md), [issue-00028](../../../../../../issues/potential/issue-00028.md), [issue-00037](../../../../../../issues/potential/issue-00037.md), [issue-00038](../../../../../../issues/potential/issue-00038.md), [issue-00041](../../../../../../issues/potential/issue-00041.md), [issue-00101](../../../../../../issues/potential/issue-00101.md), [issue-00109](../../../../../../issues/potential/issue-00109.md), [issue-00167](../../../../../../issues/potential/issue-00167.md), [issue-00176](../../../../../../issues/potential/issue-00176.md), [issue-00200](../../../../../../issues/potential/issue-00200.md), [issue-00201](../../../../../../issues/potential/issue-00201.md), [issue-00202](../../../../../../issues/potential/issue-00202.md), [issue-00204](../../../../../../issues/closed/issue-00204.md). Существующие наблюдения сверены по указанным входам. Новые проблемы имеют статус potential; корректировка механики и исправления не выполнялись.
...
PARTS.inventory52 ведёт к tab-inventory.hbs с единственной найденной кнопкой .open-currency-converter14–16. Подключение наследуется от WitcherActorSheet.activateListeners; роль этой специализации — выбор HBS, не формула/сохранение обмена. Полный actor/sheet-конвертер теперь документирован; лист наград, также связанный с инвентарём, остаётся в .037.
...
Полностью разобран импорт RewardsSheet6: экземпляр rewards14 и _renderRewards460–462 открывают просмотр журналов, а не форму выдачи/редактирования. Listener .open-rewards119. _addIpReward448–450 и .manualIpReward116 запускают отдельный API через Actor.addIpReward; _saveIpSpending452–458 остаётся отдельным прямым вызовом Log. Его строковая проблема200 не переносится на числовой ответ FormDataExtended в диалоге выдачи.
