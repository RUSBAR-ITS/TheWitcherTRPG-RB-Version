...
Включённый общий tab-effects теперь выводит один список травм с enriched-описанием. Категоризатор базового листа исключает повтор UUID; Item-конфигурация имеет отдельное действие описания. Собственный класс не менялся. См. [issue-00334](../../../../../../issues/open/issue-00334.md). Это статическая сверка; новая проверка в Foundry ожидает команды пользователя.
