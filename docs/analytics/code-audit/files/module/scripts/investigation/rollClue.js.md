...
Все 44 строки прочитаны. helper и skillMixin проверены точечно до нужных методов; полный разбор запланирован в .028/.029. Правила автоматического ущерба/времени и содержимое миров не проверялись.
