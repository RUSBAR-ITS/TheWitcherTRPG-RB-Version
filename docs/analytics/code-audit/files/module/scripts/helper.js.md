...
**14.3.1.00066, TASK-0010.008.** Новый getCustomModifierValue возвращает конечное число либо null при закрытии DialogV2.prompt; zero остаётся0. prepareCheck использует его, прежний getCustomModifier/addPart сохранены, но игровые входы больше не используют старый строковый prompt.

[Исходник](../../../../../../module/scripts/helper.js); [проверка и пределы](../../../../task-0010-008-checks.md).
