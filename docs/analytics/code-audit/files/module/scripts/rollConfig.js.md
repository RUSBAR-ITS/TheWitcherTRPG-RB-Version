...
[issue-00033](../../../../../issues/closed/issue-00033.md), [issue-00103](../../../../../issues/closed/issue-00103.md). Проблемы относятся к подготовке формулы до общего броска, не к конструктору. Новые проблемы самого RollConfig отдельно не зарегистрированы.
...
castSpell использует showResult:false и не меняет начальный threshold−1. showCrit остаётся true; успех по DC ритуала не определяется. Группы 24–25 разделяют fumble и сравнение с порогом.
