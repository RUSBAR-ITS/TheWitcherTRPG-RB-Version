...
2026-09-19. applyDamageFromMessage передаёт исходный game.messages.get(messageId) пятым аргументом Actor.applyDamage. Это только связь/видимость AE-последствия. Подбор Actor, диалог/тип урона, численные поля и прежние не-await вызовы сохранены. Периодический/status вход без сообщения остаётся допустимым.
...
[21](../../../../../../issues/closed/issue-00021.md) — потеря типа до applyDamageFromStatus; [149](../../../../../../issues/potential/issue-00149.md) — отсутствие выбранного Actor; [257](../../../../../../issues/closed/issue-00257.md) — потерянная duration; [299](../../../../../../issues/potential/issue-00299.md) — отсутствие ожидания; [300](../../../../../../issues/potential/issue-00300.md) — повторное использование изменённых данных сообщения; [301](../../../../../../issues/potential/issue-00301.md) — непроверенный DOM total. [291](../../../../../../issues/potential/issue-00291.md) — отрицательный итог статуса доходит до увеличения щита.
