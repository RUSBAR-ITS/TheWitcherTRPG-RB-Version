...
[issue-00257](../../../../../../../issues/closed/issue-00257.md). Не переносит ранее обсуждённую проблему clone в схему: issue-00257 описывает более раннюю потерю duration при создании сообщения, issue-00044 — другой этап.
