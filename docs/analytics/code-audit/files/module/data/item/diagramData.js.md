...
Актуализация [issue-00001](../../../../../../issues/closed/issue-00001.md), 2026-09-16: Удалена только legacy-ветка associatedItem → associatedItemUuid/gear. Актуальный UUID результата задаётся напрямую. Ветка alchemyDC и подготовка связанных документов сохранены; файл теперь содержит 77 строк.
