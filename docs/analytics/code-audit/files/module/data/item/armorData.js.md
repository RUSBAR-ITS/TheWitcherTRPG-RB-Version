...
2026-09-19, TASK-0011.004. Новый getter damagedLocations возвращает только повреждённую надёжность и SP шести зон с локализованными подписями. Пределы — reliabilityMax/maxStoppingPower, как в canBeRepaired/repair. repair() возвращает Promise parent.update семи полей; модифицированный SP не меняет ремонтный максимум.
...
Полный [потребитель брони](../../../../../../../module/actor/mixins/armorMixin.js) теперь разобран в TASK-0003.043. Группы 15–16 вызвали настоящий ArmorData.applySpDamage через Actor: при SP=3 износ 2/3/4 запрашивает 1/0/ничего; при базе 1 и улучшении +2 износ 2 запрашивает −1. Наблюдение 83 сохраняется. Группа 21 уточнила раннее завершение записей ([282](../../../../../../issues/potential/issue-00282.md)). Natural Item участвует в SP/сопротивлении, но не передаётся в applySpDamageToItemArmor. Нормы его износа не переопределены.
