...
Исходник и текущие связи сопоставлены в TASK-0004.006. Прежние ссылки на будущий пофайловый разбор TASK-0003 больше не являются очередью: он завершён. Остались конкретные границы сквозной проверки: [U006-03](../../../../../../cross-check-0002.md#u006-03); [U006-05](../../../../../../cross-check-0002.md#u006-05). Три флага, помеченные переводом как незавершённые, не считаются реализованными вычислениями.
...
[Полный consumer rollDamage](../../../../item/mixins/damageUtilMixin.js.md) в группах 01/05/06 проверен с настоящей моделью: preprocessing копирует записи и не меняет source,30+20 даёт 50; бросок 50 проходит,51 нет. Нулевой процент не получает applied, DamageMessageData достраивает false. Обычный выход сообщения содержит Array effects; прямой вызов applyDamage с TypedObject effects — иной контракт и выбрасывает filter-ошибку после HP (33). Ошибки неопределённого статуса и заголовка описаны 295/296; это не изменение схемы.
...
Модель содержит18 полей и TypedObject effects. AddEffects объединяет словарь, preprocessing сводит одинаковые статусы, сохраняя varEffect первой записи; 120 очищается DamageMessageData до100. Generic merge оружия словарь пропускает. Три флага, помеченные переводом как незавершённые, не считаются реализованными вычислениями.

Сопоставленные определения и потребители: [module/data/item/templates/itemEffectData.js](../itemEffectData.js.md), [module/item/sheets/configurations/WitcherPropertiesConfigurationSheet.js](../../../../item/sheets/configurations/WitcherPropertiesConfigurationSheet.js.md), [templates/sheets/item/configuration/tabs/damagePropertiesConfiguration.hbs](../../../../../templates/sheets/item/configuration/tabs/damagePropertiesConfiguration.hbs.md), [templates/sheets/item/armor-sheet.hbs](../../../../../templates/sheets/item/armor-sheet.hbs.md).

[Протокол и границы](../../../../../../review-log.md#task-0004006) — TASK-0004.006; процессы [R006-04](../../../../../../cross-check-0002.md#r006-04), [R006-06](../../../../../../cross-check-0002.md#r006-06). В этой порции выполнена статическая сверка; поведенческие опыты принадлежат датированным прежним протоколам, а не новому прогону.
