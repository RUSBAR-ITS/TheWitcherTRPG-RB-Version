...
2026-09-16, dev, база aeb527c6e6402e8a5f940a2c3ad0020d7e5b35e4. createRegionBehaviour.name разрешает WITCHER.Item.RegionProperties.${event}. Для четырёх событий схемы используются существующие en/ru-подписи; type, system.events и uuid прежние. Имена уже существующих документов не переписываются; миграция сохранена.
