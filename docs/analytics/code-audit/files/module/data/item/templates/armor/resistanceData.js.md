...
Исходник и текущие связи сопоставлены в TASK-0004.006. Прежние ссылки на будущий пофайловый разбор TASK-0003 больше не являются очередью: он завершён. Остались конкретные границы сквозной проверки: [U006-01](../../../../../../cross-check-0002.md#u006-01); [U006-03](../../../../../../cross-check-0002.md#u006-03). Современный инвентарь читает вложенные resistance, старый — плоские отсутствующие поля; это разные маршруты.
...
Три Bool объединяются OR с подготовленными enhancementItems брони. Основная форма использует итоговые Bool в именованных checkbox, поэтому .014 проверяла потенциальное сохранение бонуса как базы. Современный инвентарь читает вложенные resistance, старый — плоские отсутствующие поля; это разные маршруты.

Сопоставленные определения и потребители: [module/data/item/armorData.js](../../armorData.js.md), [module/data/item/templates/armor/spData.js](spData.js.md), [templates/sheets/actor/partials/character/inventory/tab-inventory-armors.hbs](../../../../../templates/sheets/actor/partials/character/inventory/tab-inventory-armors.hbs.md), [module/actor/witcherActor.js](../../../../actor/witcherActor.js.md).
