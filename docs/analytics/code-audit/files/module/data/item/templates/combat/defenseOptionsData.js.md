...
Все три модели магии включают defenseOptions: это способы ответа цели. Собственная защита доступна лишь SpellData через DefenseProperties и два делегирующих метода; наличие списка у HexData/RitualData не вводит isApplicableDefense.
