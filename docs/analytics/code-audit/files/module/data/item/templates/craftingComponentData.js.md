...
В TASK-0004.007 текущие определения и потребители сопоставлены; прежние опыты TASK-0003.015/.016/.017 (2026-09-10) и .034 (2026-09-11) сохраняют собственные входы и фасады. Браузер, мир, сеть и запись в БД не запускались. Точные оставшиеся вопросы и ответственные блоки: [U007-01](../../../../../cross-check-0002.md#u007-01), [U007-03](../../../../../cross-check-0002.md#u007-03), [U007-02](../../../../../cross-check-0002.md#u007-02). Для этого файла установлены процессы R007-09, R007-11, R007-14, а не полный клиентский lifecycle.

## Связанные проблемы

[issue-00095](../../../../../../../issues/closed/issue-00095.md). ID строки исправен; при неразрешённом UUID ошибается подготовка контекста листа.
...
2026-09-11, `7dbb31bdbd094f58c77c9e58dd5a684df6bb942c`. Полный разбор потребителя dismantle: читаются name/quantity/uuid, id не переносится. quantity=0 по схеме даёт выход 1 согласно алгоритму с минимумом; строки без UUID остаются неизвестными и не ищутся по имени. Две одноимённые связанные строки запускают независимые выдачи; при общей стопке воспроизведены одинаковые payload обновления.
...
craftingComponent хранит собственный randomID, name, quantity и DocumentUUIDField. В отличие от consumable status-row, id переживает очистку и используется CRUD. Пустое число очищается в null, два одинаковых UUID имеют разные id. UUID-валидация не гарантирует Item; merge повторных требований фабрика не определяет.

Сопоставленные определения и потребители: [module/data/item/diagramData.js](../diagramData.js.md), [module/item/sheets/WitcherDiagramSheet.js](../../../item/sheets/WitcherDiagramSheet.js.md), [templates/sheets/item/diagrams-sheet.hbs](../../../../templates/sheets/item/diagrams-sheet.hbs.md), [module/item/witcherItem.js](../../../item/witcherItem.js.md), [module/item/mixins/dismantlingMixin.js](../../../item/mixins/dismantlingMixin.js.md).

[Протокол и границы](../../../../../review-log.md#task-0004007) — TASK-0004.007; процессы [R007-09](../../../../../cross-check-0002.md#r007-09), [R007-11](../../../../../cross-check-0002.md#r007-11), [R007-14](../../../../../cross-check-0002.md#r007-14). В этой порции выполнена статическая сверка; прежние опыты сохраняют свои даты и фасады. Единственный новый запуск N007-01 проверяет producer/HBS alchemyComponentsList на заданном контексте; его границы не распространяются на остальные процессы.
