...
Исходник и текущие связи сопоставлены в TASK-0004.006. Прежние ссылки на будущий пофайловый разбор TASK-0003 больше не являются очередью: он завершён. Остались конкретные границы сквозной проверки: [U006-02](../../../../cross-check-0002.md#u006-02); [U006-05](../../../../cross-check-0002.md#u006-05); [U006-08](../../../../cross-check-0002.md#u006-08). Общий addItem складывает по name/type и может применяться к независимой модели без quantity.
...
2026-09-11, `rusbar-main`, `ce0c7eb7069b215b641d725913b3aae21502e811`. Восемь таблиц используют общий quantity StringField и числовые weight/cost. Все строки количества выводятся даже при hasQuantity=false у заголовка. На реальных моделях инвентарь передал строку '3' в Item.update, без обработки data-dtype самим HBS. isCarried имеет кнопку только у таблицы valuables, остальные Item могут менять его в других интерфейсах.
...
Подтверждены восемь общих полей: quantity строковая; isCarried/isStored управляют весом, isHidden его не исключает. Имя, изображение и ActiveEffect принадлежат Item. Контейнер переопределяет только расчёт вклада содержимого. Общий addItem складывает по name/type и может применяться к независимой модели без quantity.

Сопоставленные определения и потребители: [module/item/witcherItem.js](../../item/witcherItem.js.md), [module/setup/registerDataModels.js](../../setup/registerDataModels.js.md), [module/setup/registerSheets.js](../../setup/registerSheets.js.md), [module/TheWitcherTRPG.js](../../TheWitcherTRPG.js.md).

[Протокол и границы](../../../../review-log.md#task-0004006) — TASK-0004.006; процессы [R006-01](../../../../cross-check-0002.md#r006-01), [R006-12](../../../../cross-check-0002.md#r006-12), [R006-13](../../../../cross-check-0002.md#r006-13). В этой порции выполнена статическая сверка; поведенческие опыты принадлежат датированным прежним протоколам, а не новому прогону.
