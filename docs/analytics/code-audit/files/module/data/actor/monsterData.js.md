...
2026-09-11, `273a6d7db0b7c866399db3ecd4f7191817ae6f10`. Полный разбор tab-skills/edit-skills подтверждает общий интерфейс с персонажем. В MonsterData нет IP/logs/magic/training: ранее описана общая IP-вкладка (issue-00030), теперь отдельно установлена доступная кнопка повышения через openModifiers, завершающаяся TypeError. dontAddAttr исключает характеристику из формулы броска, но не её предварительное чтение.
...
2026-09-11, `aa6af106e86a9c75fe050d599f961c8fadb74f1b`. customStat является собственным полем MonsterData. Настоящие сценарии derived editor проверены в обоих режимах: он влияет на HP/STA, но не отменяет фиксированный пересчёт STUN/RUN. Общий tab-stats монстра показывает пустую сумму totalStats, поскольку producer отсутствует.

Сверенные источники: [templates/sheets/actor/configuration/app/partials/stats-block.hbs](../../../../../../../templates/sheets/actor/configuration/app/partials/stats-block.hbs); [templates/partials/character/tab-stats.hbs](../../../../../../../templates/partials/character/tab-stats.hbs); [module/actor/sheets/configurations/WitcherModifiersConfiguration.js](../../../../../../../module/actor/sheets/configurations/WitcherModifiersConfiguration.js). [Итоговая сверка третьей серии, сценарии и ограничения](../../../../review-log.md#task-0003030). Код и статусы проблем не менялись.
