...
Семь SchemaField(valueLabel) становятся general.details; особый путь general.details.value.value — текст пары с ключом value. Внешний label поля и сохранённый label пары различены. Шаблон биографии редактирует .value; автоматических числовых бонусов или синхронизации с предметами фабрика не задаёт.

Сопоставленные определения и потребители: [module/data/actor/templates/valueLabelData.js](../../valueLabelData.js.md), [module/data/actor/templates/character/generalData.js](../generalData.js.md), [templates/partials/character/tab-background.hbs](../../../../../../templates/partials/character/tab-background.hbs.md).
