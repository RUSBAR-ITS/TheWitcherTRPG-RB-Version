...
[issue-00014](../../../../../../../../../issues/closed/issue-00014.md) — Reputation передаёт фабрике ключ подписи, отсутствующий в локализациях. Сам механизм передачи метаданных работает; вопрос в аргументе потребителя.
