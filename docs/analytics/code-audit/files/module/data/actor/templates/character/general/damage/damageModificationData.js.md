...
Тройка flat0/multiplication1/applyAPfalse задаёт данные типа; ограничения знака числовых полей нет. getFlatDamageMod/getMultiDamageMod выбирают запись по damage.type. Потребитель flat использует только положительное значение; multiplication — ветви сопротивлений брони; applyAP читает неверный damage.damageProperties при штатном damage.properties. Сверены причины 00025/26/27 без выбора новой арифметики.

Сопоставленные определения и потребители: [module/data/actor/templates/character/general/damage/damageTypeModificationData.js](damageTypeModificationData.js.md), [module/actor/mixins/damageUtilMixin.js](../../../../../../actor/mixins/damageUtilMixin.js.md), [module/actor/mixins/armorMixin.js](../../../../../../actor/mixins/armorMixin.js.md), [module/actor/mixins/damageMixin.js](../../../../../../actor/mixins/damageMixin.js.md), [module/activeEffect/mixins/baseMixin.js](../../../../../../activeEffect/mixins/baseMixin.js.md).
