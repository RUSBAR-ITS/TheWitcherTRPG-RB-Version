...
**Сущности, действия и зависимости:** baseCap NumberField initial10 добавлен рядом с value. Отрицательное значение навыка модель не запрещает. Стоимость/ограничения повышения здесь ещё не рассчитываются. Зависимости прежние, подпись из ru/en.

[Исходник](../../../../../../../../../../module/data/actor/templates/common/skills/skillData.js), [проверки и границы](../../../../../../../../task-0010-003-checks.md). Статическая проверка; игровая приёмка не проводилась. Численный контракт следующих стадий ещё не внедрён.
...
2026-09-11, `273a6d7db0b7c866399db3ecd4f7191817ae6f10`. Skill.modifiedValue читает текущая character-строка; старый monster partial читает value и isVisible. edit-skills меняет value и три флага, показывая activeEffectModifiers отдельно. Настоящий formGroup при модели с Actor-родителем даёт правильные полные system.skills.*.isVisible имена, но технические подписи вместо label. Свежие незаполненные label дают сумму 52 для 52 уровней 1; после миграции подписи '(2)' дают 64 в en/ru.
