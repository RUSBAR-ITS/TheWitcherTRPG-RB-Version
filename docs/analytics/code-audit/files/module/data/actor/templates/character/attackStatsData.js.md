...
Новых проблем самой фабрики и проверенной цепочки атак не зарегистрировано. [issue-00012](../../../../../../../../issues/closed/issue-00012.md) относится к другому расчёту luck/toxicity; похожая запись += не является достаточным основанием переносить тот вывод на calculateAttackStats.
