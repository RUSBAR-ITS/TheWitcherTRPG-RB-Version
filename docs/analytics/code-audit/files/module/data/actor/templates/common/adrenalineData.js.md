...
Schema value0/label входит в CommonActorData; поля min/max не заданы. migrateAdrenaline переносит current при falsy value, включая явный0; ненулевой value сохраняет. Операции Actor и листа пишут value через update, фабрика этого не делает. Ручной плюс зависит от настройки, ручной минус — от value>0.

Сопоставленные определения и потребители: [module/data/actor/commonActorData.js](../../commonActorData.js.md), [module/actor/mixins/adrenalineMixin.js](../../../../actor/mixins/adrenalineMixin.js.md), [module/actor/sheets/mixins/statMixin.js](../../../../actor/sheets/mixins/statMixin.js.md).
