...
- `5`: `return stat('WITCHER.Reputation');`
...
[issue-00011](../../../../../../../../issues/potential/issue-00011.md) дополнена случаем Reputation; [issue-00014](../../../../../../../../issues/closed/issue-00014.md) дополнена ссылкой на полный разбор модели. Дубликаты не создавались.
