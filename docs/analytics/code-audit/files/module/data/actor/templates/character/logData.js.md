...
EmbeddedDataField(Log) имеет CharacterData-родителя; this.parent.parent.update адресует Actor. Оба метода сначала push в prepared-массив, затем инициируют запись истории и абсолютного баланса, возвращая undefined. .005/.029/.037 проверяли настоящие методы с удержанным update; последние запросы 12/13 при базе10 — не доказательство итогового серверного остатка. Противоречие magicalCost (00017) и строковое списание (00029/00200) — отдельные причины у caller.

Сопоставленные определения и потребители: [module/data/actor/characterData.js](../../characterData.js.md), [module/data/actor/templates/character/ipLogData.js](ipLogData.js.md), [module/data/actor/templates/character/currencyLogData.js](currencyLogData.js.md), [module/app/reward/reward.js](../../../../app/reward/reward.js.md), [module/actor/mixins/skillMixin.js](../../../../actor/mixins/skillMixin.js.md), [module/actor/sheets/WitcherCharacterSheet.js](../../../../actor/sheets/WitcherCharacterSheet.js.md).
