...
22 BooleanField сохраняют состояние раскрытия на Actor, не на пользователе. Девять полей веществ используются текущим inventory; 13 полей навыков/магии имеют потребителей в старых HBS, наличие которых не означает выбор зарегистрированным листом. Обработчики строят system.pannels.<dataset>IsOpen; схема только предоставляет значения и не привязывает UI.

Сопоставленные определения и потребители: [module/data/actor/commonActorData.js](../../commonActorData.js.md), [module/actor/sheets/mixins/skillMixin.js](../../../../actor/sheets/mixins/skillMixin.js.md), [module/actor/sheets/mixins/itemMixin.js](../../../../actor/sheets/mixins/itemMixin.js.md).
