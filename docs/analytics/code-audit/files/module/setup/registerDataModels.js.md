...
[issue-00005](../../../../../issues/closed/issue-00005.md) — четыре типа зарегистрированы в коде, но отсутствуют в манифесте.
...
2026-09-11, `rusbar-main`, `74322e91edac106c82668f4a47eef53ce1889dc1`; исходники прежние. Прямые default-imports WitcherChatMessage, BaseMessageData, AttackMessageData, DefenseMessageData, DamageMessageData; присваивания CONFIG.ChatMessage.documentClass и dataModels.base/attack/defense/damage сверены со всеми определениями. Модели наследуют DataModel; использование TypeDataModel не является обязательным условием этого TypeDataField. Группа02 создала настоящий common-документ каждого типа с этими классами; полный registerDataModels/клиентский startup в этой порции не запускался.
