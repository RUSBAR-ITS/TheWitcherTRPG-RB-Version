...
2026-09-20, dev. registerHooks дополнительно вызывает registerTemporaryHpHooks. Прежние периодические действия Combat не заменяются.

Связанные потребители/границы: temporaryHpDuration. Статические проверки выполнены; браузер и БД не запускались. [Исходник](../../../../../../module/setup/hooks.js) · [TASK-0012](../../../../../tasks/task-0012-temporary-hp.md) · [Проверки](../../../../task-0012-checks.md).
