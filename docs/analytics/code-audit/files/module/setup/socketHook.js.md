...
| SYSTEM_SOCKET | Локальная строка, стр. 2 | system.TheWitcherTRPG-RB-Version |
...
[issue-00010](../../../../../issues/potential/issue-00010.md) — неизвестный type; [issue-00002](../../../../../issues/closed/issue-00002.md) — регистрация может быть не достигнута из ready.
