...
Валидация/сохранение настроек и переключение пакета в действующем мире не воспроизводились; индекс после такого переключения неизвестен. Контракт выбора травмы — .012, UI/en/ru — .016. Название опции не подтверждает игровое правило.

## Связанные проблемы

[issue-00002](../../../../../issues/closed/issue-00002.md) — ready не обрабатывает отсутствие выбранного pack.
...
Сверены девять мировых регистраций и потребители ключей. criticalWoundsPack выбирает любой Item-пакет, не проверяя подтип его документов; ready индексирует четыре поля, applyCritWound позже читает pack.index по текущему значению настройки. onChange/requiresReload отсутствуют. useWitcherFont потребляется только после успешного ready.getIndex; getSetting/includes связывают настройки изображений с HBS. Все 16 буквальных name/hint-ключей настроек найдены и в en, и в ru.

Сопоставленные определения и потребители: [module/TheWitcherTRPG.js](../TheWitcherTRPG.js.md), [module/setup/handlebars.js](handlebars.js.md), [module/actor/mixins/damageMixin.js](../actor/mixins/damageMixin.js.md), [templates/partials/item-header.hbs](../../templates/partials/item-header.hbs.md), [lang/en.json](../../lang/en.json.md), [lang/ru.json](../../lang/ru.json.md).

[Протокол и границы](../../../review-log.md#task-0004002) — TASK-0004.002; процессы [R002-05](../../../cross-check-0002.md#r002-05), [R002-06](../../../cross-check-0002.md#r002-06), [R002-08](../../../cross-check-0002.md#r002-08). Новые изолированные исполнения ограничены N01/N02 протокола; остальные перечисленные опыты относятся к прежним порциям.
