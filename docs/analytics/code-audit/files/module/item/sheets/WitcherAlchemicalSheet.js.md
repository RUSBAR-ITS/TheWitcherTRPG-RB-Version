...
| PARTS.main | static object | template systems/TheWitcherTRPG/templates/sheets/item/alchemical-sheet.hbs; scrollable=[''] | HandlebarsApplicationMixin | Рендер основной части |
