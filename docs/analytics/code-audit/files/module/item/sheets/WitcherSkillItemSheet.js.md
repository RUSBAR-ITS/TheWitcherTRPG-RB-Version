...
2026-09-20, dev. Добавлено действие generateSkillId: явное сохранение случайного ID, если старое поле пустое. Шаблон даёт просмотр/редактирование ID; обычная подготовка листа ID не меняет.

Связанные потребители/границы: skill-item-sheet.hbs. Статические проверки выполнены; браузер и БД не запускались. [Исходник](../../../../../../../module/item/sheets/WitcherSkillItemSheet.js) · [TASK-0012](../../../../../../tasks/task-0012-temporary-hp.md) · [Проверки](../../../../../task-0012-checks.md).
