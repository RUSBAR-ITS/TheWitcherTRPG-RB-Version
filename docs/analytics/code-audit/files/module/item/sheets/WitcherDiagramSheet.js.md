...
**Назначение:** Лист рецепта с устойчивой идентичностью компонентов.

**Основные методы, сущности и действия:** _prepareContext асинхронно готовит строки через linkedItemContext, сохраняя saved id/uuid/name/quantity. _onEditComponent копирует массив, проверяет существование строки и разрешённое поле, возвращает ожидаемый update. Исчезнувшая строка не приводит к записи по индексу -1.

**Зависимости и потребители:** WitcherItemSheet, helpers/linkedItemContext.js; diagrams-sheet.hbs использует missing/available. diagramData остаётся моделью сохранённых компонентов.
...
[issue-00095](../../../../../../issues/closed/issue-00095.md), [issue-00080](../../../../../../issues/potential/issue-00080.md), [issue-00098](../../../../../../issues/closed/issue-00098.md), [issue-00096](../../../../../../issues/closed/issue-00096.md), [issue-00101](../../../../../../issues/potential/issue-00101.md). Потеря имени, общий риск offsetParent, подписи и представление результата; режим crafting определяется другим кодом.
