...
[issue-00121](../../../../../../issues/closed/issue-00121.md), [issue-00127](../../../../../../issues/closed/issue-00127.md). Переход по сохранённой ссылке требует проверки получателя; Drop не возвращает завершение update. Это не объявлено ошибкой формата UUID.
