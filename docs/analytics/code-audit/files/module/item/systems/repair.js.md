...
Исходник не менялся. _canRepair по-прежнему проверяет Number.isFinite и достаточность количества до расхода. CommonItemData.quantity теперь числовое целое поле, включая штатную загрузку исходной строки "6"→6; прежняя ошибка отказа для подготовленного строкового значения устранена сменой модели, а не ослаблением ремонта. Это проверено настоящим BaseItem в адресном сценарии6→5. quantityObtainable/resultQuantity/числа рецепта не переименованы; игровой повтор B04 ещё нужен.
...
[Исходник](../../../../../../../module/item/systems/repair.js); [проверка и пределы](../../../../../task-0010-008-checks.md).
...
**Назначение:** Подготовка и исполнение ремонта.

**Основные методы, сущности и действия:** prepareData прерывает подготовку с локализованным сообщением, если обязательный UUID компонента не разрешается, документ невидим/не Item или стоимость не является конечным числом. Это происходит до диалога, броска и списания. Материал, уже найденный у Actor, и ручной компонент без UUID проходят прежний маршрут. Остальные ранее описанные ошибки ремонта этой правкой не исправлены.

**Зависимости и потребители:** fromUuid; WITCHER.Repair.alerts.unavailableComponent в en/ru; repairMixin вызывает подготовку. Диалог ремонта и его прочие расчёты сохранены.
...
При успехе без прав используется socket system.TheWitcherTRPG-RB-Version: [uuid] → активный GM → документ.restoreReliability → примесь → system.repair. Это отдельный протокол от CONFIG.queries и без прикладного ответа об окончании обновления. _doRepair запускает списание до отправки. Обновления/сообщения не объединены в транзакцию.
...
В TASK-0004.007 текущие определения и потребители сопоставлены; прежние опыты TASK-0003.015/.016/.017 (2026-09-10) и .034 (2026-09-11) сохраняют собственные входы и фасады. Браузер, мир, сеть и запись в БД не запускались. Точные оставшиеся вопросы и ответственные блоки: [U007-01](../../../../cross-check-0002.md#u007-01), [U007-02](../../../../cross-check-0002.md#u007-02), [U007-03](../../../../cross-check-0002.md#u007-03), [U007-05](../../../../cross-check-0002.md#u007-05), [U007-08](../../../../cross-check-0002.md#u007-08). Для этого файла установлены процессы R007-15, R007-16, R007-17, R007-18, R007-19, R007-20, а не полный клиентский lifecycle.

## Связанные проблемы

[issue-00102](../../../../../../issues/closed/issue-00102.md), [issue-00103](../../../../../../issues/closed/issue-00103.md), [issue-00104](../../../../../../issues/potential/issue-00104.md), [issue-00105](../../../../../../issues/closed/issue-00105.md), [issue-00106](../../../../../../issues/potential/issue-00106.md), [issue-00107](../../../../../../issues/potential/issue-00107.md), [issue-00108](../../../../../../issues/potential/issue-00108.md), [issue-00081](../../../../../../issues/potential/issue-00081.md), [issue-00100](../../../../../../issues/potential/issue-00100.md), [issue-00008](../../../../../../issues/potential/issue-00008.md), [issue-00010](../../../../../../issues/potential/issue-00010.md), [issue-00034](../../../../../../issues/potential/issue-00034.md). 102/103 — независимые блокировки;104 — нулевой owned;105 — null UUID;106 — глобальный DOM цены;107/108 — границы чата. 81 дополнена ожиданием операций ремонта,100 — прежний NaN. 8/10 описывают маршрутизацию;34 относится к другим методам Actor, сам removeItem ожидает запись.
...
2026-09-11, `9f16a7ae4bc942df85a105fd37d9a3cb3ef99f4b`: commonRepair:190 вызывает extendedRoll с prepareRollConfig, где showResult=false. Общий бросок не исправляет формулу: реальный parser отклоняет незакрытую скобку и фрагмент с пропущенным оператором. В штатном ремонте [issue-00103](../../../../../../issues/closed/issue-00103.md) прерывает подготовку раньше, на незарегистрированной настройке; повторного исполнения ремонта в этой порции не было. RollConfig.showSuccess не читается extendedRoll, успех определяется threshold>=0.
...
RepairSystem связывает UUID рецепта, первый найденный компонент, обычный RepairData, диалог/бросок и восстановление. Различены отсутствие рецепта, null компонента, нулевой owned, missing damagedLocations, незарегистрированная настройка и отсутствующий restore-data метод. Цена/GM-ветвь/обычный ремонт имеют разные запросы, условия и ожидания. Нижний диагностический вызов не доказывает успешный обычный ремонт.

Сопоставленные определения и потребители: [module/scripts/rolls/extendedRoll.js](../../scripts/rolls/extendedRoll.js.md), [module/scripts/rollConfig.js](../../scripts/rollConfig.js.md), [module/scripts/socket/socketMessage.js](../../scripts/socket/socketMessage.js.md), [module/item/mixins/costEditMixin.js](../mixins/costEditMixin.js.md), [module/actor/mixins/craftingMixin.js](../../actor/mixins/craftingMixin.js.md), [module/actor/witcherActor.js](../../actor/witcherActor.js.md), [module/actor/mixins/modifierMixin.js](../../actor/mixins/modifierMixin.js.md), [module/data/actor/templates/common/stats/statsData.js](../../data/actor/templates/common/stats/statsData.js.md), [module/data/actor/templates/common/stats/statData.js](../../data/actor/templates/common/stats/statData.js.md), [module/data/actor/templates/common/skills/craData.js](../../data/actor/templates/common/skills/craData.js.md), [module/data/actor/templates/common/skills/skillData.js](../../data/actor/templates/common/skills/skillData.js.md), [module/data/item/weaponData.js](../../data/item/weaponData.js.md), [module/data/item/armorData.js](../../data/item/armorData.js.md), [module/data/item/diagramData.js](../../data/item/diagramData.js.md), [module/data/item/componentData.js](../../data/item/componentData.js.md), [module/data/item/commonItemData.js](../../data/item/commonItemData.js.md), [module/setup/config.js](../../setup/config.js.md), [module/setup/settings.js](../../setup/settings.js.md), [templates/dialog/repair-dialog.hbs](../../../templates/dialog/repair-dialog.hbs.md), [templates/chat/item/repair.hbs](../../../templates/chat/item/repair.hbs.md), [lang/en.json](../../../lang/en.json.md), [lang/ru.json](../../../lang/ru.json.md), [module/item/mixins/repairMixin.js](../mixins/repairMixin.js.md), [module/scripts/chat.js](../../scripts/chat.js.md).

[Протокол и границы](../../../../review-log.md#task-0004007) — TASK-0004.007; процессы [R007-15](../../../../cross-check-0002.md#r007-15), [R007-16](../../../../cross-check-0002.md#r007-16), [R007-17](../../../../cross-check-0002.md#r007-17), [R007-18](../../../../cross-check-0002.md#r007-18), [R007-19](../../../../cross-check-0002.md#r007-19), [R007-20](../../../../cross-check-0002.md#r007-20). В этой порции выполнена статическая сверка; прежние опыты сохраняют свои даты и фасады. Единственный новый запуск N007-01 проверяет producer/HBS alchemyComponentsList на заданном контексте; его границы не распространяются на остальные процессы.
