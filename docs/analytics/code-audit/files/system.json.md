...
| Дата проверки | 2026-09-16: версия уточнения области issue-00330 |
| Ветка и коммит | `dev`, база `031fbb8691ad32ab01fad43253c8736071bb2f8b` + рабочая правка версии |
| Изменения относительно коммита | Версия повышена до 14.3.1.00007 при реализации локализации issue-00330; остальные поля сохранены. |
...
Версия первоначального оформления [issue-00330](../../../issues/open/issue-00330.md), 2026-09-16: `14.3.1.00004`. Ограничение плана подписями и локализацией оформлено в `14.3.1.00005`. Версия `14.3.1.00006` исключила компедиумы из плана. Актуальная версия — `14.3.1.00007`: выполнены подписи и локализация. Повышен только счётчик изменения документации; реализация локализации описана в актуализации ниже.
...
| `compatibility`, `version` — 5–10 | Минимум, проверенное и максимальное поколение — 14; версия форка — `14.3.1.00007`. Это декларация совместимости, а не результат проверки. |
...
[issue-00001](../../../issues/open/issue-00001.md) — ранее зарегистрированное различие имени каталога и ID. [issue-00002](../../../issues/potential/issue-00002.md) — обработчик ready не переносит отсутствие выбранного компедиума; это отдельная проблема точки входа.
