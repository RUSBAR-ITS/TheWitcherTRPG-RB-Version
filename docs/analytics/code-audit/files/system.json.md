...
| Дата проверки | 2026-09-16: версия восстановления пяти компедиумов |
| Ветка и коммит | dev, база 28a6257af9f9b78a0dcd8df8dcfee0ed9acf4860 + рабочее изменение |
| Изменения относительно коммита | Только version: 14.3.1.00010 → 14.3.1.00012; последнее изменение 14.3.1.00011 → 14.3.1.00012 оформляет восстановление пяти компедиумов. |
...
| `compatibility`, `version` — 5–10 | Минимум, проверенное и максимальное поколение — 14; версия форка — `14.3.1.00012`. Это декларация совместимости, а не результат проверки. |
