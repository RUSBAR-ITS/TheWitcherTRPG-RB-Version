...
| Ветка и коммит | `dev`, база `28ab8dd52258b74117bdaec179470b4b675e8858` + рабочая правка версии |
| Изменения относительно коммита | Версия повышена до 14.3.1.00006 при исключении компедиумов из плана issue-00330; остальные поля сохранены. |
...
Версия первоначального оформления [issue-00330](../../../issues/open/issue-00330.md), 2026-09-16: `14.3.1.00004`. Ограничение плана подписями и локализацией оформлено в `14.3.1.00005`. Актуальная версия — `14.3.1.00006`: компедиумы также исключены из плана. Повышен только счётчик изменения документации; исправления локализации ещё не реализованы.
...
| `compatibility`, `version` — 5–10 | Минимум, проверенное и максимальное поколение — 14; версия форка — `14.3.1.00006`. Это декларация совместимости, а не результат проверки. |
