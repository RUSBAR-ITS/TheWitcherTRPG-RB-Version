...
| Дата проверки | 2026-09-16: версия реализации N01–N08 |
| Ветка и коммит | dev, база aeb527c6e6402e8a5f940a2c3ad0020d7e5b35e4 + рабочее изменение |
| Изменения относительно коммита | Только version: 14.3.1.00009 → 14.3.1.00010 при реализации N01–N08. |
...
| `compatibility`, `version` — 5–10 | Минимум, проверенное и максимальное поколение — 14; версия форка — `14.3.1.00010`. Это декларация совместимости, а не результат проверки. |
