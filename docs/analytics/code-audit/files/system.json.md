...
| Дата проверки | 2026-09-16: установка К01, 14.3.1.00018 |
| Ветка и коммит | dev, база af4d6f5fc7b40279f09eb66b0ca58aa2e1469ab4 + рабочее изменение |
| Изменения относительно коммита | Только version: относительно HEAD .00016 → .00018; .00017 — задачи диагностики/Playwright, .00018 — установка К01. |
...
| `compatibility`, `version` — 5–10 | Минимум, проверенное и максимальное поколение — 14; версия форка — `14.3.1.00018`. Это декларация совместимости, а не результат проверки. |
