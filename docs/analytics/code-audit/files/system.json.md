...
| Дата проверки | 2026-09-17: закрытие UI-исправлений, 14.3.1.00023 |
| Ветка и коммит | dev, база f31925972a627d0d60fd696346f25cb2c311ef14 + рабочее изменение |
| Изменения относительно коммита | Только version: .00022 → .00023; закрытие issue-00334 и шести исходных карточек, остальные поля сохранены. |
...
Счётчик version увеличен с 14.3.1.00012 до 14.3.1.00013 при оформлении [контента](../../../issues/closed/issue-00331.md), [механик](../../../issues/open/issue-00332.md) и [процессов](../../../issues/open/issue-00333.md). Остальные поля манифеста, включая объявления семи packs, сохранены.
...
| `compatibility`, `version` — 5–10 | Минимум, проверенное и максимальное поколение — 14; версия форка — `14.3.1.00023`. Это декларация совместимости, а не результат проверки. |
...
[issue-00001](../../../issues/closed/issue-00001.md) — ранее зарегистрированное различие имени каталога и ID. [issue-00002](../../../issues/potential/issue-00002.md) — обработчик ready не переносит отсутствие выбранного компедиума; это отдельная проблема точки входа.
