...
| Дата проверки | 2026-09-16: единый план исправления ошибок контента |
| Ветка и коммит | dev, база 433060047ca195773d582cac782a6a83a5c91ade + рабочее изменение |
| Изменения относительно коммита | Только version: 14.3.1.00012 → 14.3.1.00015; .00013 — категории, .00014 — книжная сверка, .00015 — единый план ошибок. |
...
| `compatibility`, `version` — 5–10 | Минимум, проверенное и максимальное поколение — 14; версия форка — `14.3.1.00015`. Это декларация совместимости, а не результат проверки. |
