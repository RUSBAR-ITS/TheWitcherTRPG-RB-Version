...
| Дата проверки | 2026-09-16: реализация К01, 14.3.1.00016 |
| Ветка и коммит | dev, база 095395276b97f0ffe916495e26be3938cf8fdcf8 + рабочее изменение |
| Изменения относительно коммита | Только version: 14.3.1.00015 → 14.3.1.00016; исправление контента К01. |
...
| `compatibility`, `version` — 5–10 | Минимум, проверенное и максимальное поколение — 14; версия форка — `14.3.1.00016`. Это декларация совместимости, а не результат проверки. |
