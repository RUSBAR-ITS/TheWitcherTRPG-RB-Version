...
**Основные методы, сущности и действия:** Версия 14.3.1.00034 → 14.3.1.00035; остальные поля сохранены.
...
Счётчик .00033 → .00034 при документировании [четырёх решений о контейнерах](../../../issues/open/issue-00333.md#container-decisions-00034) и актуализации плана/тестов. Остальные поля system.json сохранены. Игровое поведение не менялось, проверки мира не запускались.

## Актуализация 2026-09-17 — 14.3.1.00033

Счётчик .00032 → .00033 при подготовке [плана исправления issue-00333](../../../issues/open/issue-00333.md#plan). Остальные поля system.json сохранены. План и новое принятое требование наполненных шаблонов не являются выполненным изменением игрового поведения; реализация и игровые проверки не запускались.

## Актуализация 2026-09-17 — 14.3.1.00032

Счётчик .00031 → .00032 при документировании [согласованных правил контейнеров](../../../issues/open/issue-00333.md#container-rules) и DEC-0004. Остальные поля манифеста сохранены. Игровое поведение ещё не реализовано; код и компедиумы не менялись, игровые проверки не запускались.
