...
| Дата проверки | 2026-09-16: версия повторного анализа локализации и уточнения плана |
| Ветка и коммит | `dev`, база `52a2b64f82b0f60817a7f7d7b6ad34980510b6f9` + рабочая правка версии |
| Изменения относительно коммита | Только version: 14.3.1.00007 → 14.3.1.00009 поверх HEAD; .00008 — закрытие решённых issues, .00009 — повторный анализ и план локализации. |
...
| `compatibility`, `version` — 5–10 | Минимум, проверенное и максимальное поколение — 14; версия форка — `14.3.1.00009`. Это декларация совместимости, а не результат проверки. |
