...
| Дата проверки | 2026-09-16: версия оформления issue-00330 |
| Ветка и коммит | `dev`, база `ae93b8a5737b5611ac38d56c8882ce4d35187b19` + рабочая правка версии |
| Изменения относительно коммита | Версия повышена до 14.3.1.00004 при оформлении общей issue локализации; остальные поля сохранены. |
...
Актуальная версия после оформления [issue-00330](../../../issues/open/issue-00330.md), 2026-09-16: `14.3.1.00004`. Повышен только счётчик согласованного изменения документации; исправления локализации из плана ещё не реализованы.
...
| `compatibility`, `version` — 5–10 | Минимум, проверенное и максимальное поколение — 14; версия форка — `14.3.1.00004`. Это декларация совместимости, а не результат проверки. |
