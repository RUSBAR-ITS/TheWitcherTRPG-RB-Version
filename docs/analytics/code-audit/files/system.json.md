...
| Ветка и коммит | `dev`, база `56bbf90822903ad61bcec9912c938f9843670c95` + рабочая правка версии |
| Изменения относительно коммита | Версия повышена до 14.3.1.00005 при ограничении плана issue-00330 подписями и локализацией; остальные поля сохранены. |
...
Версия первоначального оформления [issue-00330](../../../issues/open/issue-00330.md), 2026-09-16: `14.3.1.00004`. Актуальная версия после уточнения её области — `14.3.1.00005`: план ограничен подписями и локализацией, механики исключены. Повышен только счётчик изменения документации; исправления локализации ещё не реализованы.
...
| `compatibility`, `version` — 5–10 | Минимум, проверенное и максимальное поколение — 14; версия форка — `14.3.1.00005`. Это декларация совместимости, а не результат проверки. |
