...
| Дата проверки | 2026-09-16: название и версия форка |
| Ветка и коммит | `dev`, база `172a274afd3e556a3fb178f4c0a89901e0ab02f6` + рабочая правка метаданных |
| Изменения относительно коммита | Установлены название и версия форка; технические объявления сохранены. |
...
| `compatibility`, `version` — 5–10 | Минимум, проверенное и максимальное поколение — 14; версия форка — `14.3.1.00003`. Это декларация совместимости, а не результат проверки. |
