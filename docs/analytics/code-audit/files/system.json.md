...
| Дата проверки | 2026-09-16: реализация диагностики, 14.3.1.00019 |
| Ветка и коммит | dev, база 7381f652196ed7a373fc7e47e0a1b2091cf30bd5 + рабочее изменение |
| Изменения относительно коммита | Только version: .00018 → .00019; документация реализации отдельного диагностического модуля. |
...
Счётчик повышен .00017 → .00018 один раз при [установке К01](../../../issues/open/issue-00331.md#installation). Шесть готовых баз перенесены в packs, старые сохранены; Style и все 226 JSON неизменны. Остальные поля манифеста сохранены. Foundry выключена, игровая приёмка ожидается.
...
Версия повышена один раз при реализации [К01](../../../issues/open/issue-00331.md#implementation). Остальные поля манифеста сохранены. Текущий набор: 226 JSON, 128 таблиц / 995 результатов, 94 травмы / 77 эффектов / 358 changes и четыре папки. Исправлены 48 JSON; шесть баз собраны и проверены во временном каталоге, установка отдельно.

## Единый план контента — 14.3.1.00015

Повышен только счётчик .00014 → .00015 при объединении [плана К01](../../../issues/open/issue-00331.md#k01). Авторские варианты отложены, JSON компедиумов не менялись. Остальные поля манифеста сохранены.

## Книжная сверка компедиумов — 14.3.1.00014

Счётчик повышен с 14.3.1.00013 до 14.3.1.00014 при подготовке [выписки](../../compendium-core-rulebook-reference.md), [сравнения](../../compendium-core-rulebook-comparison.md) и [К01](../../../issues/open/issue-00331.md#k01). Другие поля system.json, исходники пакетов и механики не изменялись.

## Категории работ по компедиумам — 14.3.1.00013

Счётчик version увеличен с 14.3.1.00012 до 14.3.1.00013 при оформлении [контента](../../../issues/open/issue-00331.md), [механик](../../../issues/open/issue-00332.md) и [процессов](../../../issues/open/issue-00333.md). Остальные поля манифеста, включая объявления семи packs, сохранены.
