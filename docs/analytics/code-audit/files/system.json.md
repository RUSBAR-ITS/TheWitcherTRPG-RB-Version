...
| Дата проверки | 2026-09-17: закрытие контентной К01, 14.3.1.00020 |
| Ветка и коммит | dev, база 562f7aa25b5274d64dc68ec1f4275815b383c567 + рабочее изменение |
| Изменения относительно коммита | Только version: .00019 → .00020; закрытие issue-00331 и девяти исходных карточек. |
...
| `compatibility`, `version` — 5–10 | Минимум, проверенное и максимальное поколение — 14; версия форка — `14.3.1.00019`. Это декларация совместимости, а не результат проверки. |
