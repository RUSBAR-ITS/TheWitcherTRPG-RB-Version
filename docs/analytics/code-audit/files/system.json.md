...
Счётчик .00029 → .00030 при [исправлении неизменяющей записи экспорта](../../../issues/potential/issue-00207.md#noop-fix). Остальные поля манифеста сохранены; объявления и содержимое компедиумов не менялись. Синтаксис и изолированные проверки прошли; повторный игровой запуск ожидается.
...
Версия; [реализация и пределы проверок](../../../issues/open/issue-00332.md).
...
Оформлены [план 00332](../../../issues/open/issue-00332.md#plan) и [TASK-0010](../../../tasks/task-0010-parameter-limits.md). В манифесте увеличен только счётчик; структура пакета и игровой код сохранены. Запланированные проверки реализации ещё не выполнялись.
