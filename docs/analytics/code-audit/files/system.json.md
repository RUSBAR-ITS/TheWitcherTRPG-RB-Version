...
Повышен только счётчик version с .00020 до .00021 при оформлении [issue-00334](../../../issues/open/issue-00334.md). План охватывает шесть ошибок отображения/повторного рендера; исправления JS/HBS ещё не выполнялись. Остальные поля манифеста сохранены.
