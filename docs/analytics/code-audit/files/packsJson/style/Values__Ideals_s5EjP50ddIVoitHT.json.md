# packsJson/style/Values__Ideals_s5EjP50ddIVoitHT.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/style/Values__Ideals_s5EjP50ddIVoitHT.json](../../../../../../packsJson/style/Values__Ideals_s5EjP50ddIVoitHT.json) |
...
| SHA-256 файла | c5314696b50270d073de3a2c4d2ff350117ac02fcc82e58e3ba194d5b7991cbf |

## Назначение файла

Ценности и идеалы: десять текстовых вариантов для описания персонажа. Файл задаёт таблицу `Values: Ideals`, а не Item и не ActiveEffect. Собственных обработчиков изменения Actor и игровых бонусов в нём нет.
...
| _stats | 245–252: coreVersion 13.341; compendiumSource `RollTable.sH8sCExSYidQevoA`; systemId/systemVersion/duplicateSource/exportSource null | История происхождения документа, не адрес вложенного броска |
...
Все результаты имеют _key вида `!tables.results!s5EjP50ddIVoitHT.<ID результата>`. Повтор тех же десяти локальных ID в соседних таблицах допустим: родитель входит в _key и UUID; 70 вложенных UUID серии различаются. В каждой отдельной таблице ID не повторяются.

| Значение d10 / диапазон [n,n] | ID результата | Точное description из JSON | Строки записи |
| --- | --- | --- | --- |
| 1 | `q0DM4FW7XCnFdKZu` | `Values and Ideals: Money` | 10–32 |
| 2 | `oKZeEBIq2FLMNk2e` | `Values and Ideals: Honor` | 33–55 |
| 3 | `kQX7ZeIIWKy5yTPF` | `Values and Ideals: Your Word` | 56–78 |
| 4 | `36ROPw9QWjYWmpBV` | `Values and Ideals: Hedonistic Pursuits` | 79–101 |
| 5 | `9kVdEtFeX4a3nAoe` | `Values and Ideals: Knowledge` | 102–124 |
| 6 | `cQfRuoxqB1FI58LA` | `Values and Ideals: Vengeance` | 125–147 |
| 7 | `th9s2aW3pwS3ZZX2` | `Values and Ideals: Power` | 148–170 |
| 8 | `tfUjaxwfTwqW98vG` | `Values and Ideals: Love` | 171–193 |
| 9 | `XFy2l49tSxFMwvUu` | `Values and Ideals: Survival` | 194–216 |
| 10 | `NlfhnGUfAnLtImRU` | `Values and Ideals: Friendship` | 217–239 |
...
| --- | --- | --- |
| [packsJson/character-generator/Style_and_Values_CjaIcLRWSlzwI6ly.json](../../../../../../packsJson/character-generator/Style_and_Values_CjaIcLRWSlzwI6ly.json) | results[5], ID `O4kO4Ec9Zjr1F3Qm`; documentUuid, строка 150 | Прямая ссылка на этот RollTable. При рекурсивном roll генератора получается один из его текстовых результатов |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Совпадение Item.name с `Values: Ideals` | Условный потребитель checkIfItemHasRollTable при экспорте добычи. Подбирает таблицу по индексу/имени; текстовый результат не превращается в Item, выдаётся exportLootInvalidItemError |
