# packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___How_Did_It_End__n13vBwJk61euGPa1.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___How_Did_It_End__n13vBwJk61euGPa1.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___How_Did_It_End__n13vBwJk61euGPa1.json) |
...
| SHA-256 файла | 5bb75f1fde5a1b33fec1e3dc2543b78168850cbdc3a790bea40d86862b314b31 |

## Назначение файла

Выбирает текст исхода охоты. Имя документа — `Witcher Lifepath: Hunt - How Did It End?`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.n13vBwJk61euGPa1`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Hunt - How Did It End?`; `n13vBwJk61euGPa1`; `!tables!n13vBwJk61euGPa1` | Имя, ID и ключ хранения корневого RollTable |
...
| Result _id/_key | ID в перечне; `!tables.results!n13vBwJk61euGPa1.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `q0DM4FW7XCnFdKZu` | [1,2] | text | `How Did the Hunt End - Got Your Money and Left` | 10–32 |
| 2 | `oKZeEBIq2FLMNk2e` | [3,4] | text | `How Did the Hunt End - Employer Refused To Pay` | 33–55 |
| 3 | `kQX7ZeIIWKy5yTPF` | [5,6] | text | `How Did the Hunt End - Employer Paid You in Trade` | 56–78 |
| 4 | `36ROPw9QWjYWmpBV` | [7,8] | text | `How Did the Hunt End - It Was a Particularly Tough Fight` | 79–101 |
| 5 | `9kVdEtFeX4a3nAoe` | [9,10] | text | `How Did the Hunt End - It Was a Suprisingly Easy Fight` | 102–124 |

Пять исходов по 20%; оплата, отказ или сложность боя не меняют кошелёк и характеристики.
...
| --- | --- | --- |
| [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json) | `ph4JxbZMB7MniZZ5`; documentUuid:102; range=[1,1] | `Witcher Lifepath: Hunt Generator`: при выборе диапазона и recursive:true вызывает этот документ |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Hunt - How Did It End?` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Lifepath: Hunt - How Did It End?: 1d10, возможные totals 1…10; 5 результатов (5 text / 0 document), replacement=true, displayRoll=false. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 1. Inline-выражений в результатах нет.
