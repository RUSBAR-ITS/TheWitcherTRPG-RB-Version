# packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__Power_1QUG4e60Iqom24ac.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__Power_1QUG4e60Iqom24ac.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__Power_1QUG4e60Iqom24ac.json) |
...
| SHA-256 файла | f6a02b3c4b4d08bfaa6bd5643974761e7323bc711639e3ead0fbfa4b15f85de6 |

## Назначение файла

Выбирает текстовый уровень силы врага от 1 до 10. Имя документа — `Witcher Lifepath: Danger - Enemies: Power`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.1QUG4e60Iqom24ac`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Danger - Enemies: Power`; `1QUG4e60Iqom24ac`; `!tables!1QUG4e60Iqom24ac` | Имя, ID и ключ хранения корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.b8Q3xqRgQIiiWsOg`; systemId/systemVersion/duplicateSource/exportSource=null | Метаданные происхождения; не ссылка для рекурсивного выбора |
...
| Result _id/_key | ID в перечне; `!tables.results!1QUG4e60Iqom24ac.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `q0DM4FW7XCnFdKZu` | [1,1] | text | `Enemies - Power Level: 1` | 10–32 |
| 2 | `oKZeEBIq2FLMNk2e` | [2,2] | text | `Enemies - Power Level: 2` | 33–55 |
| 3 | `kQX7ZeIIWKy5yTPF` | [3,3] | text | `Enemies - Power Level: 3` | 56–78 |
| 4 | `36ROPw9QWjYWmpBV` | [4,4] | text | `Enemies - Power Level: 4` | 79–101 |
| 5 | `9kVdEtFeX4a3nAoe` | [5,5] | text | `Enemies - Power Level: 5` | 102–124 |
| 6 | `cQfRuoxqB1FI58LA` | [6,6] | text | `Enemies - Power Level: 6` | 125–147 |
| 7 | `th9s2aW3pwS3ZZX2` | [7,7] | text | `Enemies - Power Level: 7` | 148–170 |
| 8 | `tfUjaxwfTwqW98vG` | [8,8] | text | `Enemies - Power Level: 8` | 171–193 |
| 9 | `XFy2l49tSxFMwvUu` | [9,9] | text | `Enemies - Power Level: 9` | 194–216 |
| 10 | `NlfhnGUfAnLtImRU` | [10,10] | text | `Enemies - Power Level: 10` | 217–239 |

Числа 1–10 находятся в description, а type=text. Возвращается TableResult с текстом, не числовая характеристика Power; уровень не связывается с Actor.
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Danger - Enemies: Power` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Lifepath: Danger - Enemies: Power: 1d10, возможные totals 1…10; 10 результатов (10 text / 0 document), replacement=true, displayRoll=false. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 1. Inline-выражений в результатах нет.
