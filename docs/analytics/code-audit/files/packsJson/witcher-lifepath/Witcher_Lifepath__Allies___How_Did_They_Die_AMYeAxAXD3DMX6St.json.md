# packsJson/witcher-lifepath/Witcher_Lifepath__Allies___How_Did_They_Die_AMYeAxAXD3DMX6St.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Allies___How_Did_They_Die_AMYeAxAXD3DMX6St.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Allies___How_Did_They_Die_AMYeAxAXD3DMX6St.json) |
...
| SHA-256 файла | bc0ad10cf4d8ee826ebed40a7ea8747caf336e8881bac2e022506e89f71f2c0b |

## Назначение файла

Выбирает текст причины смерти союзника. Имя документа — `Witcher Lifepath: Allies - How Did They Die`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.AMYeAxAXD3DMX6St`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Allies - How Did They Die`; `AMYeAxAXD3DMX6St`; `!tables!AMYeAxAXD3DMX6St` | Имя, ID и ключ хранения корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.0CW9cc84Wu6ygSi4`; systemId/systemVersion/duplicateSource/exportSource=null | Метаданные происхождения; не ссылка для рекурсивного выбора |
...
| Result _id/_key | ID в перечне; `!tables.results!AMYeAxAXD3DMX6St.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `q0DM4FW7XCnFdKZu` | [1,3] | text | `They died from a Bandit Attack.` | 10–32 |
| 2 | `oKZeEBIq2FLMNk2e` | [4,6] | text | `They died from a Monster Attack.` | 33–55 |
| 3 | `9kVdEtFeX4a3nAoe` | [7,9] | text | `They died as a Casualty of War.` | 56–78 |
| 4 | `OYauAXiemkJ6uwmM` | [10,10] | text | `They died Peacefully.` | 79–101 |

Вероятности Bandit Attack/Monster Attack/Casualty of War/Peacefully — 30/30/30/10%. В отличие от смерти врага, встроенного броска числа десятилетий здесь нет.
...
| --- | --- | --- |
| [packsJson/witcher-lifepath/Witcher_Lifepath__Allies___Are_They_Alive__2l9nl4ndvdgtn2SJ.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Allies___Are_They_Alive__2l9nl4ndvdgtn2SJ.json) | `WeN79l7ug6yDM7Qf`; documentUuid:53; range=[1,30] | `Witcher Lifepath: Allies - Are They Alive?`: при выборе диапазона и recursive:true вызывает этот документ |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Allies - How Did They Die` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Lifepath: Allies - How Did They Die: 1d10, возможные totals 1…10; 4 результатов (4 text / 0 document), replacement=true, displayRoll=false. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 1. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Allies___Are_They_Alive__2l9nl4ndvdgtn2SJ.json](Witcher_Lifepath__Allies___Are_They_Alive__2l9nl4ndvdgtn2SJ.json.md).
