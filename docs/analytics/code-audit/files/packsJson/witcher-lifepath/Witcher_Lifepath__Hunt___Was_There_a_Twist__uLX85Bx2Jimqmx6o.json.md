...
Определяет наличие осложнения охоты и при необходимости вызывает его подробную таблицу. Имя документа — `Witcher Lifepath: Hunt - Was There a Twist?`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Hunt - Was There a Twist?`; `uLX85Bx2Jimqmx6o`; `!tables!uLX85Bx2Jimqmx6o` | Имя, ID и ключ хранения корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.DJ7WtYF7tFFy7RiU`; systemId/systemVersion/duplicateSource/exportSource=null | Метаданные происхождения; не ссылка для рекурсивного выбора |
...
| Result _id/_key | ID в перечне; `!tables.results!uLX85Bx2Jimqmx6o.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `ciSfEh9nn9LIoeuR` | [1,4] | text | `Was There a Twist? - Yes` | 10–32 |
| 2 | `GYY5qvm0B5sAWS6S` | [1,4] | document | `Witcher Lifepath: Hunt - What Was the Twist?` | 33–56 |
| 3 | `Gl1XVUlHbuQVyANO` | [5,10] | text | `Was There a Twist? - No` | 57–79 |

Грани 1–4 дают Yes и ссылку на подробное осложнение (40%); 5–10 только No (60%). При recursive=false документная строка остаётся ссылкой, при true возвращается текст осложнения.
...
| --- | --- | --- |
| [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json) | `a90EHPhkX2hszHH8`; documentUuid:78; range=[1,1] | `Witcher Lifepath: Hunt Generator`: при выборе диапазона и recursive:true вызывает этот документ |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Hunt - Was There a Twist?` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Lifepath: Hunt - Was There a Twist?: 1d10, возможные totals 1…10; 3 результатов (2 text / 1 document), replacement=true, displayRoll=false. Рекурсивные переходы: Witcher Lifepath: Hunt - What Was the Twist?. По разрешимому графу от этого прямого входа 1–2 конечных текстов, максимальная глубина 1; входящих файлов 1. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json](Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___What_Was_the_Twist__ZyRLAmxDu5SVt7rg.json](Witcher_Lifepath__Hunt___What_Was_the_Twist__ZyRLAmxDu5SVt7rg.json.md).
