# packsJson/witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json) |
...
| Задача и порция | [TASK-0003.055](../../../../../tasks/task-0003.055.md); 41 файл / 8708 строк; этот файл — 126 строк |
| Запись перекрёстной сверки | [TASK-0003.055](../../../review-log.md#task-0003055) |
| SHA-256 файла | f204713db51b7e1a54e7207235f3655df4912c5625210038f3c693fc95206ed2 |

## Назначение файла

Собирает охоту: добычу, место, осложнение и исход. Имя документа — `Witcher Lifepath: Hunt Generator`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.vTIEP2TnU2n4hwY3`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Hunt Generator`; `vTIEP2TnU2n4hwY3`; `!tables!vTIEP2TnU2n4hwY3` | Имя, ID и ключ хранения корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.kTd41oVX7uEKIYMJ`; systemId/systemVersion/duplicateSource/exportSource=null | Метаданные происхождения; не ссылка для рекурсивного выбора |
...
| Result _id/_key | ID в перечне; `!tables.results!vTIEP2TnU2n4hwY3.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `q0DM4FW7XCnFdKZu` | [1,1] | document | `Witcher Lifepath: Hunt - What Was the Prey?` | 10–33 |
| 2 | `mp0F0yfLeczgHYKB` | [1,1] | document | `Witcher Lifepath: Hunt - Where Was the Prey?` | 34–57 |
| 3 | `a90EHPhkX2hszHH8` | [1,1] | document | `Witcher Lifepath: Hunt - Was There a Twist?` | 58–81 |
| 4 | `ph4JxbZMB7MniZZ5` | [1,1] | document | `Witcher Lifepath: Hunt - How Did It End?` | 82–105 |

Четыре результата [1,1] исполняются в порядке Prey → Where → Was There a Twist? → How Did It End?. Без осложнения получается 4 текста, с осложнением — 5. Это описание охоты: бой, монстр, награда и сцена не создаются.
...
| --- | --- | --- | --- |
| [1,1] | 4 | 1/1 | document + document + document + document |
...
При прямом запуске с _depth=0 граф допускает 4–5 конечных text; максимальная внутренняя глубина — 2. Эти границы получены отдельным обходом всех диапазонов и ссылок; проверки исполнения перебирали каждый основной результат и выбранные вложенные сочетания, не все комбинации графа. Ядро отклоняет _depth>5. Witcher Background Generator даёт максимальную глубину 4, его ветка RandomCharacter — 5; эти входы проверены отдельно.
...
| --- | --- | --- | --- |
| `q0DM4FW7XCnFdKZu`; [1,1] | `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.ZozZLNSgKpwEltsY` | [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___What_Was_the_Prey__ZozZLNSgKpwEltsY.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___What_Was_the_Prey__ZozZLNSgKpwEltsY.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Hunt___What_Was_the_Prey__ZozZLNSgKpwEltsY.json.md) | documentUuid:30; имя совпало с целью; recursive:true → innerTable.roll |
| `mp0F0yfLeczgHYKB`; [1,1] | `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.PUVAGxwjXlFhXrhv` | [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___Where_Was_the_Prey__PUVAGxwjXlFhXrhv.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___Where_Was_the_Prey__PUVAGxwjXlFhXrhv.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Hunt___Where_Was_the_Prey__PUVAGxwjXlFhXrhv.json.md) | documentUuid:54; имя совпало с целью; recursive:true → innerTable.roll |
| `a90EHPhkX2hszHH8`; [1,1] | `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.uLX85Bx2Jimqmx6o` | [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___Was_There_a_Twist__uLX85Bx2Jimqmx6o.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___Was_There_a_Twist__uLX85Bx2Jimqmx6o.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Hunt___Was_There_a_Twist__uLX85Bx2Jimqmx6o.json.md) | documentUuid:78; имя совпало с целью; recursive:true → innerTable.roll |
| `ph4JxbZMB7MniZZ5`; [1,1] | `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.n13vBwJk61euGPa1` | [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___How_Did_It_End__n13vBwJk61euGPa1.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___How_Did_It_End__n13vBwJk61euGPa1.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Hunt___How_Did_It_End__n13vBwJk61euGPa1.json.md) | documentUuid:102; имя совпало с целью; recursive:true → innerTable.roll |
...
| --- | --- | --- |
| [packsJson/witcher-lifepath/Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json) | `t7agSbQuKa3YhMog`; documentUuid:147; range=[3,3] | `Witcher Lifepath: Cautious Outcome`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/witcher-lifepath/Witcher_Lifepath__Non_Neutral_Outcome_sARR2vzegIiAh3uU.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Non_Neutral_Outcome_sARR2vzegIiAh3uU.json) | `t7agSbQuKa3YhMog`; documentUuid:147; range=[8,8] | `Witcher Lifepath: Non-Neutral Outcome`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/witcher-lifepath/Witcher_Lifepath__Normal_Outcome_Lu49KrUT3wDY1bJr.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Normal_Outcome_Lu49KrUT3wDY1bJr.json) | `t7agSbQuKa3YhMog`; documentUuid:147; range=[3,5] | `Witcher Lifepath: Normal Outcome`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/witcher-lifepath/Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json) | `t7agSbQuKa3YhMog`; documentUuid:147; range=[8,9] | `Witcher Lifepath: Risky Outcome`: при выборе диапазона и recursive:true вызывает этот документ |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Hunt Generator` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Lifepath: Hunt Generator: 1d1, возможные totals 1…1; 4 результатов (0 text / 4 document), replacement=true, displayRoll=false. Рекурсивные переходы: Witcher Lifepath: Hunt - What Was the Prey?; Witcher Lifepath: Hunt - Where Was the Prey?; Witcher Lifepath: Hunt - Was There a Twist?; Witcher Lifepath: Hunt - How Did It End?. По разрешимому графу от этого прямого входа 4–5 конечных текстов, максимальная глубина 2; входящих файлов 4. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json](Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Non_Neutral_Outcome_sARR2vzegIiAh3uU.json](Witcher_Lifepath__Non_Neutral_Outcome_sARR2vzegIiAh3uU.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Normal_Outcome_Lu49KrUT3wDY1bJr.json](Witcher_Lifepath__Normal_Outcome_Lu49KrUT3wDY1bJr.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json](Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___What_Was_the_Prey__ZozZLNSgKpwEltsY.json](Witcher_Lifepath__Hunt___What_Was_the_Prey__ZozZLNSgKpwEltsY.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___Where_Was_the_Prey__PUVAGxwjXlFhXrhv.json](Witcher_Lifepath__Hunt___Where_Was_the_Prey__PUVAGxwjXlFhXrhv.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___Was_There_a_Twist__uLX85Bx2Jimqmx6o.json](Witcher_Lifepath__Hunt___Was_There_a_Twist__uLX85Bx2Jimqmx6o.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___How_Did_It_End__n13vBwJk61euGPa1.json](Witcher_Lifepath__Hunt___How_Did_It_End__n13vBwJk61euGPa1.json.md).
