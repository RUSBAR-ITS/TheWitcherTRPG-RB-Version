# packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__What_Is_Their_Power__xxaxFJfMA29gLFOm.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__What_Is_Their_Power__xxaxFJfMA29gLFOm.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__What_Is_Their_Power__xxaxFJfMA29gLFOm.json) |
...
| SHA-256 файла | 8d49a8602bceff844e1c915a66ec37063bac756164dee815dbaba2611ce335c3 |

## Назначение файла

Выбирает источник силы врага. Имя документа — `Witcher Lifepath: Danger - Enemies: What Is Their Power?`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.xxaxFJfMA29gLFOm`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Danger - Enemies: What Is Their Power?`; `xxaxFJfMA29gLFOm`; `!tables!xxaxFJfMA29gLFOm` | Имя, ID и ключ хранения корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.FOueLJYJEiVT9hNH`; systemId/systemVersion/duplicateSource/exportSource=null | Метаданные происхождения; не ссылка для рекурсивного выбора |
...
| Result _id/_key | ID в перечне; `!tables.results!xxaxFJfMA29gLFOm.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `q0DM4FW7XCnFdKZu` | [1,2] | text | `Enemies - Power Source: Social Standing` | 10–32 |
| 2 | `tfUjaxwfTwqW98vG` | [3,4] | text | `Enemies - Power Source: Knowledge` | 33–55 |
| 3 | `XFy2l49tSxFMwvUu` | [5,6] | text | `Enemies - Power Source: Physical` | 56–78 |
| 4 | `NlfhnGUfAnLtImRU` | [7,8] | text | `Enemies - Power Source: Minions` | 79–101 |
| 5 | `9r21On8F1Le0wu4M` | [9,10] | text | `Enemies - Power Source: Magic` | 102–124 |

Пять источников по 20%; выбор Magic/Physical/Minions не меняет параметры врага и не порождает предметы.
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Danger - Enemies: What Is Their Power?` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Lifepath: Danger - Enemies: What Is Their Power?: 1d10, возможные totals 1…10; 5 результатов (5 text / 0 document), replacement=true, displayRoll=false. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 1. Inline-выражений в результатах нет.
