# packsJson/witcher-lifepath/Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json) |
...
| SHA-256 файла | c54e561227c8b3b63b24d975f6578b08f49bb412d7f22add62331d0e71b71a4e |
...
Выбирает исход рискованного десятилетия: преимущество, союзник, охота или отсутствие событий. Имя документа — `Witcher Lifepath: Risky Outcome`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.R6BzlpXysvPx6O5c`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Risky Outcome`; `R6BzlpXysvPx6O5c`; `!tables!R6BzlpXysvPx6O5c` | Имя, ID и ключ хранения корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.QePGYXnyLXGAKZgM`; systemId/systemVersion/duplicateSource/exportSource=null | Метаданные происхождения; не ссылка для рекурсивного выбора |
...
| Result _id/_key | ID в перечне; `!tables.results!R6BzlpXysvPx6O5c.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `UdHUplxRtBUmcUsy` | [1,5] | text | `This decade you gained a benefit:` | 10–32 |
| 2 | `26OatJZ2irFtE5Ly` | [1,5] | document | `Witcher Lifepath: Benefit Outcome` | 33–56 |
| 3 | `P2yeZWXSDGGrGeKW` | [6,7] | text | `This decade you gained an ally:` | 57–79 |
| 4 | `RVpgllc0boqo3hTN` | [6,7] | document | `Witcher Lifepath: Allies - Generator` | 80–103 |
| 5 | `YVCSNqm0kMcDxKF3` | [8,9] | text | `This decade you went on a hunt:` | 104–126 |
| 6 | `t7agSbQuKa3YhMog` | [8,9] | document | `Witcher Lifepath: Hunt Generator` | 127–150 |
| 7 | `gnrDCDMdILjGyQdl` | [10,10] | text | `Nothing noteworthy really happened for that decade of your life. You just wandered the world, slaying little monsters here and there.` | 151–173 |

Вероятности преимущество/союзник/охота/ничего — 50/20/20/10%. Risky Decade отдельно выбирает опасность; Outcome всегда выбирает один из четырёх исходов и не добавляет записи в Actor.general.lifeEvents.
...
| --- | --- | --- | --- |
| [1,5] | 2 | 5/10 | text + document |
| [6,7] | 2 | 2/10 | text + document |
| [8,9] | 2 | 2/10 | text + document |
| [10,10] | 1 | 1/10 | text |
...
| --- | --- | --- |
| [packsJson/character-generator/Witcher_Lifepath__Risky_Decade_6zn78Gj7lZtJfS90.json](../../../../../../packsJson/character-generator/Witcher_Lifepath__Risky_Decade_6zn78Gj7lZtJfS90.json) | `5k0jxtIvzmH6UNl5`; documentUuid:53; range=[1,25] | `Witcher Lifepath: Risky Decade`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/character-generator/Witcher_Lifepath__Risky_Decade_6zn78Gj7lZtJfS90.json](../../../../../../packsJson/character-generator/Witcher_Lifepath__Risky_Decade_6zn78Gj7lZtJfS90.json) | `OAW3DJizEEzA919s`; documentUuid:124; range=[26,100] | `Witcher Lifepath: Risky Decade`: при выборе диапазона и recursive:true вызывает этот документ |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Risky Outcome` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
| --- | --- | --- |
| [Witcher Lifepath: Risky Decade](../character-generator/Witcher_Lifepath__Risky_Decade_6zn78Gj7lZtJfS90.json.md) | `5k0jxtIvzmH6UNl5` | 53; [1,25] |
