# packsJson/witcher-lifepath/Witcher_Background__Where_Are_You_Now__w8GcZsTyPF85V5Rr.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Background__Where_Are_You_Now__w8GcZsTyPF85V5Rr.json](../../../../../../packsJson/witcher-lifepath/Witcher_Background__Where_Are_You_Now__w8GcZsTyPF85V5Rr.json) |
...
| SHA-256 файла | 04e1f70e38589b04863ea44adafb1750a3b585021b591cfa1922bfb525baf722 |

## Назначение файла

Выбирает текст текущего положения ведьмака после важного события. Имя документа — `Witcher Background: Where Are You Now?`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.w8GcZsTyPF85V5Rr`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Background: Where Are You Now?`; `w8GcZsTyPF85V5Rr`; `!tables!w8GcZsTyPF85V5Rr` | Имя, ID и ключ хранения корневого RollTable |
...
| Result _id/_key | ID в перечне; `!tables.results!w8GcZsTyPF85V5Rr.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `q0DM4FW7XCnFdKZu` | [1,1] | text | `Where Are You Now? - Became a Personal Witcher: You signed on to work for a merchant group, noble house, or important person as a personal witcher. You work for modest pay and hunt what they tell you to hunt. Mostly it’s monsters...` | 10–32 |
| 2 | `oKZeEBIq2FLMNk2e` | [2,2] | text | `Where Are You Now? - Looking For Work: The hard life of a witcher continues. You spend a lot of time on the road, lamenting the efficiency of your kind and the extinction of monsters. You travel constantly and never settle down` | 33–55 |
| 3 | `kQX7ZeIIWKy5yTPF` | [3,8] | text | `Where Are You Now? - Became a Hermit: You gave up on the life of a witcher and traveled out into the wilderness. Now you live as a hermit in the wilds. Only now that monsters are returning have you started to venture out again.` | 56–78 |
| 4 | `36ROPw9QWjYWmpBV` | [9,9] | text | `Where Are You Now? - Turned to a Normal Life: You’ve tried for decades to leave the witcher life behind. It’s difficult, since people won’t ever really accept you, but you have managed to cobble together an almost normal life. Good luck.` | 79–101 |
| 5 | `9kVdEtFeX4a3nAoe` | [10,10] | text | `Where Are You Now? - Became a Dangerous Criminal: Eventually all the negativity and thankless people got to you— you decided that with fewer and fewer monsters, it was time to start hunting people. You can determine what you do to survive.` | 102–124 |

Пять строк имеют вероятности 10%, 10%, 60%, 10%, 10%; weight=1 у каждой не делает их равновероятными при существующей formula. Текущая деятельность не записывается в профессию или инвентарь.
...
| --- | --- | --- |
| [packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json](../../../../../../packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json) | `sqyIMiR1RKv2AHJa`; documentUuid:53; range=[1,1] | `Witcher Background: What Was Your Most Important Event`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json](../../../../../../packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json) | `fCL38Rgrs0Zoi6tL`; documentUuid:100; range=[2,2] | `Witcher Background: What Was Your Most Important Event`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json](../../../../../../packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json) | `wV6AXUWCol53u7Qp`; documentUuid:147; range=[3,3] | `Witcher Background: What Was Your Most Important Event`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json](../../../../../../packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json) | `XdFNmzMBLOFAdT0a`; documentUuid:194; range=[4,4] | `Witcher Background: What Was Your Most Important Event`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json](../../../../../../packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json) | `l4vJrb9CXI7lFvOF`; documentUuid:241; range=[5,5] | `Witcher Background: What Was Your Most Important Event`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json](../../../../../../packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json) | `9ohWB7wfnoJIuyMj`; documentUuid:288; range=[6,6] | `Witcher Background: What Was Your Most Important Event`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json](../../../../../../packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json) | `olJrQIfiLqykKL6Y`; documentUuid:335; range=[7,7] | `Witcher Background: What Was Your Most Important Event`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json](../../../../../../packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json) | `e1QeDpvSCQW3TLl0`; documentUuid:382; range=[8,8] | `Witcher Background: What Was Your Most Important Event`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json](../../../../../../packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json) | `A6SuhFPiLwWjoYCB`; documentUuid:429; range=[9,9] | `Witcher Background: What Was Your Most Important Event`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json](../../../../../../packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json) | `9rYHpxRi9jvAeqhM`; documentUuid:476; range=[10,10] | `Witcher Background: What Was Your Most Important Event`: при выборе диапазона и recursive:true вызывает этот документ |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Background: Where Are You Now?` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Background: Where Are You Now?: 1d10, возможные totals 1…10; 5 результатов (5 text / 0 document), replacement=true, displayRoll=false. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 1. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/witcher-lifepath/Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json](Witcher_Background__What_Was_Your_Most_Important_Event_34nU6OswdgAyMC6p.json.md), [module/data/actor/templates/character/general/backgroundData.js](../../module/data/actor/templates/character/general/backgroundData.js.md), [module/data/item/professionData.js](../../module/data/item/professionData.js.md).
