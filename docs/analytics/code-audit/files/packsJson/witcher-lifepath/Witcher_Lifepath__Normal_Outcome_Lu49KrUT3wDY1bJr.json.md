...
| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Normal_Outcome_Lu49KrUT3wDY1bJr.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Normal_Outcome_Lu49KrUT3wDY1bJr.json) |
...
| SHA-256 файла | d8535b721eb7ffcbfd164e0b8224a0b6161b900363ea511d7a385d4961773283 |
...
Выбирает исход обычного десятилетия: преимущество, союзник, охота или отсутствие событий. Имя документа — `Witcher Lifepath: Normal Outcome`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.Lu49KrUT3wDY1bJr`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Normal Outcome`; `Lu49KrUT3wDY1bJr`; `!tables!Lu49KrUT3wDY1bJr` | Имя, ID и ключ хранения корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.DGTa2Fuin6IKce2Y`; systemId/systemVersion/duplicateSource/exportSource=null | Метаданные происхождения; не ссылка для рекурсивного выбора |
...
| Result _id/_key | ID в перечне; `!tables.results!Lu49KrUT3wDY1bJr.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| 5 | `YVCSNqm0kMcDxKF3` | [3,5] | text | `This decade you went on a hunt:` | 104–126 |
| 6 | `t7agSbQuKa3YhMog` | [3,5] | document | `Witcher Lifepath: Hunt Generator` | 127–150 |
| 7 | `gnrDCDMdILjGyQdl` | [6,10] | text | `Nothing noteworthy really happened for that decade of your life. You just wandered the world, slaying little monsters here and there.` | 151–173 |

Вероятности преимущество/союзник/охота/ничего — 10/10/30/50%. Normal Decade отдельно вызывает Dangers при опасном десятилетии; здесь нет автоматического чтения возраста или списка событий Actor.
...
| --- | --- | --- |
| [packsJson/character-generator/Witcher_Lifepath__Normal_Decade_dsvsdl2GfKCWKsEO.json](../../../../../../packsJson/character-generator/Witcher_Lifepath__Normal_Decade_dsvsdl2GfKCWKsEO.json) | `5k0jxtIvzmH6UNl5`; documentUuid:53; range=[1,75] | `Witcher Lifepath: Normal Decade`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/character-generator/Witcher_Lifepath__Normal_Decade_dsvsdl2GfKCWKsEO.json](../../../../../../packsJson/character-generator/Witcher_Lifepath__Normal_Decade_dsvsdl2GfKCWKsEO.json) | `OAW3DJizEEzA919s`; documentUuid:124; range=[76,100] | `Witcher Lifepath: Normal Decade`: при выборе диапазона и recursive:true вызывает этот документ |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Normal Outcome` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
| --- | --- | --- |
| [Witcher Lifepath: Normal Decade](../character-generator/Witcher_Lifepath__Normal_Decade_dsvsdl2GfKCWKsEO.json.md) | `5k0jxtIvzmH6UNl5` | 53; [1,75] |
| [Witcher Lifepath: Normal Decade](../character-generator/Witcher_Lifepath__Normal_Decade_dsvsdl2GfKCWKsEO.json.md) | `OAW3DJizEEzA919s` | 124; [76,100] |
...
Witcher Lifepath: Normal Outcome: 1d10, возможные totals 1…10; 7 результатов (4 text / 3 document), replacement=true, displayRoll=false. Рекурсивные переходы: Witcher Lifepath: Benefit Outcome; Witcher Lifepath: Allies - Generator; Witcher Lifepath: Hunt Generator. По разрешимому графу от этого прямого входа 1–8 конечных текстов, максимальная глубина 3; входящих файлов 1. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/character-generator/Witcher_Lifepath__Normal_Decade_dsvsdl2GfKCWKsEO.json](../character-generator/Witcher_Lifepath__Normal_Decade_dsvsdl2GfKCWKsEO.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Benefit_Outcome_snt4khwSoq2rdeZa.json](Witcher_Lifepath__Benefit_Outcome_snt4khwSoq2rdeZa.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Allies___Generator_47kWQhpq3yeAG74c.json](Witcher_Lifepath__Allies___Generator_47kWQhpq3yeAG74c.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json](Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json.md).
