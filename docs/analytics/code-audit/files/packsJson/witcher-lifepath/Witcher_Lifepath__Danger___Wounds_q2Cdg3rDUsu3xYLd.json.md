...
| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Wounds_q2Cdg3rDUsu3xYLd.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Wounds_q2Cdg3rDUsu3xYLd.json) |
...
| SHA-256 файла | ed809c6207d61491ec3fb988c469bf3dbbdb17044cd17de6b2e5d0f818dd89c8 |

## Назначение файла

Выбирает текст последствий ранения из десяти вариантов. Имя документа — `Witcher Lifepath: Danger - Wounds`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.q2Cdg3rDUsu3xYLd`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Danger - Wounds`; `q2Cdg3rDUsu3xYLd`; `!tables!q2Cdg3rDUsu3xYLd` | Имя, ID и ключ хранения корневого RollTable |
...
| Result _id/_key | ID в перечне; `!tables.results!q2Cdg3rDUsu3xYLd.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `q0DM4FW7XCnFdKZu` | [1,1] | text | `Wound - Stiff Knee (-1 SPD): A horrible wound to your leg left it shattered and nearly unrepairable. Even after surgery and a regimen of witcher potions, it has never been the same.` | 10–32 |
| 2 | `oKZeEBIq2FLMNk2e` | [2,2] | text | `Wound - Damaged Eye (-1 Sight Awareness): Usually witchers are fast enough to avoid a vital strike, but some monsters are too fast. A shot to your eye left it mildly hazy.` | 33–55 |
| 3 | `kQX7ZeIIWKy5yTPF` | [3,3] | text | `Wound - Stiff Arm (-1 Melee with that arm): A shattering blow to your arm left you with weeks of recovery and a stiff arm. You can still hold a sword and fight, but the stiffness always aggravates you.` | 56–78 |
| 4 | `36ROPw9QWjYWmpBV` | [4,4] | text | `Wound - Damaged Fingers (Can’t do signs with that hand): It may have been the result of torture or just a very unlucky strike to that hand in combat, but its fingers are stiff and awkward.` | 79–101 |
| 5 | `9kVdEtFeX4a3nAoe` | [5,5] | text | `Wound - Embedded Arrowhead (-1 Physique): A marksman’s shot and a barbed head left an arrowhead deep in your body, lodged in your muscle. Strenuous lifting has been painful ever since.` | 102–124 |
| 6 | `cQfRuoxqB1FI58LA` | [6,6] | text | `Wound - Wheeze (-5 Stamina): You may have been stabbed in the lung or inhaled a toxic gas. Either way, your lungs have been damaged; breathing normally is somewhat difficult.` | 125–147 |
| 7 | `th9s2aW3pwS3ZZX2` | [7,7] | text | `Wound - Huge Scar (-2 Charm &amp; Seduction): It’s not uncommon for a witcher’s body to be a patchwork of scars. However you have sustained a blow that disfigured your face.` | 148–170 |
| 8 | `tfUjaxwfTwqW98vG` | [8,8] | text | `Wound - Damaged Nose (-2 Scent Tracking): A number of punches to the face in bar fights (or toxic gases) have damaged your nose and nearly robbed you of your scent tracking.` | 171–193 |
| 9 | `XFy2l49tSxFMwvUu` | [9,9] | text | `Wound - Venom Damage (-5 Health): Toxins that once coursed though you left a patchwork of blackened veins around the wound and weakened your body.` | 194–216 |
| 10 | `NlfhnGUfAnLtImRU` | [10,10] | text | `Wound - Half Deafened (-1 Hearing Awareness): Many monsters use deadly sonic attacks. You were lucky enough to survive one, but your ears will never be the same.` | 217–239 |

Десять текстов по 10%. SPD, Physique, Stamina, Health, зрение/слух и ограничения знаков описаны словами; ни один результат не является Item/criticalWound, не содержит effects/changes и не ссылается на criticalWounds. Травма не добавляется автоматически.
...
| --- | --- | --- |
| [packsJson/witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json) | `9kVdEtFeX4a3nAoe`; documentUuid:54; range=[4,6] | `Witcher Lifepath: Dangers`: при выборе диапазона и recursive:true вызывает этот документ |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Danger - Wounds` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Lifepath: Danger - Wounds: 1d10, возможные totals 1…10; 10 результатов (10 text / 0 document), replacement=true, displayRoll=false. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 1. Inline-выражений в результатах нет.
