# packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___Where_Was_the_Prey__PUVAGxwjXlFhXrhv.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___Where_Was_the_Prey__PUVAGxwjXlFhXrhv.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___Where_Was_the_Prey__PUVAGxwjXlFhXrhv.json) |
...
| SHA-256 файла | 8f1f03d0521596325cffab99e01f000da9cb0541e4c172d6ed2046fdf0a5b8bc |

## Назначение файла

Выбирает место охоты. Имя документа — `Witcher Lifepath: Hunt - Where Was the Prey?`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.PUVAGxwjXlFhXrhv`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Hunt - Where Was the Prey?`; `PUVAGxwjXlFhXrhv`; `!tables!PUVAGxwjXlFhXrhv` | Имя, ID и ключ хранения корневого RollTable |
...
| Result _id/_key | ID в перечне; `!tables.results!PUVAGxwjXlFhXrhv.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `q0DM4FW7XCnFdKZu` | [1,1] | text | `Hunt Location - A Forest` | 10–32 |
| 2 | `oKZeEBIq2FLMNk2e` | [2,2] | text | `Hunt Location - A Building` | 33–55 |
| 3 | `kQX7ZeIIWKy5yTPF` | [3,3] | text | `Hunt Location - An Abandoned Building` | 56–78 |
| 4 | `36ROPw9QWjYWmpBV` | [4,4] | text | `Hunt Location - A Coast` | 79–101 |
| 5 | `9kVdEtFeX4a3nAoe` | [5,5] | text | `Hunt Location - The Mountains` | 102–124 |
| 6 | `cQfRuoxqB1FI58LA` | [6,6] | text | `Hunt Location - The City` | 125–147 |
| 7 | `th9s2aW3pwS3ZZX2` | [7,7] | text | `Hunt Location - A Graveyard` | 148–170 |
| 8 | `tfUjaxwfTwqW98vG` | [8,8] | text | `Hunt Location - A Hamlet` | 171–193 |
| 9 | `XFy2l49tSxFMwvUu` | [9,9] | text | `Hunt Location - Along the River` | 194–216 |
| 10 | `NlfhnGUfAnLtImRU` | [10,10] | text | `Hunt Location - A Cave` | 217–239 |

Десять мест по 10%; Scene/Region/JournalEntry не создаются.
...
| --- | --- | --- |
| [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json) | `mp0F0yfLeczgHYKB`; documentUuid:54; range=[1,1] | `Witcher Lifepath: Hunt Generator`: при выборе диапазона и recursive:true вызывает этот документ |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Hunt - Where Was the Prey?` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Lifepath: Hunt - Where Was the Prey?: 1d10, возможные totals 1…10; 10 результатов (10 text / 0 document), replacement=true, displayRoll=false. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 1. Inline-выражений в результатах нет.
