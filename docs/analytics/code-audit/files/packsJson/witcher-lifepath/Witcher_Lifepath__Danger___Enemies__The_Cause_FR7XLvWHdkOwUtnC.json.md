# packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__The_Cause_FR7XLvWHdkOwUtnC.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__The_Cause_FR7XLvWHdkOwUtnC.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__The_Cause_FR7XLvWHdkOwUtnC.json) |
...
| SHA-256 файла | aa7d4792d4e796b799e0d9fe05451f3c681547376c831fd1b05c366e83140cc0 |

## Назначение файла

Выбирает причину вражды. Имя документа — `Witcher Lifepath: Danger - Enemies: The Cause`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.FR7XLvWHdkOwUtnC`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Danger - Enemies: The Cause`; `FR7XLvWHdkOwUtnC`; `!tables!FR7XLvWHdkOwUtnC` | Имя, ID и ключ хранения корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.etyRT5AWtCJKkttH`; systemId/systemVersion/duplicateSource/exportSource=null | Метаданные происхождения; не ссылка для рекурсивного выбора |
...
| Result _id/_key | ID в перечне; `!tables.results!FR7XLvWHdkOwUtnC.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `q0DM4FW7XCnFdKZu` | [1,2] | text | `Enemies - The Cause: They Slandered You` | 10–32 |
| 2 | `oKZeEBIq2FLMNk2e` | [3,4] | text | `Enemies - The Cause: You Foiled Their Plan` | 33–55 |
| 3 | `kQX7ZeIIWKy5yTPF` | [5,6] | text | `Enemies - The Cause: They Betrayed You` | 56–78 |
| 4 | `36ROPw9QWjYWmpBV` | [7,8] | text | `Enemies - The Cause: You Killed Their Kin` | 79–101 |
| 5 | `9kVdEtFeX4a3nAoe` | [9,10] | text | `Enemies - The Cause: They Cheated You` | 102–124 |

Пять причин по 20%; ссылок на виновников, квесты или события нет.
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Danger - Enemies: The Cause` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Lifepath: Danger - Enemies: The Cause: 1d10, возможные totals 1…10; 5 результатов (5 text / 0 document), replacement=true, displayRoll=false. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 1. Inline-выражений в результатах нет.
