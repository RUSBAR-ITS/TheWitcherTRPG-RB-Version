# packsJson/witcher-lifepath/Witcher_Lifepath__Allies___How_You_Met_pr3upjAFiZVHdOXp.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Allies___How_You_Met_pr3upjAFiZVHdOXp.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Allies___How_You_Met_pr3upjAFiZVHdOXp.json) |
...
| SHA-256 файла | 6d37cd297c9587fa41ef95d78af454f76d4e046c0934226751d355e42b712eae |

## Назначение файла

Выбирает обстоятельства знакомства с союзником. Имя документа — `Witcher Lifepath: Allies - How You Met`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.pr3upjAFiZVHdOXp`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Allies - How You Met`; `pr3upjAFiZVHdOXp`; `!tables!pr3upjAFiZVHdOXp` | Имя, ID и ключ хранения корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.iijkQo4itEZnRNU4`; systemId/systemVersion/duplicateSource/exportSource=null | Метаданные происхождения; не ссылка для рекурсивного выбора |
...
| Result _id/_key | ID в перечне; `!tables.results!pr3upjAFiZVHdOXp.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `q0DM4FW7XCnFdKZu` | [1,1] | text | `How You Met Your Ally: Saved Them from Something` | 10–32 |
| 2 | `oKZeEBIq2FLMNk2e` | [2,2] | text | `How You Met Your Ally: Met in a Tavern` | 33–55 |
| 3 | `kQX7ZeIIWKy5yTPF` | [3,3] | text | `How You Met Your Ally: They Saved You from Something` | 56–78 |
| 4 | `36ROPw9QWjYWmpBV` | [4,4] | text | `How You Met Your Ally: They Hired You for Something` | 79–101 |
| 5 | `9kVdEtFeX4a3nAoe` | [5,5] | text | `How You Met Your Ally: You Were Trapped Together` | 102–124 |
| 6 | `cQfRuoxqB1FI58LA` | [6,6] | text | `How You Met Your Ally: You Were Forced to Work Together` | 125–147 |
| 7 | `th9s2aW3pwS3ZZX2` | [7,7] | text | `How You Met Your Ally: You Hired Them for Something` | 148–170 |
| 8 | `tfUjaxwfTwqW98vG` | [8,8] | text | `How You Met Your Ally: You Met While Drunk and Hit It Off` | 171–193 |
| 9 | `XFy2l49tSxFMwvUu` | [9,9] | text | `How You Met Your Ally: You Met While Traveling` | 194–216 |
| 10 | `NlfhnGUfAnLtImRU` | [10,10] | text | `How You Met Your Ally: You Fought Together` | 217–239 |

Десять одиночных диапазонов дают по 10%; рассказ о знакомстве не создаёт событие в Actor.general.lifeEvents.
...
| --- | --- | --- |
| [packsJson/witcher-lifepath/Witcher_Lifepath__Allies___Generator_47kWQhpq3yeAG74c.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Allies___Generator_47kWQhpq3yeAG74c.json) | `a90EHPhkX2hszHH8`; documentUuid:78; range=[1,1] | `Witcher Lifepath: Allies - Generator`: при выборе диапазона и recursive:true вызывает этот документ |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Allies - How You Met` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Lifepath: Allies - How You Met: 1d10, возможные totals 1…10; 10 результатов (10 text / 0 document), replacement=true, displayRoll=false. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 1. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Allies___Generator_47kWQhpq3yeAG74c.json](Witcher_Lifepath__Allies___Generator_47kWQhpq3yeAG74c.json.md).
