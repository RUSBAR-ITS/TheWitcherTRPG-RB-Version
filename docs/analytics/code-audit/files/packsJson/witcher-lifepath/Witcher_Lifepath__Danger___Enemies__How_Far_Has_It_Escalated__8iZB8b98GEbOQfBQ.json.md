# packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__How_Far_Has_It_Escalated__8iZB8b98GEbOQfBQ.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__How_Far_Has_It_Escalated__8iZB8b98GEbOQfBQ.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__How_Far_Has_It_Escalated__8iZB8b98GEbOQfBQ.json) |
...
| SHA-256 файла | 49bd435143665c180591f688e51eb5c9a706ebef59c8d75779348e2fc7b3552a |

## Назначение файла

Выбирает степень обострения вражды. Имя документа — `Witcher Lifepath: Danger - Enemies: How Far Has It Escalated?`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.8iZB8b98GEbOQfBQ`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Danger - Enemies: How Far Has It Escalated?`; `8iZB8b98GEbOQfBQ`; `!tables!8iZB8b98GEbOQfBQ` | Имя, ID и ключ хранения корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.UffuwqJpMXTFcVyq`; systemId/systemVersion/duplicateSource/exportSource=null | Метаданные происхождения; не ссылка для рекурсивного выбора |
...
| Result _id/_key | ID в перечне; `!tables.results!8iZB8b98GEbOQfBQ.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `q0DM4FW7XCnFdKZu` | [1,2] | text | `Enemy - How Far Has It Escalated: They have mostly forgotten` | 10–32 |
| 2 | `36ROPw9QWjYWmpBV` | [3,4] | text | `Enemy - How Far Has It Escalated: They plan to backstab you` | 33–55 |
| 3 | `cQfRuoxqB1FI58LA` | [5,6] | text | `Enemy - How Far Has It Escalated: They are outright violent if they see you` | 56–78 |
| 4 | `tfUjaxwfTwqW98vG` | [7,8] | text | `Enemy - How Far Has It Escalated: They will hunt for revenge` | 79–101 |
| 5 | `NlfhnGUfAnLtImRU` | [9,10] | text | `Enemy - How Far Has It Escalated: They are out for blood` | 102–124 |

Пять диапазонов по 20%; «забыли», «планируют удар», «открыто враждебны», «охотятся за местью», «жаждут крови» остаются текстом.
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Danger - Enemies: How Far Has It Escalated?` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Lifepath: Danger - Enemies: How Far Has It Escalated?: 1d10, возможные totals 1…10; 5 результатов (5 text / 0 document), replacement=true, displayRoll=false. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 1. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies_Generator_iwGZ1Sj0v9iBqvSk.json](Witcher_Lifepath__Danger___Enemies_Generator_iwGZ1Sj0v9iBqvSk.json.md).
