# packsJson/witcher-lifepath/Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json) |
...
| SHA-256 файла | ac486ecd70bfb0f06b84ecca4789043ae33d2d5e48f2a5b150f07132b85dbd43 |
...
Выбирает исход осторожного десятилетия: преимущество, союзник, охота или отсутствие заметных событий. Имя документа — `Witcher Lifepath: Cautious Outcome`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.jhPNDSApv5lQlUk3`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Cautious Outcome`; `jhPNDSApv5lQlUk3`; `!tables!jhPNDSApv5lQlUk3` | Имя, ID и ключ хранения корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.O5oQMFwMhO1z7z1U`; systemId/systemVersion/duplicateSource/exportSource=null | Метаданные происхождения; не ссылка для рекурсивного выбора |
...
| Result _id/_key | ID в перечне; `!tables.results!jhPNDSApv5lQlUk3.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `UdHUplxRtBUmcUsy` | [1,1] | text | `This decade you gained a benefit:` | 10–32 |
| 2 | `26OatJZ2irFtE5Ly` | [1,1] | document | `Witcher Lifepath: Benefit Outcome` | 33–56 |
| 3 | `P2yeZWXSDGGrGeKW` | [2,2] | text | `This decade you gained an ally:` | 57–79 |
| 4 | `RVpgllc0boqo3hTN` | [2,2] | document | `Witcher Lifepath: Allies - Generator` | 80–103 |
| 5 | `YVCSNqm0kMcDxKF3` | [3,3] | text | `This decade you went on a hunt:` | 104–126 |
| 6 | `t7agSbQuKa3YhMog` | [3,3] | document | `Witcher Lifepath: Hunt Generator` | 127–150 |
| 7 | `gnrDCDMdILjGyQdl` | [4,10] | text | `Nothing noteworthy really happened for that decade of your life. You just wandered the world, slaying little monsters here and there.` | 151–173 |

Вероятности преимущество/союзник/охота/ничего — 10/10/10/70%. Опасность здесь не выбирается: соответствующий Cautious Decade вызывает Dangers отдельной ветвью. Description предлагает один бросок за десятилетие после 29 лет; проверка возраста и повторение не реализованы данными.
...
| --- | --- | --- | --- |
| `26OatJZ2irFtE5Ly`; [1,1] | `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.snt4khwSoq2rdeZa` | [packsJson/witcher-lifepath/Witcher_Lifepath__Benefit_Outcome_snt4khwSoq2rdeZa.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Benefit_Outcome_snt4khwSoq2rdeZa.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Benefit_Outcome_snt4khwSoq2rdeZa.json.md) | documentUuid:53; имя совпало с целью; recursive:true → innerTable.roll |
| `RVpgllc0boqo3hTN`; [2,2] | `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.47kWQhpq3yeAG74c` | [packsJson/witcher-lifepath/Witcher_Lifepath__Allies___Generator_47kWQhpq3yeAG74c.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Allies___Generator_47kWQhpq3yeAG74c.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Allies___Generator_47kWQhpq3yeAG74c.json.md) | documentUuid:100; имя совпало с целью; recursive:true → innerTable.roll |
| `t7agSbQuKa3YhMog`; [3,3] | `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.vTIEP2TnU2n4hwY3` | [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json.md) | documentUuid:147; имя совпало с целью; recursive:true → innerTable.roll |
...
| --- | --- | --- |
| [packsJson/character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json](../../../../../../packsJson/character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json) | `5k0jxtIvzmH6UNl5`; documentUuid:53; range=[1,90] | `Witcher Lifepath: Cautious Decade`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json](../../../../../../packsJson/character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json) | `OAW3DJizEEzA919s`; documentUuid:124; range=[91,100] | `Witcher Lifepath: Cautious Decade`: при выборе диапазона и recursive:true вызывает этот документ |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Cautious Outcome` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
| --- | --- | --- |
| [Witcher Lifepath: Cautious Decade](../character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json.md) | `5k0jxtIvzmH6UNl5` | 53; [1,90] |
| [Witcher Lifepath: Cautious Decade](../character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json.md) | `OAW3DJizEEzA919s` | 124; [91,100] |
...
Witcher Lifepath: Cautious Outcome: 1d10, возможные totals 1…10; 7 результатов (4 text / 3 document), replacement=true, displayRoll=false. Рекурсивные переходы: Witcher Lifepath: Benefit Outcome; Witcher Lifepath: Allies - Generator; Witcher Lifepath: Hunt Generator. По разрешимому графу от этого прямого входа 1–8 конечных текстов, максимальная глубина 3; входящих файлов 1. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json](../character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Benefit_Outcome_snt4khwSoq2rdeZa.json](Witcher_Lifepath__Benefit_Outcome_snt4khwSoq2rdeZa.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Allies___Generator_47kWQhpq3yeAG74c.json](Witcher_Lifepath__Allies___Generator_47kWQhpq3yeAG74c.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json](Witcher_Lifepath__Hunt_Generator_vTIEP2TnU2n4hwY3.json.md).
