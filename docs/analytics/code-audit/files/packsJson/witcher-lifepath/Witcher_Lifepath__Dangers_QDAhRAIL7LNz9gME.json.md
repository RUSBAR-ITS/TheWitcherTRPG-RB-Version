# packsJson/witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json) |
| Тип файла | JSON: экспорт RollTable, 4 TableResult (1 text, 3 document) |
| Статус анализа | Проверено |
| Дата проверки | 2026-09-16: актуализация технических обращений по issue-00001 |
| Ветка и коммит | `dev`, база `d8e0e1ad1159cb71a8769b0353f812de6f1ed4d8` + незакоммиченное исправление issue-00001 |
| Изменения относительно коммита | issue-00001; текущие технические обращения актуализированы. Прежние опыты ниже относятся к своим датам. |
| Задача и порция | [TASK-0003.055](../../../../../tasks/task-0003.055.md); 41 файл / 8708 строк; этот файл — 125 строк |
| Запись перекрёстной сверки | [TASK-0003.055](../../../review-log.md#task-0003055) |
| SHA-256 файла | 7fd0835f37abbc2395aff0e12b227e238249317398001012d45a64ceac70e682 |
...
Разветвляет опасность десятилетия на событие, ранение или генерацию врага. Имя документа — `Witcher Lifepath: Dangers`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.QDAhRAIL7LNz9gME`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Dangers`; `QDAhRAIL7LNz9gME`; `!tables!QDAhRAIL7LNz9gME` | Имя, ID и ключ хранения корневого RollTable |
...
| Result _id/_key | ID в перечне; `!tables.results!QDAhRAIL7LNz9gME.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
Иконки результатов: `icons/svg/d20-grey.svg`, `icons/svg/d20-black.svg`. Указанные пути найдены в public/icons установленного ядра; HTTP и внешний вид не проверялись. Текст с бонусом не является изменением характеристики: в структуре нет Item, ActiveEffect, effects или changes.

| № | ID результата | range | type | Точное description для text / name для document | Строки записи |
| --- | --- | --- | --- | --- | --- |
| 1 | `36ROPw9QWjYWmpBV` | [1,3] | document | `Witcher Lifepath: Danger - Events` | 10–33 |
| 2 | `9kVdEtFeX4a3nAoe` | [4,6] | document | `Witcher Lifepath: Danger - Wounds` | 34–57 |
| 3 | `iDR3wgMsixJKTSTq` | [7,10] | text | `You have made an enemy.` | 58–80 |
| 4 | `cQfRuoxqB1FI58LA` | [7,10] | document | `Witcher Lifepath: Danger - Enemies Generator` | 81–104 |

Грани 1–3 дают Events, 4–6 — Wounds, 7–10 — сообщение о враге и Enemies Generator. Это 30/30/40%. После рекурсивного раскрытия получается 1 текст события/раны либо 8–9 текстов о враге. Сама таблица не выбирает риск десятилетия.
...
При прямом запуске с _depth=0 граф допускает 1–9 конечных text; максимальная внутренняя глубина — 3. Эти границы получены отдельным обходом всех диапазонов и ссылок; проверки исполнения перебирали каждый основной результат и выбранные вложенные сочетания, не все комбинации графа. Ядро отклоняет _depth>5. Witcher Background Generator даёт максимальную глубину 4, его ветка RandomCharacter — 5; эти входы проверены отдельно.
...
| --- | --- | --- | --- |
| `36ROPw9QWjYWmpBV`; [1,3] | `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.zVS3tsoiyTdjwU7i` | [packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Events_zVS3tsoiyTdjwU7i.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Events_zVS3tsoiyTdjwU7i.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Danger___Events_zVS3tsoiyTdjwU7i.json.md) | documentUuid:30; имя совпало с целью; recursive:true → innerTable.roll |
| `9kVdEtFeX4a3nAoe`; [4,6] | `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.q2Cdg3rDUsu3xYLd` | [packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Wounds_q2Cdg3rDUsu3xYLd.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Wounds_q2Cdg3rDUsu3xYLd.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Danger___Wounds_q2Cdg3rDUsu3xYLd.json.md) | documentUuid:54; имя совпало с целью; recursive:true → innerTable.roll |
| `cQfRuoxqB1FI58LA`; [7,10] | `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.iwGZ1Sj0v9iBqvSk` | [packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies_Generator_iwGZ1Sj0v9iBqvSk.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies_Generator_iwGZ1Sj0v9iBqvSk.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Danger___Enemies_Generator_iwGZ1Sj0v9iBqvSk.json.md) | documentUuid:101; имя совпало с целью; recursive:true → innerTable.roll |
...
| --- | --- | --- |
| [packsJson/character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json](../../../../../../packsJson/character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json) | `YVCSNqm0kMcDxKF3`; documentUuid:100; range=[91,100] | `Witcher Lifepath: Cautious Decade`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/character-generator/Witcher_Lifepath__Non_Neutral_Decade_obLsbuoNixBUbeAy.json](../../../../../../packsJson/character-generator/Witcher_Lifepath__Non_Neutral_Decade_obLsbuoNixBUbeAy.json) | `YVCSNqm0kMcDxKF3`; documentUuid:100; range=[51,100] | `Witcher Lifepath: Non-Neutral Decade`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/character-generator/Witcher_Lifepath__Normal_Decade_dsvsdl2GfKCWKsEO.json](../../../../../../packsJson/character-generator/Witcher_Lifepath__Normal_Decade_dsvsdl2GfKCWKsEO.json) | `YVCSNqm0kMcDxKF3`; documentUuid:100; range=[76,100] | `Witcher Lifepath: Normal Decade`: при выборе диапазона и recursive:true вызывает этот документ |
| [packsJson/character-generator/Witcher_Lifepath__Risky_Decade_6zn78Gj7lZtJfS90.json](../../../../../../packsJson/character-generator/Witcher_Lifepath__Risky_Decade_6zn78Gj7lZtJfS90.json) | `YVCSNqm0kMcDxKF3`; documentUuid:100; range=[26,100] | `Witcher Lifepath: Risky Decade`: при выборе диапазона и recursive:true вызывает этот документ |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Dangers` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Lifepath: Dangers: 1d10, возможные totals 1…10; 4 результатов (1 text / 3 document), replacement=true, displayRoll=false. Рекурсивные переходы: Witcher Lifepath: Danger - Events; Witcher Lifepath: Danger - Wounds; Witcher Lifepath: Danger - Enemies Generator. По разрешимому графу от этого прямого входа 1–9 конечных текстов, максимальная глубина 3; входящих файлов 4. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json](../character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json.md), [packsJson/character-generator/Witcher_Lifepath__Non_Neutral_Decade_obLsbuoNixBUbeAy.json](../character-generator/Witcher_Lifepath__Non_Neutral_Decade_obLsbuoNixBUbeAy.json.md), [packsJson/character-generator/Witcher_Lifepath__Normal_Decade_dsvsdl2GfKCWKsEO.json](../character-generator/Witcher_Lifepath__Normal_Decade_dsvsdl2GfKCWKsEO.json.md), [packsJson/character-generator/Witcher_Lifepath__Risky_Decade_6zn78Gj7lZtJfS90.json](../character-generator/Witcher_Lifepath__Risky_Decade_6zn78Gj7lZtJfS90.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Events_zVS3tsoiyTdjwU7i.json](Witcher_Lifepath__Danger___Events_zVS3tsoiyTdjwU7i.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Wounds_q2Cdg3rDUsu3xYLd.json](Witcher_Lifepath__Danger___Wounds_q2Cdg3rDUsu3xYLd.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies_Generator_iwGZ1Sj0v9iBqvSk.json](Witcher_Lifepath__Danger___Enemies_Generator_iwGZ1Sj0v9iBqvSk.json.md).
