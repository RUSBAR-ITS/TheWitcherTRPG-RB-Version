# packsJson/witcher-lifepath/Witcher_Background__How_Did_Early_Training_Go__u2n9HR4RhSt1QV3l.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Background__How_Did_Early_Training_Go__u2n9HR4RhSt1QV3l.json](../../../../../../packsJson/witcher-lifepath/Witcher_Background__How_Did_Early_Training_Go__u2n9HR4RhSt1QV3l.json) |
...
| SHA-256 файла | 9d051fa13503eafb346079c13d6dfa417700c8556c21f4173c7d88b600e4b4b9 |
...
Основная таблица раннего обучения: выбирает событие и вариант испытаний без исходного возрастного модификатора. Имя документа — `Witcher Background: How Did Early Training Go?`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.u2n9HR4RhSt1QV3l`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Background: How Did Early Training Go?`; `u2n9HR4RhSt1QV3l`; `!tables!u2n9HR4RhSt1QV3l` | Имя, ID и ключ хранения корневого RollTable |
...
| Result _id/_key | ID в перечне; `!tables.results!u2n9HR4RhSt1QV3l.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| 8 | `EjpUyBW2tKuwSB3E` | [4,4] | document | `Witcher Background: How Did Your Trials Go? +2` | 174–197 |
...
| 14 | `oyc8IVQRocy7fHWF` | [7,7] | document | `Witcher Background: How Did Your Trials Go? -2` | 315–338 |
...
Все десять граней дают пару text + document при неизменной formula=1d10. Суффикс 0 не является арифметикой формулы обучения; он обозначает вариант переходов к испытаниям. При грани 4 выбирается испытание +2, при 7 — −2, при остальных восьми — без модификатора. У базового варианта ветви 4/7 реализуют указанные в самих текстах +2/−2. Результаты с друзьями, врагами, диаграммой, характеристиками и навыками остаются описаниями; соответствующие генераторы/Item/ActiveEffect автоматически не вызываются.
...
| `EjpUyBW2tKuwSB3E`; [4,4] | `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.zNG1R1HQoY6tpSLz` | [packsJson/witcher-lifepath/Witcher_Background__How_Did_Your_Trials_Go___2_zNG1R1HQoY6tpSLz.json](../../../../../../packsJson/witcher-lifepath/Witcher_Background__How_Did_Your_Trials_Go___2_zNG1R1HQoY6tpSLz.json); [карточка](../witcher-lifepath/Witcher_Background__How_Did_Your_Trials_Go___2_zNG1R1HQoY6tpSLz.json.md) | documentUuid:194; имя совпало с целью; recursive:true → innerTable.roll |
...
| `oyc8IVQRocy7fHWF`; [7,7] | `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.CDX4hqsxcxxovYz3` | [packsJson/witcher-lifepath/Witcher_Background__How_Did_Your_Trials_Go___2_CDX4hqsxcxxovYz3.json](../../../../../../packsJson/witcher-lifepath/Witcher_Background__How_Did_Your_Trials_Go___2_CDX4hqsxcxxovYz3.json); [карточка](../witcher-lifepath/Witcher_Background__How_Did_Your_Trials_Go___2_CDX4hqsxcxxovYz3.json.md) | documentUuid:335; имя совпало с целью; recursive:true → innerTable.roll |
...
| --- | --- | --- |
| [packsJson/character-generator/Witcher_Background_Generator_C5d6zkIMvS9gDWEN.json](../../../../../../packsJson/character-generator/Witcher_Background_Generator_C5d6zkIMvS9gDWEN.json) | `d9NGvIh79ha1B9mq`; documentUuid:148; range=[3,8] | `Witcher Background Generator`: при выборе диапазона и recursive:true вызывает этот документ |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Background: How Did Early Training Go?` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
| --- | --- | --- |
| [Witcher Background Generator](../character-generator/Witcher_Background_Generator_C5d6zkIMvS9gDWEN.json.md) | `d9NGvIh79ha1B9mq` | 148; [3,8] |
...
Witcher Background: How Did Early Training Go?: 1d10, возможные totals 1…10; 20 результатов (10 text / 10 document), replacement=true, displayRoll=false. Рекурсивные переходы: Witcher Background: How Did Your Trials Go?; Witcher Background: How Did Your Trials Go? +2; Witcher Background: How Did Your Trials Go? -2. По разрешимому графу от этого прямого входа 4–4 конечных текстов, максимальная глубина 3; входящих файлов 1. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/character-generator/Witcher_Background_Generator_C5d6zkIMvS9gDWEN.json](../character-generator/Witcher_Background_Generator_C5d6zkIMvS9gDWEN.json.md), [packsJson/witcher-lifepath/Witcher_Background__How_Did_Your_Trials_Go__vaUFKIYBmEbJotfJ.json](Witcher_Background__How_Did_Your_Trials_Go__vaUFKIYBmEbJotfJ.json.md), [packsJson/witcher-lifepath/Witcher_Background__How_Did_Your_Trials_Go___2_zNG1R1HQoY6tpSLz.json](Witcher_Background__How_Did_Your_Trials_Go___2_zNG1R1HQoY6tpSLz.json.md), [packsJson/witcher-lifepath/Witcher_Background__How_Did_Your_Trials_Go___2_CDX4hqsxcxxovYz3.json](Witcher_Background__How_Did_Your_Trials_Go___2_CDX4hqsxcxxovYz3.json.md).
