# packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__Position_9m5zE1WyAI4xslyk.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__Position_9m5zE1WyAI4xslyk.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Danger___Enemies__Position_9m5zE1WyAI4xslyk.json) |
...
| SHA-256 файла | f5e8b5ae9244ccd822baa14f8bd71e3d62a4e8752c583e8fa16ee5cfe3cbeb64 |

## Назначение файла

Выбирает общественное положение врага. Имя документа — `Witcher Lifepath: Danger - Enemies: Position`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.9m5zE1WyAI4xslyk`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Danger - Enemies: Position`; `9m5zE1WyAI4xslyk`; `!tables!9m5zE1WyAI4xslyk` | Имя, ID и ключ хранения корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.IX4WMdc4Yuv0frYF`; systemId/systemVersion/duplicateSource/exportSource=null | Метаданные происхождения; не ссылка для рекурсивного выбора |
...
| Result _id/_key | ID в перечне; `!tables.results!9m5zE1WyAI4xslyk.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `q0DM4FW7XCnFdKZu` | [1,2] | text | `Enemies - Position: Nobleman` | 10–32 |
| 2 | `oKZeEBIq2FLMNk2e` | [3,4] | text | `Enemies - Position: Mercenary` | 33–55 |
| 3 | `kQX7ZeIIWKy5yTPF` | [5,6] | text | `Enemies - Position: Soldier` | 56–78 |
| 4 | `36ROPw9QWjYWmpBV` | [7,8] | text | `Enemies - Position: Merchant` | 79–101 |
| 5 | `9kVdEtFeX4a3nAoe` | [9,10] | text | `Enemies - Position: Criminal` | 102–124 |

Пять положений врага по 20%; это не документы профессий или персонажей.
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Danger - Enemies: Position` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Lifepath: Danger - Enemies: Position: 1d10, возможные totals 1…10; 5 результатов (5 text / 0 document), replacement=true, displayRoll=false. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 1. Inline-выражений в результатах нет.
