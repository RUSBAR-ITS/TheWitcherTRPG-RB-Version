# packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___What_Was_the_Twist__ZyRLAmxDu5SVt7rg.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___What_Was_the_Twist__ZyRLAmxDu5SVt7rg.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___What_Was_the_Twist__ZyRLAmxDu5SVt7rg.json) |
...
| SHA-256 файла | 0032bd75306a1b0426be5ab9c00250a7f8a386d5a6e6d89ad9a4318eb7e9efbc |

## Назначение файла

Выбирает текст осложнения охоты. Имя документа — `Witcher Lifepath: Hunt - What Was the Twist?`. Это данные для выборки и вывода описаний, включая явно заданные ссылки и формулы; самостоятельной программы изменения Actor/Item в JSON нет.

## Условия использования

[system.json](../../../../../../system.json):36,71–76 регистрирует RollTable-пакет Witcher_Lifepath_and_BG_Sub-tables в папке Character Generation с путём packs/witcher-lifepath.db. Адрес документа — `Compendium.TheWitcherTRPG.Witcher_Lifepath_and_BG_Sub-tables.RollTable.ZyRLAmxDu5SVt7rg`.
...
| --- | --- | --- |
| name, _id, _key | `Witcher Lifepath: Hunt - What Was the Twist?`; `ZyRLAmxDu5SVt7rg`; `!tables!ZyRLAmxDu5SVt7rg` | Имя, ID и ключ хранения корневого RollTable |
...
| Result _id/_key | ID в перечне; `!tables.results!ZyRLAmxDu5SVt7rg.<resultId>` | Ключи хранения; _key удалён строгой моделью из toObject |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `q0DM4FW7XCnFdKZu` | [1,1] | text | `Hunt Twist - The Monster Was Fake` | 10–32 |
| 2 | `oKZeEBIq2FLMNk2e` | [2,2] | text | `Hunt Twist - It Was All a Curse` | 33–55 |
| 3 | `kQX7ZeIIWKy5yTPF` | [3,3] | text | `Hunt Twist - The Monster Was Already Dead` | 56–78 |
| 4 | `36ROPw9QWjYWmpBV` | [4,4] | text | `Hunt Twist - It Wasn’t What You Thought` | 79–101 |
| 5 | `9kVdEtFeX4a3nAoe` | [5,5] | text | `Hunt Twist - Your Employer Wanted It Caught` | 102–124 |
| 6 | `cQfRuoxqB1FI58LA` | [6,6] | text | `Hunt Twist - The Employer Is to Blame For It All` | 125–147 |
| 7 | `th9s2aW3pwS3ZZX2` | [7,7] | text | `Hunt Twist - The Monster Was Harmless` | 148–170 |
| 8 | `tfUjaxwfTwqW98vG` | [8,8] | text | `Hunt Twist - It Was a Trap For You` | 171–193 |
| 9 | `XFy2l49tSxFMwvUu` | [9,9] | text | `Hunt Twist - It Was More Than You Were Told` | 194–216 |
| 10 | `NlfhnGUfAnLtImRU` | [10,10] | text | `Hunt Twist - A Mage Was Behind It All` | 217–239 |

Десять осложнений по 10%; даже Fake/Already Dead/Harmless не отменяют отдельный бросок How Did It End? родительской таблицы — автоматических условий по смыслу текста нет.
...
| --- | --- | --- |
| [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___Was_There_a_Twist__uLX85Bx2Jimqmx6o.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___Was_There_a_Twist__uLX85Bx2Jimqmx6o.json) | `GYY5qvm0B5sAWS6S`; documentUuid:53; range=[1,4] | `Witcher Lifepath: Hunt - Was There a Twist?`: при выборе диапазона и recursive:true вызывает этот документ |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Hunt - What Was the Twist?` | Общий поиск таблицы при экспорте добычи ожидает Item, а этот граф возвращает text |
...
Witcher Lifepath: Hunt - What Was the Twist?: 1d10, возможные totals 1…10; 10 результатов (10 text / 0 document), replacement=true, displayRoll=false. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 1. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Hunt___Was_There_a_Twist__uLX85Bx2Jimqmx6o.json](Witcher_Lifepath__Hunt___Was_There_a_Twist__uLX85Bx2Jimqmx6o.json.md).
