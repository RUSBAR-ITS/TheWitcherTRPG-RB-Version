...
Family Status: Northern: 1d10, возможные totals 1…10; 14 результатов (7 text / 7 document), replacement=true, displayRoll=false. Рекурсивные переходы: Most Influential Friend: Northern. По разрешимому графу от этого прямого входа 2–2 конечных текстов, максимальная глубина 1; входящих файлов 3. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/character-generator-sub-tables/Family_Fate__Northern_CN0lwXPHxkV2vDeY.json](Family_Fate__Northern_CN0lwXPHxkV2vDeY.json.md), [packsJson/character-generator-sub-tables/Parental_Fate__Northern_FQEyr6n57ae1ySLC.json](Parental_Fate__Northern_FQEyr6n57ae1ySLC.json.md), [packsJson/character-generator-sub-tables/Parents__Northern_SGuXziIZzzst1LVJ.json](Parents__Northern_SGuXziIZzzst1LVJ.json.md), [packsJson/character-generator-sub-tables/Most_Influential_Friend__Northern_Xc9k6o8pE8Aaj1Kb.json](Most_Influential_Friend__Northern_Xc9k6o8pE8Aaj1Kb.json.md).
