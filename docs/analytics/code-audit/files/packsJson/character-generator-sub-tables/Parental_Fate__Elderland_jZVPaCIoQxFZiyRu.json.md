...
Parental Fate: Elderland: 1d10, возможные totals 1…10; 21 результатов (10 text / 11 document), replacement=true, displayRoll=true. Рекурсивные переходы: Family Status: Elderland; Which Parent. По разрешимому графу от этого прямого входа 4–4 конечных текстов, максимальная глубина 2; входящих файлов 1. Inline-выражений в результатах нет.
