# packsJson/character-generator-sub-tables/Which_Parent_7fAXpaJLFwlWxkWX.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/character-generator-sub-tables/Which_Parent_7fAXpaJLFwlWxkWX.json](../../../../../../packsJson/character-generator-sub-tables/Which_Parent_7fAXpaJLFwlWxkWX.json) |
...
| Задача и порция | [TASK-0003.054](../../../../../tasks/task-0003.054.md); 35 файлов / 8319 строк; этот файл — 99 строк |
| Запись перекрёстной сверки | [TASK-0003.054](../../../review-log.md#task-0003054) |
| SHA-256 файла | a6ef87b2ab8dbdb09cf3683abd553e4d5d9747302868650e4e648f92b1b0db71 |

## Назначение файла

Уточняет, относится событие к отцу, матери или обоим родителям. Имя документа — `Which Parent`. Это экспорт таблицы для получения текста и раскрытия ссылок; собственных изменений параметров Actor, создания вещей или сущностей биографии в данных нет.
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.gT3TsAgTNme2wzAy`; systemId/systemVersion/duplicateSource/exportSource=null | История экспорта; источник происхождения не используется рекурсивным roll |
...
| Result _id, _key | ID ниже; `!tables.results!7fAXpaJLFwlWxkWX.<resultId>` | Уникальные ключи вложенных документов; _key не входит в toObject модели |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `FSiN9Lz0KFhVSqtl` | [1,4] | text | `Parental Fate, which parent: Father` | 10–32 |
| 2 | `NHxsyIUmt1tGSp3v` | [5,8] | text | `Parental Fate, which parent: Mother` | 33–55 |
| 3 | `XEDYdsBspEf428n1` | [9,10] | text | `Parental Fate, which parent: Both` | 56–78 |

Father 1–4, Mother 5–8, Both 9–10: 40%, 40%, 20%. Все три Parental Fate ссылаются на одну запись documentUuid с диапазоном 1–10. Поэтому уточняющий бросок выполняется на любом исходе судьбы родителей. Порядок текста в итоговом массиве определяется местом общей записи в JSON.
...
| --- | --- | --- |
| [packsJson/character-generator-sub-tables/Parental_Fate__Elderland_jZVPaCIoQxFZiyRu.json](../../../../../../packsJson/character-generator-sub-tables/Parental_Fate__Elderland_jZVPaCIoQxFZiyRu.json) | `uxEsX6eym5hKf3yX`; строка 77; range=[1,10] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Parental_Fate__Nilfgaard_wFuCDleU9PzP00mf.json](../../../../../../packsJson/character-generator-sub-tables/Parental_Fate__Nilfgaard_wFuCDleU9PzP00mf.json) | `uxEsX6eym5hKf3yX`; строка 77; range=[1,10] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Parental_Fate__Northern_FQEyr6n57ae1ySLC.json](../../../../../../packsJson/character-generator-sub-tables/Parental_Fate__Northern_FQEyr6n57ae1ySLC.json) | `uxEsX6eym5hKf3yX`; строка 53; range=[1,10] | При recursive:true вызывает эту RollTable |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Совпадение Item.name с `Which Parent` | Условный поиск при экспорте добычи; метод ожидает Item, а данный граф выдаёт text |
...
Which Parent: 1d10, возможные totals 1…10; 3 результатов (3 text / 0 document), replacement=true, displayRoll=true. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 3. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/character-generator-sub-tables/Parental_Fate__Elderland_jZVPaCIoQxFZiyRu.json](Parental_Fate__Elderland_jZVPaCIoQxFZiyRu.json.md), [packsJson/character-generator-sub-tables/Parental_Fate__Nilfgaard_wFuCDleU9PzP00mf.json](Parental_Fate__Nilfgaard_wFuCDleU9PzP00mf.json.md), [packsJson/character-generator-sub-tables/Parental_Fate__Northern_FQEyr6n57ae1ySLC.json](Parental_Fate__Northern_FQEyr6n57ae1ySLC.json.md).
