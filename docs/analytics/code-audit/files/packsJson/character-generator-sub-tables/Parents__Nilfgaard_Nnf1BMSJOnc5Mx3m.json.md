# packsJson/character-generator-sub-tables/Parents__Nilfgaard_Nnf1BMSJOnc5Mx3m.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/character-generator-sub-tables/Parents__Nilfgaard_Nnf1BMSJOnc5Mx3m.json](../../../../../../packsJson/character-generator-sub-tables/Parents__Nilfgaard_Nnf1BMSJOnc5Mx3m.json) |
...
| SHA-256 файла | 3515cec0d2b48d01feb8d1f0ffa0dc42e66f38e34f9010b14cf359077e6b2c06 |
...
Выбирает состояние родителей в Нильфгаарде и раскрывает семейное положение либо судьбу родителей. Имя документа — `Parents: Nilfgaard`. Это экспорт таблицы для получения текста и раскрытия ссылок; собственных изменений параметров Actor, создания вещей или сущностей биографии в данных нет.
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.KIJ9w7Yy8anfIVEe`; systemId/systemVersion/duplicateSource/exportSource=null | История экспорта; источник происхождения не используется рекурсивным roll |
...
| Result _id, _key | ID ниже; `!tables.results!Nnf1BMSJOnc5Mx3m.<resultId>` | Уникальные ключи вложенных документов; _key не входит в toObject модели |
...
| 2 | `MWl2EoIWD33CT3oV` | [1,1] | document | `Family Status: Nilfgaard` | 33–56 |
| 3 | `liefj3VOt3jFZnfH` | [2,2] | text | `Something Happened To Your Parents` | 57–79 |
| 4 | `a6YCIDdtwpoL5ytY` | [2,2] | document | `Parental Fate: Nilfgaard` | 80–103 |

На 1 выбираются текст Your Parents Are Alive и Family Status: Nilfgaard; на 2 — текст Something Happened To Your Parents и Parental Fate: Nilfgaard. По 50% для каждой группы. Первая группа даёт три текста; состав второй зависит от подтаблицы судьбы.
...
| --- | --- | --- |
| `MWl2EoIWD33CT3oV`, строка 53 | [Family Status: Nilfgaard](Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json.md) | `Compendium.TheWitcherTRPG-RB-Version.Character-gen_Sub-tables.RollTable.6WXA7KAOHjeqCCRn` |
| `a6YCIDdtwpoL5ytY`, строка 100 | [Parental Fate: Nilfgaard](Parental_Fate__Nilfgaard_wFuCDleU9PzP00mf.json.md) | `Compendium.TheWitcherTRPG-RB-Version.Character-gen_Sub-tables.RollTable.wFuCDleU9PzP00mf` |

## Известные потребители

| Файл / компонент | Запись / используемые данные | Условия |
| --- | --- | --- |
| [packsJson/character-generator-sub-tables/Family_and_Parents__Nilfgaard_5OcHT6WrJ8pL9cYp.json](../../../../../../packsJson/character-generator-sub-tables/Family_and_Parents__Nilfgaard_5OcHT6WrJ8pL9cYp.json) | `VySuFOPm5I8jY8r9`; строка 53; range=[1,1] | При recursive:true вызывает эту RollTable |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Совпадение Item.name с `Parents: Nilfgaard` | Условный поиск при экспорте добычи; метод ожидает Item, а данный граф выдаёт text |
