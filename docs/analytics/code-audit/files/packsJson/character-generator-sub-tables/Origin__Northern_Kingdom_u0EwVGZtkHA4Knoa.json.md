# packsJson/character-generator-sub-tables/Origin__Northern_Kingdom_u0EwVGZtkHA4Knoa.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/character-generator-sub-tables/Origin__Northern_Kingdom_u0EwVGZtkHA4Knoa.json](../../../../../../packsJson/character-generator-sub-tables/Origin__Northern_Kingdom_u0EwVGZtkHA4Knoa.json) |
...
| SHA-256 файла | 9385acdf0364a21de9c1fd8a5e1a923dd55b04189824f0dcf7a13c7862400e87 |

## Назначение файла

Выбирает одно из десяти северных происхождений с текстовым указанием бонуса. Имя документа — `Origin: Northern Kingdom`. Это экспорт таблицы для получения текста и раскрытия ссылок; собственных изменений параметров Actor, создания вещей или сущностей биографии в данных нет.
...
| --- | --- | --- |
| name, _id, _key | `Origin: Northern Kingdom`; `u0EwVGZtkHA4Knoa`; `!tables!u0EwVGZtkHA4Knoa` | Имя, идентификатор и ключ корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.U27SlKsxbIzCfkOP`; systemId/systemVersion/duplicateSource/exportSource=null | История экспорта; источник происхождения не используется рекурсивным roll |
...
| Result _id, _key | ID ниже; `!tables.results!u0EwVGZtkHA4Knoa.<resultId>` | Уникальные ключи вложенных документов; _key не входит в toObject модели |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `8UG84FSvmBKRmwHI` | [1,1] | text | `Redania (+1 Education)` | 10–32 |
| 2 | `YxO7ky9eSVJUOI3N` | [2,2] | text | `Kaedwen (+1 Endurance)` | 33–55 |
| 3 | `Qch5z1vn6YQagvCO` | [3,3] | text | `Temeria (+1 Charisma)` | 56–78 |
| 4 | `2zCNPnCinG46jtWE` | [4,4] | text | `Aedirn (+1 Crafting)` | 79–101 |
| 5 | `zr9L8SkmKgKC3FJH` | [5,5] | text | `Lyria &amp; Rivia (+1 Resist Coercion)` | 102–124 |
| 6 | `Fk8gK60UrUNEvhTk` | [6,6] | text | `Kovir &amp; Poviss (+1 Business)` | 125–147 |
| 7 | `M2HENBWyZLf6ss7y` | [7,7] | text | `Skellige (+1 Courage)` | 148–170 |
| 8 | `IpJb93nRxSWccCmT` | [8,8] | text | `Cidaris (+1 Sailing)` | 171–193 |
| 9 | `jCsO4hX1EfeRlY8p` | [9,9] | text | `Verden (+1 Wilderness Survival)` | 194–216 |
| 10 | `BJSnWUWuLLZdzDQF` | [10,10] | text | `Cintra (+1 Human Perception)` | 217–239 |

Десять равновероятных записей. Lyria &amp; Rivia и Kovir &amp; Poviss содержат HTML-сущности; они передаются как часть HTML описания. Запись объединённых названий не сопоставляется автоматически с отдельными ключами config.homelands.
...
| --- | --- | --- |
| [packsJson/character-generator/Background_Generator__Human_g9I3DpPOi5CfOFBz.json](../../../../../../packsJson/character-generator/Background_Generator__Human_g9I3DpPOi5CfOFBz.json) | `0dQ3NR8YsZjPzHul`; строка 56; range=[1,1] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Origin__Human_Lands_de64KicDG5R7FFO9.json](../../../../../../packsJson/character-generator-sub-tables/Origin__Human_Lands_de64KicDG5R7FFO9.json) | `nX4mbx8F2ITxvBNF`; строка 30; range=[1,1] | При recursive:true вызывает эту RollTable |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Совпадение Item.name с `Origin: Northern Kingdom` | Условный поиск при экспорте добычи; метод ожидает Item, а данный граф выдаёт text |
...
| --- | --- | --- |
| [Background Generator: Human](../character-generator/Background_Generator__Human_g9I3DpPOi5CfOFBz.json.md) | `0dQ3NR8YsZjPzHul` | 56; [1,1] |
...
Origin: Northern Kingdom: 1d10, возможные totals 1…10; 10 результатов (10 text / 0 document), replacement=true, displayRoll=true. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 2. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/character-generator-sub-tables/Origin__Human_Lands_de64KicDG5R7FFO9.json](Origin__Human_Lands_de64KicDG5R7FFO9.json.md), [packsJson/character-generator/Background_Generator__Human_g9I3DpPOi5CfOFBz.json](../character-generator/Background_Generator__Human_g9I3DpPOi5CfOFBz.json.md), [module/data/item/homelandData.js](../../module/data/item/homelandData.js.md), [module/data/item/professionData.js](../../module/data/item/professionData.js.md), [module/actor/sheets/WitcherCharacterSheet.js](../../module/actor/sheets/WitcherCharacterSheet.js.md).
