# packsJson/character-generator-sub-tables/Most_Influential_Friend__Nilfgaard_8R2zAqegJcbDr4xB.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/character-generator-sub-tables/Most_Influential_Friend__Nilfgaard_8R2zAqegJcbDr4xB.json](../../../../../../packsJson/character-generator-sub-tables/Most_Influential_Friend__Nilfgaard_8R2zAqegJcbDr4xB.json) |
...
| SHA-256 файла | ceb72939178d0e7eba6be300d860461c46eefb92b2ff10539b90600ee7b1e33a |

## Назначение файла

Выбирает влиятельного знакомого в Нильфгаарде и текст памятной вещи. Имя документа — `Most Influential Friend: Nilfgaard`. Это экспорт таблицы для получения текста и раскрытия ссылок; собственных изменений параметров Actor, создания вещей или сущностей биографии в данных нет.
...
Адрес по манифесту и ID — `Compendium.TheWitcherTRPG.Character-gen_Sub-tables.RollTable.8R2zAqegJcbDr4xB`. Штатный лист/каталог Foundry вызывает draw; другой генератор может получить таблицу через documentUuid. При стандартном recursive:true выбираются конечные текстовые результаты, при false документные записи остаются ссылками. Наличие экспорта не доказывает состояние установленной БД или доступ пользователя.

## Введённые сущности и действия с ними

| Сущность / поля | Значение | Действия и смысл |
| --- | --- | --- |
| name, _id, _key | `Most Influential Friend: Nilfgaard`; `8R2zAqegJcbDr4xB`; `!tables!8R2zAqegJcbDr4xB` | Имя, идентификатор и ключ корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.KZr760ifhM61v8LL`; systemId/systemVersion/duplicateSource/exportSource=null | История экспорта; источник происхождения не используется рекурсивным roll |
...
| Result _id, _key | ID ниже; `!tables.results!8R2zAqegJcbDr4xB.<resultId>` | Уникальные ключи вложенных документов; _key не входит в toObject модели |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `JFQp11xOxJvsDKNM` | [1,1] | text | `Most Influential Friend: The Cult of the Great Sun - Your greatest influence was the Church. You spent years learning chants and rituals. Gear: A Ceremonial Mask` | 10–32 |
| 2 | `VgZylS4pJWSlcJfl` | [2,2] | text | `Most Influential Friend: An Outcast - Your greatest influence was a social outcast who taught you to always question society. Gear: A Bright Colorful Badge` | 33–55 |
| 3 | `TdQRXB7UbEfdV35d` | [3,3] | text | `Most Influential Friend: A Count - Your greatest influence was a count who taught you how to lead and instill order. Gear: A Silver Necklace` | 56–78 |
| 4 | `Y8g0DWGZfC5wLYWx` | [4,4] | text | `Most Influential Friend: A Mage - Your greatest influence was a mage who taught you the importance of order and caution. Gear: An Emblem` | 79–101 |
| 5 | `XObJWkbk3Q5PzG1h` | [5,5] | text | `Most Influential Friend: A Solicitor - Your greatest influence was an imperial detective. You spent a lot of time solving mysteries. Gear: A Magnifying Lens` | 102–124 |
| 6 | `DCx5bDeMkPrAW8Lu` | [6,6] | text | `Most Influential Friend: A Mage Hunter - Your greatest influence was a mage hunter who taught you to be cautious of magic and mages. Gear: A Ring with Dimeritium` | 125–147 |
| 7 | `ZchxXpW2jQc3iPVU` | [7,7] | text | `Most Influential Friend: A Man At Arms - Your greatest influence was a soldier who shared stories of danger and excitement. Gear: A Trophy of Battle` | 148–170 |
| 8 | `u4lXsez4UGjAY14R` | [8,8] | text | `Most Influential Friend: An Artisan - Your greatest influence was an artisan who taught you to appreciate skill and precision. Gear: A Trinket You Made` | 171–193 |
| 9 | `p0WUkxWYGUPh4gEB` | [9,9] | text | `Most Influential Friend: A Sentient Monster - Your greatest influence was a sentient monster that taught you that not all monsters are evil. Gear: A Strange Totem` | 194–216 |
| 10 | `VSc9ry4JowYa3Rgz` | [10,10] | text | `Most Influential Friend: An Entertainer - Your greatest influence was an entertainer who taught you to express yourself. Gear: A Token from a Fan` | 217–239 |

Десять равновероятных text-результатов, каждый описывает знакомого, его влияние и вещь Gear. Family Status: Nilfgaard ссылается сюда из каждой своей группы; полученный текст не создаёт Actor знакомого или Item вещи.
...
| --- | --- | --- |
| [packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json](../../../../../../packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json) | `YKSa1ZWzSmILymvX`; строка 53; range=[1,1] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json](../../../../../../packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json) | `lisAkdcM9LZzCIFB`; строка 100; range=[2,2] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json](../../../../../../packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json) | `bjZwAmuqXpNKHjAg`; строка 147; range=[3,3] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json](../../../../../../packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json) | `vZecLds1BUXGxeQg`; строка 194; range=[4,4] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json](../../../../../../packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json) | `srTNN36Ce2HHSisB`; строка 241; range=[5,5] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json](../../../../../../packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json) | `ye32sHyFgcEeHX1J`; строка 288; range=[6,7] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json](../../../../../../packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json) | `6jOqPsAISSRQJWuL`; строка 335; range=[8,10] | При recursive:true вызывает эту RollTable |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Совпадение Item.name с `Most Influential Friend: Nilfgaard` | Условный поиск при экспорте добычи; метод ожидает Item, а данный граф выдаёт text |
...
Most Influential Friend: Nilfgaard: 1d10, возможные totals 1…10; 10 результатов (10 text / 0 document), replacement=true, displayRoll=true. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 1. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/character-generator-sub-tables/Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json](Family_Status__Nilfgaard_6WXA7KAOHjeqCCRn.json.md).
