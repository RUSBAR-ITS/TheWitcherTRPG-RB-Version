# packsJson/character-generator-sub-tables/Most_Influential_Friend__Elderland_eATe1gk2PaKG1K9r.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/character-generator-sub-tables/Most_Influential_Friend__Elderland_eATe1gk2PaKG1K9r.json](../../../../../../packsJson/character-generator-sub-tables/Most_Influential_Friend__Elderland_eATe1gk2PaKG1K9r.json) |
...
| SHA-256 файла | 9c501bceca8f7c9d514f73324c3f02e176c0dd088efb425354538c72ca9fc1ad |

## Назначение файла

Выбирает влиятельного знакомого в землях старших рас и текст памятной вещи. Имя документа — `Most Influential Friend: Elderland`. Это экспорт таблицы для получения текста и раскрытия ссылок; собственных изменений параметров Actor, создания вещей или сущностей биографии в данных нет.
...
Адрес по манифесту и ID — `Compendium.TheWitcherTRPG.Character-gen_Sub-tables.RollTable.eATe1gk2PaKG1K9r`. Штатный лист/каталог Foundry вызывает draw; другой генератор может получить таблицу через documentUuid. При стандартном recursive:true выбираются конечные текстовые результаты, при false документные записи остаются ссылками. Наличие экспорта не доказывает состояние установленной БД или доступ пользователя.

## Введённые сущности и действия с ними

| Сущность / поля | Значение | Действия и смысл |
| --- | --- | --- |
| name, _id, _key | `Most Influential Friend: Elderland`; `eATe1gk2PaKG1K9r`; `!tables!eATe1gk2PaKG1K9r` | Имя, идентификатор и ключ корневого RollTable |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.Hb0fJCOlltctoiGg`; systemId/systemVersion/duplicateSource/exportSource=null | История экспорта; источник происхождения не используется рекурсивным roll |
...
| Result _id, _key | ID ниже; `!tables.results!eATe1gk2PaKG1K9r.<resultId>` | Уникальные ключи вложенных документов; _key не входит в toObject модели |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `JFQp11xOxJvsDKNM` | [1,1] | text | `Most Influential Friend: A Human - Your greatest influence was a human who taught you that sometimes racism is unfounded. Gear: A Straw Doll` | 10–32 |
| 2 | `VgZylS4pJWSlcJfl` | [2,2] | text | `Most Influential Friend: An Artisan - Your greatest influence was an artisan who taught you to appreciate great elderfolk art. Gear: A Small Token You Made` | 33–55 |
| 3 | `TdQRXB7UbEfdV35d` | [3,3] | text | `Most Influential Friend: A Noble Warrior - Your greatest influence was a War Dancer or a Mahakaman Defender who taught you honor. Gear: A Token of Battle` | 56–78 |
| 4 | `Y8g0DWGZfC5wLYWx` | [4,4] | text | `Most Influential Friend: A Highborn - Your greatest influence was a highborn who taught you pride and how to comport yourself. Gear: A Signet Ring` | 79–101 |
| 5 | `XObJWkbk3Q5PzG1h` | [5,5] | text | `Most Influential Friend: An Entertainer - Your greatest influence was an entertainer who taught you the importance of happiness and beauty. Gear: A Playbill or Ticket` | 102–124 |
| 6 | `DCx5bDeMkPrAW8Lu` | [6,6] | text | `Most Influential Friend: A Raider - Your greatest influence was a raider who taught you that you have the right to take what you need. Gear: A Satchel` | 125–147 |
| 7 | `ZchxXpW2jQc3iPVU` | [7,7] | text | `Most Influential Friend: A Sage - Your greatest influence was a sage who taught you about the importance of elderfolk history. Gear: A Book of Tales` | 148–170 |
| 8 | `u4lXsez4UGjAY14R` | [8,8] | text | `Most Influential Friend: A Criminal - Your greatest influence was a criminal who taught you to follow your own rules. Gear: A Mask` | 171–193 |
| 9 | `p0WUkxWYGUPh4gEB` | [9,9] | text | `Most Influential Friend: A Hunter - Your greatest influence was a hunter who taught you how to survive in the wilderness. Gear: A Trophy of a Hunt` | 194–216 |
| 10 | `VSc9ry4JowYa3Rgz` | [10,10] | text | `Most Influential Friend: A Lowland Farmer - Your greatest influence was a lowland farmer who taught you how to live happily. Gear: A Farmer’s Spade` | 217–239 |

Десять равновероятных text-результатов, каждый описывает знакомого, его влияние и вещь Gear. Family Status: Elderland ссылается сюда из каждой своей группы; полученный текст не создаёт Actor знакомого или Item вещи.
...
| --- | --- | --- |
| [packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json](../../../../../../packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json) | `LiQWRDw0kOEenPPp`; строка 53; range=[1,1] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json](../../../../../../packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json) | `vBcbI8JHB2iuiCQO`; строка 100; range=[2,2] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json](../../../../../../packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json) | `QopwFO4hi11CVLBs`; строка 147; range=[3,3] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json](../../../../../../packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json) | `b9GGs4YL9DwKfbkX`; строка 194; range=[4,4] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json](../../../../../../packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json) | `LG0Lavg7kvcwJdo1`; строка 241; range=[5,5] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json](../../../../../../packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json) | `RyojgGJJe81WldwQ`; строка 288; range=[6,7] | При recursive:true вызывает эту RollTable |
| [packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json](../../../../../../packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json) | `KJ1xz0E7zcKtO4Az`; строка 335; range=[8,10] | При recursive:true вызывает эту RollTable |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Совпадение Item.name с `Most Influential Friend: Elderland` | Условный поиск при экспорте добычи; метод ожидает Item, а данный граф выдаёт text |
...
Most Influential Friend: Elderland: 1d10, возможные totals 1…10; 10 результатов (10 text / 0 document), replacement=true, displayRoll=true. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 1. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json](Family_Status__Elderland_GOp8mGE4MiGaqjk2.json.md).
