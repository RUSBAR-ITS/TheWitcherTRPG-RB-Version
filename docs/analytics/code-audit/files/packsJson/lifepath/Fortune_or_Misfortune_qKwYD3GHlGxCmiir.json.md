...
Адрес по манифесту и ID: `Compendium.TheWitcherTRPG-RB-Version.Life_Event_Sub-tables.RollTable.qKwYD3GHlGxCmiir`. Штатный draw доступен через лист/каталог таблиц; внешние потребители могут разрешить UUID или найти документ по имени. Экспорт не подтверждает совпадение с действующей БД и права конкретного игрока.
...
| `JQmqgYHhLo9rqERr`: `Misfortune` | [Misfortune_JNbvihde5EGIFPdB.json](Misfortune_JNbvihde5EGIFPdB.json.md) | `Compendium.TheWitcherTRPG-RB-Version.Life_Event_Sub-tables.RollTable.JNbvihde5EGIFPdB`; recursive:true раскрывает RollTable, false сохраняет ссылку |
| `cUNRbBflCqmrkzp7`: `Fortune` | [Fortune_Z0eeWQI3R8v4YNLd.json](Fortune_Z0eeWQI3R8v4YNLd.json.md) | `Compendium.TheWitcherTRPG-RB-Version.Life_Event_Sub-tables.RollTable.Z0eeWQI3R8v4YNLd`; recursive:true раскрывает RollTable, false сохраняет ссылку |
