...
| Изменения относительно коммита | Нет; 104 строк; SHA-256 f53c2b8746a471ce3e464df0f8e8aa5ebc419a64a2ffbcf8e6ff4658d86ffa0b |
...
| --- | --- | --- | --- | --- |
| Sprained Leg (Right) | Корневой Item, name: 3, _id: 101 | Шаблон травмы | `VhwzsUlv5csYSJTM`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.VhwzsUlv5csYSJTM` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.fNiSVOJzpaxVvZTE"` | DocumentUUIDField типа Item; treat загружает адресата и инициирует замену. |
