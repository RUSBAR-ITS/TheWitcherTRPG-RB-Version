...
| Изменения относительно коммита | Нет; 92 строк; SHA-256 eaf08939db9cd21f253c4a1b4c7df94f263c5f3c97e17761387f39bea5b53780 |
...
| --- | --- | --- | --- | --- |
| Cracked Ribs | Корневой Item, name: 3, _id: 5 | Шаблон травмы | `7TzGQ2y4yZnG01im`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.7TzGQ2y4yZnG01im` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.2c4PbGjd0segbvmr"` | DocumentUUIDField типа Item; treat загружает адресата и инициирует замену. |
