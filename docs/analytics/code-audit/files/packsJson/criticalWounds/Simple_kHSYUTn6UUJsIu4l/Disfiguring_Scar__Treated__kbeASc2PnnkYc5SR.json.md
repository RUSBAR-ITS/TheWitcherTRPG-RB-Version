...
| Изменения относительно коммита | Нет; 92 строк; SHA-256 063aa77214100239207b495cc67bc069823a2721ce5d21951d3724b48dc55077 |
...
| --- | --- | --- | --- | --- |
| Disfiguring Scar (Treated) | Корневой Item, name: 3, _id: 85 | Шаблон травмы | `kbeASc2PnnkYc5SR`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.kbeASc2PnnkYc5SR` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
