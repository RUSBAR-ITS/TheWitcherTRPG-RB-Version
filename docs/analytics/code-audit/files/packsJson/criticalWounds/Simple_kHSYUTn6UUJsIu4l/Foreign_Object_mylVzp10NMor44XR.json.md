...
| Изменения относительно коммита | Нет; 37 строк; SHA-256 de387cd750bc119b447d714802cce14089fd758777c8312cd504f22e103ade79 |
...
| --- | --- | --- | --- | --- |
| Foreign Object | Корневой Item, name: 2, _id: 34 | Шаблон травмы | `mylVzp10NMor44XR`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.mylVzp10NMor44XR` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.fnYssldrMLVqbF22"` | DocumentUUIDField типа Item; treat загружает адресата и инициирует замену. |
