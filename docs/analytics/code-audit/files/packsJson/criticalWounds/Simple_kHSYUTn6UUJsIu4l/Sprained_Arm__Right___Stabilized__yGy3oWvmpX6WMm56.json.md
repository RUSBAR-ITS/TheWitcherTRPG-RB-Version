...
| `treatedWound` | `"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.YiusbDXfFDhqwtQT"` |
| `daysHealed` | `0` |
| `sterilized` | `false` |
...
| --- | --- | --- | --- | --- |
| Sprained Arm (Right - Stabilized) | Корневой Item, name: 3, _id: 34 | Шаблон травмы | `yGy3oWvmpX6WMm56`; UUID `Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.yGy3oWvmpX6WMm56` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
...
| followUp | `"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.YiusbDXfFDhqwtQT"` | DocumentUUIDField типа Item; treat загружает адресата и инициирует замену. |
