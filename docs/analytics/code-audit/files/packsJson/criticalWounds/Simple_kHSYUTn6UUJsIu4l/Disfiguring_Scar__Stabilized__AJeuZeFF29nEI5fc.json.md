...
| Изменения относительно коммита | Нет; 122 строк; SHA-256 d56c29f29aea80681ff44946e12a98892160c07a2560de472ca9bf7a5e484319 |
...
| --- | --- | --- | --- | --- |
| Disfiguring Scar (Stabilized) | Корневой Item, name: 3, _id: 115 | Шаблон травмы | `AJeuZeFF29nEI5fc`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.AJeuZeFF29nEI5fc` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.kbeASc2PnnkYc5SR"` | DocumentUUIDField типа Item; treat загружает адресата и инициирует замену. |
