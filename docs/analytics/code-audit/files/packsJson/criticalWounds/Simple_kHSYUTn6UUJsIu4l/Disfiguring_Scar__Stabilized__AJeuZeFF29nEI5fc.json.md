...
| --- | --- | --- | --- | --- |
| Disfiguring Scar (Stabilized) | Корневой Item, name: 3, _id: 36 | Шаблон травмы | `AJeuZeFF29nEI5fc`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.AJeuZeFF29nEI5fc` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
