...
| --- | --- | --- | --- | --- |
| Sprained Arm (Left - Treated) | Корневой Item, name: 3, _id: 36 | Шаблон травмы | `q5vr9VLD2tEkL1ux`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.q5vr9VLD2tEkL1ux` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
