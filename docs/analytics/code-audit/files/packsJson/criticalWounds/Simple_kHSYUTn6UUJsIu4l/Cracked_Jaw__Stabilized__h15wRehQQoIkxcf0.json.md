...
| --- | --- | --- | --- | --- |
| Cracked Jaw (Stabilized) | Корневой Item, name: 3, _id: 35 | Шаблон травмы | `h15wRehQQoIkxcf0`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.h15wRehQQoIkxcf0` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
