...
| Изменения относительно коммита | Нет; 92 строк; SHA-256 cfc5e26a4978d63063a35b56515b6458cba3bd1652cca1735de11475668c7fd4 |
...
| --- | --- | --- | --- | --- |
| Cracked Ribs (Stabilized) | Корневой Item, name: 3, _id: 89 | Шаблон травмы | `2c4PbGjd0segbvmr`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.2c4PbGjd0segbvmr` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.oe4y6zxH2WUR9gSj"` | DocumentUUIDField типа Item; treat загружает адресата и инициирует замену. |
