...
| --- | --- | --- | --- | --- |
| Cracked Ribs (Stabilized) | Корневой Item, name: 3, _id: 36 | Шаблон травмы | `2c4PbGjd0segbvmr`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.2c4PbGjd0segbvmr` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
