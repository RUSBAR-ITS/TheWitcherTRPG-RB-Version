...
| Изменения относительно коммита | Нет; 145 строк; SHA-256 d051d6c26c7a2f90860f0ad7ed944c55e2b6177733028068e28d05de08145097 |
...
| --- | --- | --- | --- | --- |
| Cracked Jaw | Корневой Item, name: 3, _id: 5 | Шаблон травмы | `UnWBI9Sgu4AJv1z1`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.UnWBI9Sgu4AJv1z1` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.h15wRehQQoIkxcf0"` | DocumentUUIDField типа Item; treat загружает адресата и инициирует замену. |
