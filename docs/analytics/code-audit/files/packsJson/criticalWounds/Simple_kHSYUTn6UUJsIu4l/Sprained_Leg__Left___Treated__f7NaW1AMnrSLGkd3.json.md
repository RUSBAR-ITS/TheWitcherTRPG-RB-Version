...
| Поле | Значение |
| --- | --- |
| Источник | [packsJson/criticalWounds/Simple_kHSYUTn6UUJsIu4l/Sprained_Leg__Left___Treated__f7NaW1AMnrSLGkd3.json](../../../../../../../packsJson/criticalWounds/Simple_kHSYUTn6UUJsIu4l/Sprained_Leg__Left___Treated__f7NaW1AMnrSLGkd3.json) |
...
| Имя / ID | Sprained Leg (Left - Treated) / `f7NaW1AMnrSLGkd3` |
| Строк / SHA-256 | 92 / `ed5b2cbad0c472a1855dd41c62a12ebce0593bfa20b379f0b87cf97304e70cff` |

### Выполненные исправления

B14: анатомическая локация; B16: исправить сторону в имени эффекта. Остальные поля сохранены. Текущие значения и связи перечислены ниже; архив в конце описывает прежние срезы.
...
Несоответствие локации: оба предшественника имеют leftLeg, этот Item — leftArm. Шаблон списка выводит подпись по полю, а не по имени. Штраф SPD остаётся тем же, поскольку путь changes от location не зависит. См. [issue-00325](../../../../../../issues/closed/issue-00325.md).
