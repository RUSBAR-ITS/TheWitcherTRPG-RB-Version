...
| Изменения относительно коммита | Нет; 92 строк; SHA-256 ac2271e82fcb4f8567e2b16d6e4beacdede9c1bbf9c6bd21eaafdf934bbfddec |
...
| --- | --- | --- | --- | --- |
| Cracked Ribs (Treated) | Корневой Item, name: 3, _id: 89 | Шаблон травмы | `oe4y6zxH2WUR9gSj`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.oe4y6zxH2WUR9gSj` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
