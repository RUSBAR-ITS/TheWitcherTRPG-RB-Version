...
| --- | --- | --- | --- | --- |
| Sprained Leg (Right - Stabilized) | Корневой Item, name: 3, _id: 36 | Шаблон травмы | `fNiSVOJzpaxVvZTE`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.fNiSVOJzpaxVvZTE` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
