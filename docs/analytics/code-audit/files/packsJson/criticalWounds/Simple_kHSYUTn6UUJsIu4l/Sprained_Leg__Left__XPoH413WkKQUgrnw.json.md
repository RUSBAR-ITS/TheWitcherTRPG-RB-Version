...
| --- | --- | --- | --- | --- |
| Sprained Leg (Left) | Корневой Item, name: 3, _id: 36 | Шаблон травмы | `XPoH413WkKQUgrnw`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.XPoH413WkKQUgrnw` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
