...
| Изменения относительно коммита | Нет; 104 строк; SHA-256 0d4afea6865d8ad31b5bf7895d8415b3b128d312c2a820e735bdc1a9814e8932 |
...
| --- | --- | --- | --- | --- |
| Sprained Leg (Left) | Корневой Item, name: 3, _id: 101 | Шаблон травмы | `XPoH413WkKQUgrnw`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.XPoH413WkKQUgrnw` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.eblucqnyOS7lb5E5"` | DocumentUUIDField типа Item; treat загружает адресата и инициирует замену. |
