...
| --- | --- | --- | --- | --- |
| Cracked Jaw (Treated) | Корневой Item, name: 3, _id: 35 | Шаблон травмы | `AODuTRNu2RtJJhLD`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.AODuTRNu2RtJJhLD` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
