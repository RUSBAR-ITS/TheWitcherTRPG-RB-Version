...
| --- | --- | --- | --- | --- |
| Sprained Leg (Left - Stabilized) | Корневой Item, name: 3, _id: 36 | Шаблон травмы | `eblucqnyOS7lb5E5`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.eblucqnyOS7lb5E5` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
