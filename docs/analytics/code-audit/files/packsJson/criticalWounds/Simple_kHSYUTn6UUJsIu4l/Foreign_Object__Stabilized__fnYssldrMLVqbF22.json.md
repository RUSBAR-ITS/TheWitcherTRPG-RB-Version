...
| `treatedWound` | `"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.rgRGVfLBlHMwUvGy"` |
| `daysHealed` | `0` |
| `sterilized` | `false` |
...
| --- | --- | --- | --- | --- |
| Foreign Object (Stabilized) | Корневой Item, name: 2, _id: 34 | Шаблон травмы | `fnYssldrMLVqbF22`; UUID `Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.fnYssldrMLVqbF22` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
...
| followUp | `"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.rgRGVfLBlHMwUvGy"` | DocumentUUIDField типа Item; treat загружает адресата и инициирует замену. |
