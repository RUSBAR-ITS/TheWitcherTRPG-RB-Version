# packsJson/criticalWounds/Simple_kHSYUTn6UUJsIu4l/Disfiguring_Scar_8tqapNHVCmSwijJw.json
...
| `canHeal` | `false` |
| `healingDuration` | `""` |
| `stabilizedWound` | `"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.AJeuZeFF29nEI5fc"` |
...
| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/criticalWounds/Simple_kHSYUTn6UUJsIu4l/Disfiguring_Scar_8tqapNHVCmSwijJw.json](../../../../../../../packsJson/criticalWounds/Simple_kHSYUTn6UUJsIu4l/Disfiguring_Scar_8tqapNHVCmSwijJw.json) |
...
Экспорт Disfiguring Scar: документ травмы с состоянием `none` и локацией `head`. Содержит 1 ActiveEffect и 6 изменений. Разбор описывает структуру и работу потребителей; соответствие игровым правилам не проверяется.
...
| --- | --- | --- | --- | --- |
| Disfiguring Scar | Корневой Item, name: 3, _id: 5 | Шаблон травмы | `8tqapNHVCmSwijJw`; UUID `Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.8tqapNHVCmSwijJw` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
| _key / folder / sort | Корневые поля | Идентификация экспортного документа и порядок | `"!items!8tqapNHVCmSwijJw"` / `"kHSYUTn6UUJsIu4l"` / `700000` | Потребление ядром и инструментами экспорта; sort не задаёт приоритет изменений |
...
| followUp | `"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.AJeuZeFF29nEI5fc"` | DocumentUUIDField типа Item; treat загружает адресата и инициирует замену. |
...
| --- | --- | --- | --- | --- |
| 1 / 46 | `system.skills.emp.charisma.activeEffectModifiers` | 2 / `"-3"` / `null` | add; -3; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
| 2 / 52 | `system.skills.emp.persuasion.activeEffectModifiers` | 2 / `"-3"` / `null` | add; -3; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
| 3 / 58 | `system.skills.emp.seduction.activeEffectModifiers` | 2 / `"-3"` / `null` | add; -3; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
| 4 / 64 | `system.skills.emp.leadership.activeEffectModifiers` | 2 / `"-3"` / `null` | add; -3; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
| 5 / 70 | `system.skills.emp.deceit.activeEffectModifiers` | 2 / `"-3"` / `null` | add; -3; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
| 6 / 76 | `system.skills.int.socialetq.activeEffectModifiers` | 2 / `"-3"` / `null` | add; -3; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
...
Item `8tqapNHVCmSwijJw` («Disfiguring Scar»): `simple/none/head`; 1 ActiveEffect, 6 changes. Предшественник: нет; `followUp` ведёт к `AJeuZeFF29nEI5fc` («Disfiguring Scar (Stabilized)», `stabilized/head`).
