...
| Изменения относительно коммита | Нет; 122 строк; SHA-256 69d71779c7ef06f5f0754279adcf64f0b49bdb404024024732bd0bda995b0c1a |
...
| --- | --- | --- | --- | --- |
| Disfiguring Scar | Корневой Item, name: 3, _id: 5 | Шаблон травмы | `8tqapNHVCmSwijJw`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.8tqapNHVCmSwijJw` | Загрузка, копирование к Actor, подготовка, лечение и удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.AJeuZeFF29nEI5fc"` | DocumentUUIDField типа Item; treat загружает адресата и инициирует замену. |
