...
| Изменения относительно коммита | Нет; 94 строк; SHA-256 7b99021ee820b1a4fb2d890fb45080b773200a7705c43a2d5e69a425100ed5d3 |
...
| --- | --- | --- | --- |
| Dismembered Arm (Right) | Корневой Item; name:3, _id:87 | ID `ZxvWPJPDD9fm34Pc`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.ZxvWPJPDD9fm34Pc` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.hKgvgj4lJ74wPt8N"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
