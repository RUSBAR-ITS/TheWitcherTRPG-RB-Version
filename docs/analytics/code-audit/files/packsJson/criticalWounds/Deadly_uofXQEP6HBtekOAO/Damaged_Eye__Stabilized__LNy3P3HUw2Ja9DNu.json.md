...
| Изменения относительно коммита | Нет; 98 строк; SHA-256 d956919a8ee26ebbab8b378f8ab5cd5d1b95ec4d4b01edfc6cf3b82ef96d8982 |
...
| --- | --- | --- | --- |
| Damaged Eye (Stabilized) | Корневой Item; name:3, _id:91 | ID `LNy3P3HUw2Ja9DNu`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.LNy3P3HUw2Ja9DNu` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.XQeXSAhvjrQZNpAE"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
