...
| Изменения относительно коммита | Нет; 104 строк; SHA-256 cdcdf98690353c981c0d04dad488c24c06a085569539379036090a1570ac4815 |
...
| --- | --- | --- | --- |
| Dismembered Leg (Left - Stabilized) | Корневой Item; name:3, _id:97 | ID `lck0EEySmuLZXMrA`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.lck0EEySmuLZXMrA` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.eYEp1CPif98mDm2U"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |

### ActiveEffect 1: Dismembered Leg (Left - Stabilized)

ID `3atgpxSf0fttNYLr`; _key=`"!items.effects!lck0EEySmuLZXMrA.3atgpxSf0fttNYLr"`. Origin=`"Compendium.TheWitcherTRPG.criticalWounds.Item.lck0EEySmuLZXMrA"` — UUID текущего Item в компедиуме, сопоставлен с экспортом. Цель переноса при transfer=true — Actor-владелец текущего Item; origin не выбирает другого владельца.
