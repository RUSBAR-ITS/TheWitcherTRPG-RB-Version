...
| Изменения относительно коммита | Нет; 154 строк; SHA-256 af595eda120ea9dc4ab328aadec7c9f293c21a06747577569bf4e0b6d0a5e0d4 |
...
| --- | --- | --- | --- |
| Damaged Eye | Корневой Item; name:3, _id:5 | ID `zHK1XmZ77V8c26Xv`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.zHK1XmZ77V8c26Xv` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.LNy3P3HUw2Ja9DNu"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
