...
| `canHeal` | `false` |
| `healingDuration` | `""` |
| `stabilizedWound` | `"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.vYza9bpK13G36YRV"` |
...
| Поле | Значение |
| --- | --- |
| Источник | [packsJson/criticalWounds/Deadly_uofXQEP6HBtekOAO/Dismembered_Leg__Right__Ssi9d4GQsAyYnt86.json](../../../../../../../packsJson/criticalWounds/Deadly_uofXQEP6HBtekOAO/Dismembered_Leg__Right__Ssi9d4GQsAyYnt86.json) |
...
| Имя / ID | Dismembered Leg (Right) / `Ssi9d4GQsAyYnt86` |
| Строк / SHA-256 | 160 / `0df7bc79926b25afb160b1ab54d9f36cd18d7eff19b22ade6ca6c5107f037fbb` |

### Выполненные исправления

B15: включить существующий эффект множителей; B16: исправить сторону в имени эффекта. Остальные поля сохранены. Текущие значения и связи перечислены ниже; архив в конце описывает прежние срезы.

| Поле system | Текущее значение |
| --- | --- |
| `htmlFields` | ["description"] |
| `description` | "<p>The blow tears your leg from your body or damages it beyond repair. Quarter your SPD, Dodge/Escape, and Athletics.</p>" |
...
| `healingTime` | 0 |
| `sterilized` | false |
| `followUp` | "Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.vYza9bpK13G36YRV" |

2 ActiveEffect; 4 changes. ID и `_key` сохранённых эффектов, origin, transfer, duration и несвязанные значения сохранены.

#### Dismembered Leg (Right) — qbyJKEvoYMrHtiBg
...
#### Dismembered Leg (Right) — teBgn7uGcPnT0CzT

Строка `_id`: 92. `disabled=false`, `transfer=true`; statuses: `[]`.

| key | mode | value | priority |
| --- | --- | --- | --- |
| `system.stats.spd.max` | 1 | "0.25" | null |
| `system.skills.ref.dodge.value` | 1 | "0.25" | null |
| `system.skills.dex.athletics.value` | 1 | "0.25" | null |
...
Следующий этап: [Dismembered Leg (Right - Stabilized)](../../../../../../../packsJson/criticalWounds/Deadly_uofXQEP6HBtekOAO/Dismembered_Leg__Right___Stabilized__vYza9bpK13G36YRV.json) — `Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.vYza9bpK13G36YRV`.
...
| --- | --- | --- | --- |
| Dismembered Leg (Right) | Корневой Item; name:3, _id:153 | ID `Ssi9d4GQsAyYnt86`; UUID `Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.Ssi9d4GQsAyYnt86` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.vYza9bpK13G36YRV"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
...
ID `teBgn7uGcPnT0CzT`; _key=`"!items.effects!Ssi9d4GQsAyYnt86.teBgn7uGcPnT0CzT"`. Origin=`"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.Ssi9d4GQsAyYnt86"` — UUID текущего Item в компедиуме, сопоставлен с экспортом. Цель переноса при transfer=true — Actor-владелец текущего Item; origin не выбирает другого владельца.
