...
| `treatedWound` | `"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.kfyfxEVsMRUDDk1A"` |
| `daysHealed` | `0` |
| `sterilized` | `false` |
...
| --- | --- | --- | --- |
| Compound Leg Fracture (Left - Stabilized) | Корневой Item; name:3, _id:97 | ID `NiGtzaHs4dUj8Pmd`; UUID `Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.NiGtzaHs4dUj8Pmd` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.kfyfxEVsMRUDDk1A"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |

### ActiveEffect 1: Compound Leg Fracture (Left - Stabilized)

ID `SZ1HqkNycACTg82X`; _key=`"!items.effects!NiGtzaHs4dUj8Pmd.SZ1HqkNycACTg82X"`. Origin=`"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.NiGtzaHs4dUj8Pmd"` — UUID текущего Item в компедиуме, сопоставлен с экспортом. Цель переноса при transfer=true — Actor-владелец текущего Item; origin не выбирает другого владельца.
