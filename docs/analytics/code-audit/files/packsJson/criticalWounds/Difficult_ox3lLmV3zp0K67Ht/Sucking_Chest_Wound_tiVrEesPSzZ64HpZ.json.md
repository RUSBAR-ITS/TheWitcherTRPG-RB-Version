...
| Изменения относительно коммита | Нет; 154 строк; SHA-256 644d7612cd328d5082aade354cceb253a4dc0913b554a68b81065e27b6d0a5a8 |
...
| --- | --- | --- | --- |
| Sucking Chest Wound | Корневой Item; name:3, _id:5 | ID `tiVrEesPSzZ64HpZ`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.tiVrEesPSzZ64HpZ` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.cfQ2OHPNVVKMDsDo"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
