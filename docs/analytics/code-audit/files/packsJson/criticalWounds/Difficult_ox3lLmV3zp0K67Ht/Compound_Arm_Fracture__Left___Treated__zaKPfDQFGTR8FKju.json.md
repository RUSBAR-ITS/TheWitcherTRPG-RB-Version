# packsJson/criticalWounds/Difficult_ox3lLmV3zp0K67Ht/Compound_Arm_Fracture__Left___Treated__zaKPfDQFGTR8FKju.json
...
| Поле | Значение |
| --- | --- |
| Источник | [packsJson/criticalWounds/Difficult_ox3lLmV3zp0K67Ht/Compound_Arm_Fracture__Left___Treated__zaKPfDQFGTR8FKju.json](../../../../../../../packsJson/criticalWounds/Difficult_ox3lLmV3zp0K67Ht/Compound_Arm_Fracture__Left___Treated__zaKPfDQFGTR8FKju.json) |
...
| Имя / ID | Compound Arm Fracture (Left - Treated) / `zaKPfDQFGTR8FKju` |
| Строк / SHA-256 | 37 / `5688db5e14b878d2e34e91b402f1a255b8e342df1ffb323ee3619023513057b4` |
...
| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/criticalWounds/Difficult_ox3lLmV3zp0K67Ht/Compound_Arm_Fracture__Left___Treated__zaKPfDQFGTR8FKju.json](../../../../../../../packsJson/criticalWounds/Difficult_ox3lLmV3zp0K67Ht/Compound_Arm_Fracture__Left___Treated__zaKPfDQFGTR8FKju.json) |
...
| Изменения относительно коммита | Нет; 94 строк; SHA-256 3ce4993befdce1716ff2917b8463937b1d5fef1cf8fef9d980f6eb8844d05ad8 |
| Задача и порция | [TASK-0003.060](../../../../../../tasks/task-0003.060.md) |
| Запись перекрёстной сверки | [Протокол .060](../../../../review-log.md#task-0003060) |

## Назначение файла

Экспорт Compound Arm Fracture (Left - Treated): состояние treated, локация leftArm. Вложенных ActiveEffect: 1; изменений: 1. Данные задают шаблон травмы и её переход; действия выполняют потребители системы и Foundry.
...
| --- | --- | --- | --- |
| Compound Arm Fracture (Left - Treated) | Корневой Item; name:3, _id:87 | ID `zaKPfDQFGTR8FKju`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.zaKPfDQFGTR8FKju` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
| _key / folder / sort | Корневые поля | `"!items!zaKPfDQFGTR8FKju"` / `"ox3lLmV3zp0K67Ht"` / `0` | Ключ экспорта, родительская папка и сортировка; sort не приоритет эффекта |
...
ID `32L2d5MfPiaENuqI`; _key=`"!items.effects!zaKPfDQFGTR8FKju.32L2d5MfPiaENuqI"`. Origin=`"Item.saPd4IMUCv5qZE60"` — ссылка на мировой Item; существование адресата не проверялось. Цель переноса при transfer=true — Actor-владелец текущего Item; origin не выбирает другого владельца.
...
Item `zaKPfDQFGTR8FKju` («Compound Arm Fracture (Left - Treated)»): `difficult/treated/leftArm`; 1 ActiveEffect, 1 changes. Предшественник: `tdcGSOZGCUhNArDc`; `followUp=null`: ручной `treat()` запрашивает удаление этого Item.
