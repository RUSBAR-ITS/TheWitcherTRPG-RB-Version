...
| Изменения относительно коммита | Нет; 94 строк; SHA-256 e05966e0b74f6af7c1e52a5764062f3c3c2c4f8dd28486d31c4b8912857ead46 |
...
| --- | --- | --- | --- |
| Compound Arm Fracture (Left) | Корневой Item; name:3, _id:5 | ID `saPd4IMUCv5qZE60`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.saPd4IMUCv5qZE60` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.tdcGSOZGCUhNArDc"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
