...
| Изменения относительно коммита | Нет; 37 строк; SHA-256 ef226ed21cfd16718913bbd5d3e5a19bd883e32aef3db22848ff03f88aa306ea |
...
| --- | --- | --- | --- |
| Compound Arm Fracture (Left - Stabilized) | Корневой Item; name:3, _id:30 | ID `tdcGSOZGCUhNArDc`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.tdcGSOZGCUhNArDc` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.zaKPfDQFGTR8FKju"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
