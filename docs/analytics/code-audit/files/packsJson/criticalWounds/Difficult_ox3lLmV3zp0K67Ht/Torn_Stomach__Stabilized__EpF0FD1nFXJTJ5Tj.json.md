# packsJson/criticalWounds/Difficult_ox3lLmV3zp0K67Ht/Torn_Stomach__Stabilized__EpF0FD1nFXJTJ5Tj.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/criticalWounds/Difficult_ox3lLmV3zp0K67Ht/Torn_Stomach__Stabilized__EpF0FD1nFXJTJ5Tj.json](../../../../../../../packsJson/criticalWounds/Difficult_ox3lLmV3zp0K67Ht/Torn_Stomach__Stabilized__EpF0FD1nFXJTJ5Tj.json) |
...
| Изменения относительно коммита | Нет; 398 строк; SHA-256 7f5116185f09c495274ce84f3be14bb3a79d8a9dddac080714c810a250791280 |
| Задача и порция | [TASK-0003.060](../../../../../../tasks/task-0003.060.md) |
| Запись перекрёстной сверки | [Протокол .060](../../../../review-log.md#task-0003060) |

## Назначение файла

Экспорт Torn Stomach (Stabilized): состояние stabilized, локация torso. Вложенных ActiveEffect: 1; изменений: 52. Данные задают шаблон травмы и её переход; действия выполняют потребители системы и Foundry.
...
| --- | --- | --- | --- |
| Torn Stomach (Stabilized) | Корневой Item; name:3, _id:391 | ID `EpF0FD1nFXJTJ5Tj`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.EpF0FD1nFXJTJ5Tj` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
| _key / folder / sort | Корневые поля | `"!items!EpF0FD1nFXJTJ5Tj"` / `"ox3lLmV3zp0K67Ht"` / `0` | Ключ экспорта, родительская папка и сортировка; sort не приоритет эффекта |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.Mg1jn99OitVPdvje"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |

### ActiveEffect 1: Torn Stomach

ID `uxvX0GUDLr0DqbQV`; _key=`"!items.effects!EpF0FD1nFXJTJ5Tj.uxvX0GUDLr0DqbQV"`. Origin=`"Item.5gnx9xNF52ap9PYi"` — ссылка на мировой Item; существование адресата не проверялось. Цель переноса при transfer=true — Actor-владелец текущего Item; origin не выбирает другого владельца.
...
| --- | --- | --- | --- | --- |
| 1 / 45 | `system.skills.int.awareness.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 2 / 51 | `system.skills.int.business.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 3 / 57 | `system.skills.int.deduction.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 4 / 63 | `system.skills.int.education.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 5 / 69 | `system.skills.int.commonspeech.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | commonspeech отсутствует в схеме; [intData.js](../../../../../../../module/data/actor/templates/common/skills/intData.js) объявляет commonsp; динамический путь=-2 |
| 6 / 75 | `system.skills.int.eldersp.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 7 / 81 | `system.skills.int.dwarven.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 8 / 87 | `system.skills.int.monster.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 9 / 93 | `system.skills.int.socialetq.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 10 / 99 | `system.skills.int.streetwise.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 11 / 105 | `system.skills.int.tactics.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 12 / 111 | `system.skills.int.teaching.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 13 / 117 | `system.skills.int.wilderness.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 14 / 123 | `system.skills.ref.brawling.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 15 / 129 | `system.skills.ref.dodge.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 16 / 135 | `system.skills.ref.melee.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 17 / 141 | `system.skills.ref.riding.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 18 / 147 | `system.skills.ref.sailing.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 19 / 153 | `system.skills.ref.smallblades.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 20 / 159 | `system.skills.ref.staffspear.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 21 / 165 | `system.skills.ref.swordsmanship.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 22 / 171 | `system.skills.will.courage.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 23 / 177 | `system.skills.will.hexweave.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 24 / 183 | `system.skills.will.intimidation.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 25 / 189 | `system.skills.will.spellcast.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 26 / 195 | `system.skills.will.resistmagic.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 27 / 201 | `system.skills.will.resistcoerc.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 28 / 207 | `system.skills.will.ritcraft.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 29 / 213 | `system.skills.dex.archery.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 30 / 219 | `system.skills.dex.athletics.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 31 / 225 | `system.skills.dex.crossbow.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 32 / 231 | `system.skills.dex.sleight.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 33 / 237 | `system.skills.dex.stealth.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 34 / 243 | `system.skills.cra.alchemy.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 35 / 249 | `system.skills.cra.crafting.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 36 / 255 | `system.skills.cra.disguise.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 37 / 261 | `system.skills.cra.firstaid.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 38 / 267 | `system.skills.cra.forgery.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 39 / 273 | `system.skills.cra.picklock.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 40 / 279 | `system.skills.cra.trapcraft.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 41 / 285 | `system.skills.body.physique.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 42 / 291 | `system.skills.body.endurance.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 43 / 297 | `system.skills.emp.charisma.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 44 / 303 | `system.skills.emp.deceit.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 45 / 309 | `system.skills.emp.finearts.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 46 / 315 | `system.skills.emp.gambling.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 47 / 321 | `system.skills.emp.grooming.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 48 / 327 | `system.skills.emp.perception.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 49 / 333 | `system.skills.emp.leadership.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 50 / 339 | `system.skills.emp.persuasion.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 51 / 345 | `system.skills.emp.performance.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
| 52 / 351 | `system.skills.emp.seduction.activeEffectModifiers` | 2 / `"-2"` / `null` | add; `-2`; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js); -2 |
...
[issue-00121](../../../../../../issues/potential/issue-00121.md) — ожидание замены, [issue-00127](../../../../../../issues/potential/issue-00127.md) — граница завершения лечения, [issue-00288](../../../../../../issues/potential/issue-00288.md) — повтор name/type. [issue-00004](../../../../../../issues/potential/issue-00004.md) — commonspeech/commonsp. Статусы potential сохранены, подтверждения/исправления не выполнялись. Наличие этих общих проблем не объявляет дефектом каждое поле или папку.
...
Item `EpF0FD1nFXJTJ5Tj` («Torn Stomach (Stabilized)»): `difficult/stabilized/torso`; 1 ActiveEffect, 52 changes. Предшественник: `5gnx9xNF52ap9PYi`; `followUp` ведёт к `Mg1jn99OitVPdvje` («Torn Stomach (Treated)», `treated/torso`).
