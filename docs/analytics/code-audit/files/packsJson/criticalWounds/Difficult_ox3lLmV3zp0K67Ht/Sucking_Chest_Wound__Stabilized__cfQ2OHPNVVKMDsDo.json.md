...
| --- | --- | --- | --- |
| Sucking Chest Wound (Stabilized) | Корневой Item; name:3, _id:91 | ID `cfQ2OHPNVVKMDsDo`; UUID `Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.cfQ2OHPNVVKMDsDo` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.wFul3Zr7mMaKjA5I"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
