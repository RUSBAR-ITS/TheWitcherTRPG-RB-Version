...
| Изменения относительно коммита | Нет; 404 строк; SHA-256 48e59a7388b103cf9cc933843df113ff5d89582a79daecafa53340055fa831bf |
...
| --- | --- | --- | --- |
| Torn Stomach | Корневой Item; name:3, _id:5 | ID `5gnx9xNF52ap9PYi`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.5gnx9xNF52ap9PYi` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.EpF0FD1nFXJTJ5Tj"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
