# packsJson/criticalWounds/Difficult_ox3lLmV3zp0K67Ht/Skull_Fracture__Treated__v4RVIshohh1PPuAu.json
...
| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/criticalWounds/Difficult_ox3lLmV3zp0K67Ht/Skull_Fracture__Treated__v4RVIshohh1PPuAu.json](../../../../../../../packsJson/criticalWounds/Difficult_ox3lLmV3zp0K67Ht/Skull_Fracture__Treated__v4RVIshohh1PPuAu.json) |
...
| Изменения относительно коммита | Нет; 37 строк; SHA-256 2ad31ac3963ca2e2919d505199842fa8d0c915a0bc446262054d4c9a3f2ef79e |
| Задача и порция | [TASK-0003.060](../../../../../../tasks/task-0003.060.md) |
| Запись перекрёстной сверки | [Протокол .060](../../../../review-log.md#task-0003060) |

## Назначение файла

Экспорт Skull Fracture (Treated): состояние treated, локация head. Вложенных ActiveEffect: 0; изменений: 0. Данные задают шаблон травмы и её переход; действия выполняют потребители системы и Foundry.
...
| --- | --- | --- | --- |
| Skull Fracture (Treated) | Корневой Item; name:3, _id:30 | ID `v4RVIshohh1PPuAu`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.v4RVIshohh1PPuAu` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
| _key / folder / sort | Корневые поля | `"!items!v4RVIshohh1PPuAu"` / `"ox3lLmV3zp0K67Ht"` / `0` | Ключ экспорта, родительская папка и сортировка; sort не приоритет эффекта |
...
Item `v4RVIshohh1PPuAu` («Skull Fracture (Treated)»): `difficult/treated/head`; 0 ActiveEffect, 0 changes. Предшественник: `ikv3qioEgGJG6Olw`; `followUp=null`: ручной `treat()` запрашивает удаление этого Item.
