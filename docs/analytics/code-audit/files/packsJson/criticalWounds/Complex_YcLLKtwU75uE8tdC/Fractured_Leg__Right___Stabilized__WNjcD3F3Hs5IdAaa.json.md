...
| Поле | Значение |
| --- | --- |
| Источник | [packsJson/criticalWounds/Complex_YcLLKtwU75uE8tdC/Fractured_Leg__Right___Stabilized__WNjcD3F3Hs5IdAaa.json](../../../../../../../packsJson/criticalWounds/Complex_YcLLKtwU75uE8tdC/Fractured_Leg__Right___Stabilized__WNjcD3F3Hs5IdAaa.json) |
...
| Имя / ID | Fractured Leg (Right - Stabilized) / `WNjcD3F3Hs5IdAaa` |
| Строк / SHA-256 | 104 / `8b123a63887620e524b6fb85d7710185d90b6e90c337dc5cb352b038c859665c` |
...
| `healingTime` | 0 |
| `sterilized` | false |
| `followUp` | "Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.Aa8wCz1OGM4gflmc" |
...
Следующий этап: [Fractured Leg (Right - Treated)](../../../../../../../packsJson/criticalWounds/Complex_YcLLKtwU75uE8tdC/Fractured_Leg__Right___Treated__Aa8wCz1OGM4gflmc.json) — `Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.Aa8wCz1OGM4gflmc`.
...
| --- | --- | --- | --- |
| Fractured Leg (Right - Stabilized) | Корневой Item; name:3, _id:97 | ID `WNjcD3F3Hs5IdAaa`; UUID `Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.WNjcD3F3Hs5IdAaa` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.Aa8wCz1OGM4gflmc"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
...
Отображаемое имя эффекта — Fractured Leg (Left), хотя Item имеет location=rightLeg. Реальный addActiveEffects('dodge') при displayRollsDetails=true вернул `" +-2[Fractured Leg (Left)]"`. Это неверная подпись источника штрафа, [issue-00326](../../../../../../issues/closed/issue-00326.md).
...
Item `WNjcD3F3Hs5IdAaa` («Fractured Leg (Right - Stabilized)»): `complex/stabilized/rightLeg`; 1 ActiveEffect, 3 changes. Предшественник: `yI6kHQM8voHrBF2h`; `followUp` ведёт к `Aa8wCz1OGM4gflmc` («Fractured Leg (Right - Treated)», `treated/rightLeg`).
