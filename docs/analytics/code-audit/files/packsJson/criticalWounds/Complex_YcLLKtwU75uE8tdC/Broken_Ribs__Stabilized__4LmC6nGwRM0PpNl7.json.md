...
| Изменения относительно коммита | Нет; 98 строк; SHA-256 ab0ada94b4ebbc63609e205be5d32e25191d165e4f4200853139c252701873a1 |
...
| --- | --- | --- | --- |
| Broken Ribs (Stabilized) | Корневой Item; name:2, _id:91 | ID `4LmC6nGwRM0PpNl7`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.4LmC6nGwRM0PpNl7` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.77evBMjaJOlKTaRv"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
