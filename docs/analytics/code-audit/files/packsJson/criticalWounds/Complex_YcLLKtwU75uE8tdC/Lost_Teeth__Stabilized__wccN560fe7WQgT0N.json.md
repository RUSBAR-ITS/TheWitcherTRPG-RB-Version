...
| Изменения относительно коммита | Нет; 146 строк; SHA-256 c9128b1067a252cde152f0d46ba0e7d4c47e2c6c5b75a55b2820d57ec28472dd |
...
| --- | --- | --- | --- |
| Lost Teeth (Stabilized) | Корневой Item; name:2, _id:139 | ID `wccN560fe7WQgT0N`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.wccN560fe7WQgT0N` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.yHU7iYTocbAok2wH"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
