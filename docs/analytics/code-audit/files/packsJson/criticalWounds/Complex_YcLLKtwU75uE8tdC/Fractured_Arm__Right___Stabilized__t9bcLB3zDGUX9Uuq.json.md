...
| Изменения относительно коммита | Нет; 37 строк; SHA-256 bd8b4a7a4b08bd606663df4ff184e3eb194925c39e99a0c08bf2d728789fc806 |
...
| --- | --- | --- | --- |
| Fractured Arm (Right - Stabilized) | Корневой Item; name:3, _id:30 | ID `t9bcLB3zDGUX9Uuq`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.t9bcLB3zDGUX9Uuq` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.djnBTcYyGVsykdoy"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
