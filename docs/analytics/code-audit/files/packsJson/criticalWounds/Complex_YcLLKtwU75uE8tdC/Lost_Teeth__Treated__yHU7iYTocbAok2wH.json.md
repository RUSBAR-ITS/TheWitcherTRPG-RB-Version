# packsJson/criticalWounds/Complex_YcLLKtwU75uE8tdC/Lost_Teeth__Treated__yHU7iYTocbAok2wH.json
...
| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/criticalWounds/Complex_YcLLKtwU75uE8tdC/Lost_Teeth__Treated__yHU7iYTocbAok2wH.json](../../../../../../../packsJson/criticalWounds/Complex_YcLLKtwU75uE8tdC/Lost_Teeth__Treated__yHU7iYTocbAok2wH.json) |
...
| Изменения относительно коммита | Нет; 146 строк; SHA-256 cbb2c6d866086468e65d9d76e2e6a117c5692cb757e60235e4e33755ee76c207 |
| Задача и порция | [TASK-0003.059](../../../../../../tasks/task-0003.059.md) |
| Запись перекрёстной сверки | [Протокол .059](../../../../review-log.md#task-0003059) |

## Назначение файла

Экспорт Lost Teeth (Treated): состояние treated, локация head. Содержит 1 ActiveEffect и 10 изменений. Данные задают шаблон травмы и её переход; действия выполняют потребители системы и Foundry.
...
| --- | --- | --- | --- |
| Lost Teeth (Treated) | Корневой Item; name:2, _id:139 | ID `yHU7iYTocbAok2wH`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.yHU7iYTocbAok2wH` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
| _key / folder / sort | Корневые поля | `"!items!yHU7iYTocbAok2wH"` / `"YcLLKtwU75uE8tdC"` / `300000` | Ключ экспорта, родительская папка и сортировка; sort не приоритет эффекта |
...
ID `W3nKiUcheFOw6vZv`; экспортный _key=`"!items.effects!yHU7iYTocbAok2wH.W3nKiUcheFOw6vZv"`. Origin=`"Item.IMLpjhiZ0yg6hjKI"` — ссылка на мировой Item; разрешение такого UUID в действующем мире не проверялось. Она не становится ссылкой на компедиум при совпадении последнего ID и не задаёт цель применения. Цель при transfer=true — Actor-владелец этого Item.
...
| --- | --- | --- | --- | --- |
| 1 / 44 | `system.skills.will.spellcast.activeEffectModifiers` | 2 / `"-1"` / `null` | add; -1; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
| 2 / 50 | `system.skills.will.ritcraft.activeEffectModifiers` | 2 / `"-1"` / `null` | add; -1; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
| 3 / 56 | `system.skills.will.hexweave.activeEffectModifiers` | 2 / `"-1"` / `null` | add; -1; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
| 4 / 62 | `system.skills.emp.charisma.activeEffectModifiers` | 2 / `"-1"` / `null` | add; -1; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
| 5 / 68 | `system.skills.emp.persuasion.activeEffectModifiers` | 2 / `"-1"` / `null` | add; -1; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
| 6 / 74 | `system.skills.emp.seduction.activeEffectModifiers` | 2 / `"-1"` / `null` | add; -1; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
| 7 / 80 | `system.skills.emp.leadership.activeEffectModifiers` | 2 / `"-1"` / `null` | add; -1; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
| 8 / 86 | `system.skills.emp.deceit.activeEffectModifiers` | 2 / `"-1"` / `null` | add; -1; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
| 9 / 92 | `system.skills.int.socialetq.activeEffectModifiers` | 2 / `"-1"` / `null` | add; -1; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
| 10 / 98 | `system.skills.will.intimidation.activeEffectModifiers` | 2 / `"-1"` / `null` | add; -1; priority=20; phase=initial | NumberField; [skillData.js](../../../../../../../module/data/actor/templates/common/skills/skillData.js) |
...
Item `yHU7iYTocbAok2wH` («Lost Teeth (Treated)»): `complex/treated/head`; 1 ActiveEffect, 10 changes. Предшественник: `wccN560fe7WQgT0N`; `followUp=null`: ручной `treat()` запрашивает удаление этого Item.
