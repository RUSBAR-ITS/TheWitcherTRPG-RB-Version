...
| Изменения относительно коммита | Нет; 37 строк; SHA-256 6ce5aeb73c896515f5eeb04797e995b5cf6a2693375d2ef2fa4a7f208a08c393 |
...
| --- | --- | --- | --- |
| Fractured Arm (Right) | Корневой Item; name:3, _id:30 | ID `ZOyO6WlnMTDjzBj9`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.ZOyO6WlnMTDjzBj9` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.t9bcLB3zDGUX9Uuq"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
