...
| Изменения относительно коммита | Нет; 37 строк; SHA-256 47e17f8345ec3b06845d8b41a1fb19550589678f164969aef88775cef06c8c08 |
...
| --- | --- | --- | --- |
| Fractured Arm (Left) | Корневой Item; name:3, _id:5 | ID `Z2L7diKDSE9L7E9d`; UUID `Compendium.TheWitcherTRPG.criticalWounds.Item.Z2L7diKDSE9L7E9d` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG.criticalWounds.Item.eCiJjDqfUyaXCW2z"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
