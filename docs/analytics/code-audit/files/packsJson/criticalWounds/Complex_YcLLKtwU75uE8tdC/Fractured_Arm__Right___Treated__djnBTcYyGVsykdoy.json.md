...
Item `djnBTcYyGVsykdoy` («Fractured Arm (Right - Treated)»): `complex/treated/rightArm`; 0 ActiveEffect, 0 changes. Предшественник: `t9bcLB3zDGUX9Uuq`; `followUp=null`: ручной `treat()` запрашивает удаление этого Item.
