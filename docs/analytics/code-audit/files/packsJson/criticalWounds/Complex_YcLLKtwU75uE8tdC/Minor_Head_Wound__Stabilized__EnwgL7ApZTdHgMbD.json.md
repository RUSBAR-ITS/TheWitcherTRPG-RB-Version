...
| --- | --- | --- | --- |
| Minor Head Wound (Stabilized) | Корневой Item; name:2, _id:91 | ID `EnwgL7ApZTdHgMbD`; UUID `Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.EnwgL7ApZTdHgMbD` | Загрузка, копирование к Actor, подготовка, лечение/удаление |
...
| followUp | `"Compendium.TheWitcherTRPG-RB-Version.criticalWounds.Item.KsYEWWO5KlPHSdCy"` | DocumentUUIDField типа Item; treat загружает адресата или удаляет конечный Item. |
