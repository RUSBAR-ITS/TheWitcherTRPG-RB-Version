...
[issue-00319](../../../../../issues/closed/issue-00319.md): исполняемые x2/x3 — explode.
...
Vehicle Control Loss: 1d6, возможные totals 1…6; 3 результатов (3 text / 0 document), replacement=true, displayRoll=true. Листовая выдача текста без documentUuid. По разрешимому графу от этого прямого входа 1–1 конечных текстов, максимальная глубина 0; входящих файлов 0. В description 3 inline: 1d10x2, 1d10x3, 5d6; вычисление относится к getHTML, не к roll.  Inline xN имеет семантику explode, не умножения (00319); границы x2/x3 отличаются от недостижимых x10/x100.
