# packsJson/character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json](../../../../../../packsJson/character-generator/Witcher_Lifepath__Cautious_Decade_09MXduRik0BKuUqa.json) |
...
| SHA-256 файла | 4d69af27e804bb71913026608ad7a745a527653a7e643801be1df6d3b842fddd |
...
Выбирает опасность осторожного десятилетия и всегда добавляет его исход. Имя документа — `Witcher Lifepath: Cautious Decade`. Результат работы — текстовые TableResult и сообщение; создание персонажа как Actor, его вещей или ActiveEffect этим файлом не реализовано.

## Условия использования

[system.json](../../../../../../system.json):32–38,58–63 регистрирует Character-gen как RollTable в Character Generation, путь packs/character-generator.db. UUID данного документа — `Compendium.TheWitcherTRPG-RB-Version.Character-gen.RollTable.09MXduRik0BKuUqa`. JSON является экспортом данных, не браузерным модулем.
...
| --- | --- | --- |
| name / _id / _key | `Witcher Lifepath: Cautious Decade`; `09MXduRik0BKuUqa`; `!tables!09MXduRik0BKuUqa` | Название, ID и ключ хранения RollTable |
...
| img | `icons/environment/settlement/target-dummy.webp` | Корневая иконка; путь найден в public установленного Foundry |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.YdNfOR91KZ5BAWli`; остальные четыре поля null | История происхождения; roll следует documentUuid, не compendiumSource |
...
| Result _id / _key | Перечень ID ниже; `!tables.results!09MXduRik0BKuUqa.<id>` | Ключ экспорта; _key не является полем модели Foundry |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `UdHUplxRtBUmcUsy` | [1,90] | text | `No danger occurred in this decade.` | 10–32 |
| 2 | `5k0jxtIvzmH6UNl5` | [1,90] | document | `Witcher Lifepath: Cautious Outcome` | 33–56 |
| 3 | `gnrDCDMdILjGyQdl` | [91,100] | text | `During this decade, a danger occurred:` | 57–79 |
| 4 | `YVCSNqm0kMcDxKF3` | [91,100] | document | `Witcher Lifepath: Dangers` | 80–103 |
| 5 | `OAW3DJizEEzA919s` | [91,100] | document | `Witcher Lifepath: Cautious Outcome` | 104–127 |

На 1–90 выводится No danger и Cautious Outcome; на 91–100 — During this decade…, Dangers и Cautious Outcome. Вероятность ветви опасности 10%. Outcome запускается в любом случае и после Dangers на опасной ветви. Нижняя/верхняя границы проверены, в том числе 90/91. При выбранных «ничего» и отсутствии опасности два конечных текста; при умершем враге и умершем союзнике — 18. Description требует самостоятельного выбора риска и повторения за десятилетия после 29 лет.
...
| --- | --- | --- |
| 1–90 | 90/100 | `UdHUplxRtBUmcUsy`, `5k0jxtIvzmH6UNl5` |
| 91–100 | 10/100 | `gnrDCDMdILjGyQdl`, `YVCSNqm0kMcDxKF3`, `OAW3DJizEEzA919s` |
...
| --- | --- | --- | --- |
| `5k0jxtIvzmH6UNl5`; [1,90] | `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.jhPNDSApv5lQlUk3` | [packsJson/witcher-lifepath/Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json.md) | documentUuid:53; имя/ID/тип сверены |
| `YVCSNqm0kMcDxKF3`; [91,100] | `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.QDAhRAIL7LNz9gME` | [packsJson/witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json.md) | documentUuid:100; имя/ID/тип сверены |
| `OAW3DJizEEzA919s`; [91,100] | `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.jhPNDSApv5lQlUk3` | [packsJson/witcher-lifepath/Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json.md) | documentUuid:124; имя/ID/тип сверены |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Cautious Decade` | Общий поиск при экспорте добычи ожидает Item; этот граф выдаёт текст |
...
Witcher Lifepath: Cautious Decade: 1d100, возможные totals 1…100; 5 результатов (2 text / 3 document), replacement=true, displayRoll=true. Рекурсивные переходы: Witcher Lifepath: Cautious Outcome; Witcher Lifepath: Dangers. По разрешимому графу от этого прямого входа 2–18 конечных текстов, максимальная глубина 4; входящих файлов 0. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json](../witcher-lifepath/Witcher_Lifepath__Cautious_Outcome_jhPNDSApv5lQlUk3.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json](../witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json.md).
