...
Style and Values: 1d1, возможные totals 1…1; 7 результатов (0 text / 7 document), replacement=true, displayRoll=false. Рекурсивные переходы: Style: Clothing; Style: Personality; Style: Hair Style; Style: Affectations; Values: Valued Person; Values: Ideals; Values: Feelings on People. По разрешимому графу от этого прямого входа 7–7 конечных текстов, максимальная глубина 1; входящих файлов 0. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/style/Style__Clothing_BuyEb4FcAyQL2hov.json](../style/Style__Clothing_BuyEb4FcAyQL2hov.json.md), [packsJson/style/Style__Personality_TOQz3ETDronoeEDt.json](../style/Style__Personality_TOQz3ETDronoeEDt.json.md), [packsJson/style/Style__Hair_Style_Ov9xIpAdWEPZCIoH.json](../style/Style__Hair_Style_Ov9xIpAdWEPZCIoH.json.md), [packsJson/style/Style__Affectations_4RWDMDzNdnz2kgwU.json](../style/Style__Affectations_4RWDMDzNdnz2kgwU.json.md), [packsJson/style/Values__Valued_Person_y1WCi6n2Kpwqb27P.json](../style/Values__Valued_Person_y1WCi6n2Kpwqb27P.json.md), [packsJson/style/Values__Ideals_s5EjP50ddIVoitHT.json](../style/Values__Ideals_s5EjP50ddIVoitHT.json.md), [packsJson/style/Values__Feelings_on_People_4eCXMVEfRx4PivWH.json](../style/Values__Feelings_on_People_4eCXMVEfRx4PivWH.json.md), [module/data/actor/templates/character/general/detailsData.js](../../module/data/actor/templates/character/general/detailsData.js.md), [templates/partials/character/tab-background.hbs](../../templates/partials/character/tab-background.hbs.md).
