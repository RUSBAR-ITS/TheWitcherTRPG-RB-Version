...
| Поле | Значение |
| --- | --- |
| Источник | [packsJson/character-generator/Background_Generator__Elves_L8o8Rz85um05VUW4.json](../../../../../../packsJson/character-generator/Background_Generator__Elves_L8o8Rz85um05VUW4.json) |
...
| Имя / ID | Background Generator: Elves / `L8o8Rz85um05VUW4` |
| Строк / SHA-256 | 195 / `f8cf136a7265feb44bf69eae48f39abc1e22aebf2e3d5a0c254b957f4cd55675` |
...
| --- | --- | --- | --- |
| `igDANbaFG5sSYm1T` / 11 | [1,2] | text | Elderland Origin: Dol Blathanna (+1 Social Etiquette) |
...
| `6stg4kxtfUkySns5` / 81 | [1,2] | document | [Siblings: Elves](../../../../../../packsJson/character-generator-sub-tables/Siblings__Elves_6QuZTatyIKElcCKz.json) — `Compendium.TheWitcherTRPG-RB-Version.Character-gen_Sub-tables.RollTable.6QuZTatyIKElcCKz` |
| `zpupYNP2QGhmUGIU` / 105 | [1,2] | document | [Elf Profession](../../../../../../packsJson/character-generator-sub-tables/Elf_Profession_zEykV0pe3YUlaDTd.json) — `Compendium.TheWitcherTRPG-RB-Version.Character-gen_Sub-tables.RollTable.zEykV0pe3YUlaDTd` |
...
[system.json](../../../../../../system.json):32–38,58–63 регистрирует Character-gen как RollTable в Character Generation, путь packs/character-generator.db. UUID данного документа — `Compendium.TheWitcherTRPG-RB-Version.Character-gen.RollTable.L8o8Rz85um05VUW4`. JSON является экспортом данных, не браузерным модулем.
