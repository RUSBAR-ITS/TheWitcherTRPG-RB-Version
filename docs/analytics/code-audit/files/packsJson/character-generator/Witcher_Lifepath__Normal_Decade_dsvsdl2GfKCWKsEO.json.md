...
Witcher Lifepath: Normal Decade: 1d100, возможные totals 1…100; 5 результатов (2 text / 3 document), replacement=true, displayRoll=true. Рекурсивные переходы: Witcher Lifepath: Normal Outcome; Witcher Lifepath: Dangers. По разрешимому графу от этого прямого входа 2–18 конечных текстов, максимальная глубина 4; входящих файлов 0. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Normal_Outcome_Lu49KrUT3wDY1bJr.json](../witcher-lifepath/Witcher_Lifepath__Normal_Outcome_Lu49KrUT3wDY1bJr.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json](../witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json.md).
