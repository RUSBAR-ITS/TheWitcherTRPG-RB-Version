...
[system.json](../../../../../../system.json):32–38,58–63 регистрирует Character-gen как RollTable в Character Generation, путь packs/character-generator.db. UUID данного документа — `Compendium.TheWitcherTRPG.Character-gen.RollTable.4Y8IpS3ArbbP2gGc`. JSON является экспортом данных, не браузерным модулем.
...
| --- | --- | --- | --- |
| `fEC34SOBkzdDBUtx`; [1,4] | `Compendium.TheWitcherTRPG.Life_Event_Sub-tables.RollTable.Z0eeWQI3R8v4YNLd` | [packsJson/lifepath/Fortune_Z0eeWQI3R8v4YNLd.json](../../../../../../packsJson/lifepath/Fortune_Z0eeWQI3R8v4YNLd.json); [карточка](../lifepath/Fortune_Z0eeWQI3R8v4YNLd.json.md) | documentUuid:30; имя/ID/тип сверены |
| `nzF8eW0BGLhTGpdM`; [5,7] | `Compendium.TheWitcherTRPG.Life_Event_Sub-tables.RollTable.JNbvihde5EGIFPdB` | [packsJson/lifepath/Misfortune_JNbvihde5EGIFPdB.json](../../../../../../packsJson/lifepath/Misfortune_JNbvihde5EGIFPdB.json); [карточка](../lifepath/Misfortune_JNbvihde5EGIFPdB.json.md) | documentUuid:54; имя/ID/тип сверены |
| `fnoSJmCrZPrgneXp`; [8,10] | `Compendium.TheWitcherTRPG.Life_Event_Sub-tables.RollTable.CDgdx129wZvINn16` | [packsJson/lifepath/Romance_CDgdx129wZvINn16.json](../../../../../../packsJson/lifepath/Romance_CDgdx129wZvINn16.json); [карточка](../lifepath/Romance_CDgdx129wZvINn16.json.md) | documentUuid:78; имя/ID/тип сверены |
