# packsJson/character-generator/Background_Generator__Dwarves_PCAssN2Ms7yLzuCv.json

## Текущий срез — 14.3.1.00016

| Поле | Значение |
| --- | --- |
| Источник | [packsJson/character-generator/Background_Generator__Dwarves_PCAssN2Ms7yLzuCv.json](../../../../../../packsJson/character-generator/Background_Generator__Dwarves_PCAssN2Ms7yLzuCv.json) |
...
| Имя / ID | Background Generator: Dwarves / `PCAssN2Ms7yLzuCv` |
| Строк / SHA-256 | 195 / `a0e5073f44db18b320b3a697dd358d3eaa4db19ec42f14edbbe8912e294f3b11` |
...
`formula=1d2`, `replacement=true`, `displayRoll=false`. 7 TableResult: 3 text и 4 document. Совпадающие диапазоны выбираются совместно; дочерняя таблица бросается отдельно.

| ID / строка _id | range | Тип | Текст результата / цель |
| --- | --- | --- | --- |
| `igDANbaFG5sSYm1T` / 11 | [1,2] | text | Elderland Origin: Mahakam (+1 Crafting) |
| `FyjZwFRJUzcqDrwW` / 34 | [1,1] | text | At Least Some of Your Family Is Alive |
| `VySuFOPm5I8jY8r9` / 57 | [1,1] | document | [Parents: Elderland](../../../../../../packsJson/character-generator-sub-tables/Parents__Elderland_zSTMrICDELIRaNyL.json) — `Compendium.TheWitcherTRPG-RB-Version.Character-gen_Sub-tables.RollTable.zSTMrICDELIRaNyL` |
| `lQTRDF2dEv3hPTOh` / 81 | [1,2] | document | [Siblings: Dwarves/Halflings](../../../../../../packsJson/character-generator-sub-tables/Siblings__Dwarves_Halflings_Ty1Hs3G4BXkkTu67.json) — `Compendium.TheWitcherTRPG-RB-Version.Character-gen_Sub-tables.RollTable.Ty1Hs3G4BXkkTu67` |
| `fHqJQkniV2WVHHIf` / 105 | [1,2] | document | [Dwarf / Gnome Profession](../../../../../../packsJson/character-generator-sub-tables/Dwarf___Gnome_Profession_TjKh0NMxyyYxjSDt.json) — `Compendium.TheWitcherTRPG-RB-Version.Character-gen_Sub-tables.RollTable.TjKh0NMxyyYxjSDt` |
| `g4JnOCAOpDRIw8tQ` / 129 | [2,2] | text | Something Happened to Your Family |
| `rx40q7d9iV7PIvy0` / 152 | [2,2] | document | [Family Fate: Elderland](../../../../../../packsJson/character-generator-sub-tables/Family_Fate__Elderland_W6mgmCP3219eYdf0.json) — `Compendium.TheWitcherTRPG-RB-Version.Character-gen_Sub-tables.RollTable.W6mgmCP3219eYdf0` |
...
| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/character-generator/Background_Generator__Dwarves_PCAssN2Ms7yLzuCv.json](../../../../../../packsJson/character-generator/Background_Generator__Dwarves_PCAssN2Ms7yLzuCv.json) |
...
| SHA-256 файла | 4bd1b825952cbf11c12ba233f14c2c301f6a32361156180714a22587101b7eb8 |
...
Собирает предысторию дворфа: фиксированное происхождение, семейную ветвь, число братьев/сестёр и профессию. Имя документа — `Background Generator: Dwarves`. Результат работы — текстовые TableResult и сообщение; создание персонажа как Actor, его вещей или ActiveEffect этим файлом не реализовано.

## Условия использования

[system.json](../../../../../../system.json):32–38,58–63 регистрирует Character-gen как RollTable в Character Generation, путь packs/character-generator.db. UUID данного документа — `Compendium.TheWitcherTRPG-RB-Version.Character-gen.RollTable.PCAssN2Ms7yLzuCv`. JSON является экспортом данных, не браузерным модулем.
...
| --- | --- | --- |
| name / _id / _key | `Background Generator: Dwarves`; `PCAssN2Ms7yLzuCv`; `!tables!PCAssN2Ms7yLzuCv` | Название, ID и ключ хранения RollTable |
...
| img | `icons/svg/castle.svg` | Корневая иконка; путь найден в public установленного Foundry |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.pbCmVenPQATBcoCm`; остальные четыре поля null | История происхождения; roll следует documentUuid, не compendiumSource |
...
| Result _id / _key | Перечень ID ниже; `!tables.results!PCAssN2Ms7yLzuCv.<id>` | Ключ экспорта; _key не является полем модели Foundry |
...
Иконки результатов: `icons/svg/d20-black.svg`, `icons/svg/d20-grey.svg`, `icons/sundries/flags/banner-silver-white.webp`. Все ресурсы найдены локально; HTTP и видимость для Foundry-службы не установлены. Непустые table-type/loot-amount-key, когда они есть, относятся к пространству better-rolltables и не меняют доказанное стандартное поведение ядра; сам модуль не исполнялся.

| № | ID результата | range | type | Точное description для text / name для document | Строки записи |
| --- | --- | --- | --- | --- | --- |
| 1 | `igDANbaFG5sSYm1T` | [1,2] | text | `Elderland Origin: Mahakam (+1 Crafting)` | 10–32 |
...
| 4 | `lQTRDF2dEv3hPTOh` | [1,2] | document | `Siblings: Dwarves/Halflings` | 80–103 |
| 5 | `fHqJQkniV2WVHHIf` | [1,2] | document | `Dwarf / Gnome Profession` | 104–127 |
...
Обе грани дают фиксированный Mahakam (+1 Crafting), таблицу числа братьев/сестёр Dwarves/Halflings и Dwarf / Gnome Profession. При 1 выбираются сообщение о живой семье и Parents: Elderland; при 2 — сообщение о событии в семье, Family Fate: Elderland и Family Status: Elderland. В порядке JSON при грани 2 число братьев/сестёр и профессия идут раньше сообщения о судьбе семьи. +1 Crafting — текст, не изменение навыка. Штатно 1/2 семейной ветви; полное раскрытие даёт 7–9 текстов, глубина до 4.
...
| --- | --- | --- |
| 1–1 | 1/2 | `igDANbaFG5sSYm1T`, `FyjZwFRJUzcqDrwW`, `VySuFOPm5I8jY8r9`, `lQTRDF2dEv3hPTOh`, `fHqJQkniV2WVHHIf` |
| 2–2 | 1/2 | `igDANbaFG5sSYm1T`, `lQTRDF2dEv3hPTOh`, `fHqJQkniV2WVHHIf`, `g4JnOCAOpDRIw8tQ`, `rx40q7d9iV7PIvy0`, `hNdtp3IHu6NaWkJo` |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Background Generator: Dwarves` | Общий поиск при экспорте добычи ожидает Item; этот граф выдаёт текст |
...
[issue-00039](../../../../../issues/closed/issue-00039.md) относится к отдельному общему потребителю добычи; [issue-00313](../../../../../issues/closed/issue-00313.md), [issue-00314](../../../../../issues/closed/issue-00314.md), [issue-00315](../../../../../issues/closed/issue-00315.md) — к утилитам извлечения. Они не доказывают дефект конкретного JSON. При выполнении TASK-0003.056 новых issues не создано; issue-00320 дополнена, статусы potential и отсутствие исправлений сохранены.
...
Background Generator: Dwarves: 1d2, возможные totals 1…2; 8 результатов (3 text / 5 document), replacement=true, displayRoll=false. Рекурсивные переходы: Parents: Elderland; Siblings: Dwarves/Halflings; Dwarf / Gnome Profession; Family Fate: Elderland; Family Status: Elderland. По разрешимому графу от этого прямого входа 7–9 конечных текстов, максимальная глубина 4; входящих файлов 1. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/character-generator/Background_Generator__RandomCharacter_CIpykDUYYuJB0zLv.json](Background_Generator__RandomCharacter_CIpykDUYYuJB0zLv.json.md), [packsJson/character-generator-sub-tables/Parents__Elderland_zSTMrICDELIRaNyL.json](../character-generator-sub-tables/Parents__Elderland_zSTMrICDELIRaNyL.json.md), [packsJson/character-generator-sub-tables/Siblings__Dwarves_Halflings_Ty1Hs3G4BXkkTu67.json](../character-generator-sub-tables/Siblings__Dwarves_Halflings_Ty1Hs3G4BXkkTu67.json.md), [packsJson/character-generator-sub-tables/Dwarf___Gnome_Profession_TjKh0NMxyyYxjSDt.json](../character-generator-sub-tables/Dwarf___Gnome_Profession_TjKh0NMxyyYxjSDt.json.md), [packsJson/character-generator-sub-tables/Family_Fate__Elderland_W6mgmCP3219eYdf0.json](../character-generator-sub-tables/Family_Fate__Elderland_W6mgmCP3219eYdf0.json.md), [packsJson/character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json](../character-generator-sub-tables/Family_Status__Elderland_GOp8mGE4MiGaqjk2.json.md).

[Протокол и границы](../../../review-log.md#task-0004017) — TASK-0004.017; процессы [R017-01](../../../cross-check-0002.md#r017-01), [R017-02](../../../cross-check-0002.md#r017-02), [R017-03](../../../cross-check-0002.md#r017-03), [R017-04](../../../cross-check-0002.md#r017-04), [R017-12](../../../cross-check-0002.md#r017-12). В этой порции выполнена статическая сверка; прежние опыты сохраняют свои даты и фасады. Новых поведенческих запусков нет; браузер, мир, сеть и запись в БД не запускались.
