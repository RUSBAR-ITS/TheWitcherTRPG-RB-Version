# packsJson/character-generator/Witcher_Lifepath__Risky_Decade_6zn78Gj7lZtJfS90.json

| Поле | Значение |
| --- | --- |
| Исходный файл | [packsJson/character-generator/Witcher_Lifepath__Risky_Decade_6zn78Gj7lZtJfS90.json](../../../../../../packsJson/character-generator/Witcher_Lifepath__Risky_Decade_6zn78Gj7lZtJfS90.json) |
...
| SHA-256 файла | d3d8d0ec25b4be8d4005cd27de4a0f5d7d96da98d15d689f193e1e3d78924802 |
...
Выбирает опасность рискованного десятилетия и всегда добавляет его исход. Имя документа — `Witcher Lifepath: Risky Decade`. Результат работы — текстовые TableResult и сообщение; создание персонажа как Actor, его вещей или ActiveEffect этим файлом не реализовано.

## Условия использования

[system.json](../../../../../../system.json):32–38,58–63 регистрирует Character-gen как RollTable в Character Generation, путь packs/character-generator.db. UUID данного документа — `Compendium.TheWitcherTRPG-RB-Version.Character-gen.RollTable.6zn78Gj7lZtJfS90`. JSON является экспортом данных, не браузерным модулем.
...
| --- | --- | --- |
| name / _id / _key | `Witcher Lifepath: Risky Decade`; `6zn78Gj7lZtJfS90`; `!tables!6zn78Gj7lZtJfS90` | Название, ID и ключ хранения RollTable |
...
| img | `icons/environment/settlement/graveyard-tombstone-night.webp` | Корневая иконка; путь найден в public установленного Foundry |
...
| _stats | coreVersion=13.341; compendiumSource=`RollTable.dn1Viin0ml5tQ1Hx`; остальные четыре поля null | История происхождения; roll следует documentUuid, не compendiumSource |
...
| Result _id / _key | Перечень ID ниже; `!tables.results!6zn78Gj7lZtJfS90.<id>` | Ключ экспорта; _key не является полем модели Foundry |
...
| --- | --- | --- | --- | --- | --- |
| 1 | `UdHUplxRtBUmcUsy` | [1,25] | text | `No danger occurred in this decade.` | 10–32 |
| 2 | `5k0jxtIvzmH6UNl5` | [1,25] | document | `Witcher Lifepath: Risky Outcome` | 33–56 |
| 3 | `gnrDCDMdILjGyQdl` | [26,100] | text | `During this decade, a danger occurred:` | 57–79 |
| 4 | `YVCSNqm0kMcDxKF3` | [26,100] | document | `Witcher Lifepath: Dangers` | 80–103 |
| 5 | `OAW3DJizEEzA919s` | [26,100] | document | `Witcher Lifepath: Risky Outcome` | 104–127 |

На 1–25 выводится No danger и Risky Outcome; на 26–100 — вводный текст опасности, Dangers и Risky Outcome. Вероятность опасности 75%; Risky Outcome даёт самостоятельный результат после Dangers. Проверены в том числе 25/26. Тексты ранений, врага, союзника или выгоды не создают игровых документов.
...
| --- | --- | --- |
| 1–25 | 25/100 | `UdHUplxRtBUmcUsy`, `5k0jxtIvzmH6UNl5` |
| 26–100 | 75/100 | `gnrDCDMdILjGyQdl`, `YVCSNqm0kMcDxKF3`, `OAW3DJizEEzA919s` |
...
| --- | --- | --- | --- |
| `5k0jxtIvzmH6UNl5`; [1,25] | `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.R6BzlpXysvPx6O5c` | [packsJson/witcher-lifepath/Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json.md) | documentUuid:53; имя/ID/тип сверены |
| `YVCSNqm0kMcDxKF3`; [26,100] | `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.QDAhRAIL7LNz9gME` | [packsJson/witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json.md) | documentUuid:100; имя/ID/тип сверены |
| `OAW3DJizEEzA919s`; [26,100] | `Compendium.TheWitcherTRPG-RB-Version.Witcher_Lifepath_and_BG_Sub-tables.RollTable.R6BzlpXysvPx6O5c` | [packsJson/witcher-lifepath/Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json](../../../../../../packsJson/witcher-lifepath/Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json); [карточка](../witcher-lifepath/Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json.md) | documentUuid:124; имя/ID/тип сверены |
...
| [module/item/witcherItem.js](../../../../../../module/item/witcherItem.js):257–315 | Возможное совпадение Item.name с `Witcher Lifepath: Risky Decade` | Общий поиск при экспорте добычи ожидает Item; этот граф выдаёт текст |
...
Witcher Lifepath: Risky Decade: 1d100, возможные totals 1…100; 5 результатов (2 text / 3 document), replacement=true, displayRoll=true. Рекурсивные переходы: Witcher Lifepath: Risky Outcome; Witcher Lifepath: Dangers. По разрешимому графу от этого прямого входа 2–18 конечных текстов, максимальная глубина 4; входящих файлов 0. Inline-выражений в результатах нет.

Сопоставленные определения и потребители: [system.json](../../system.json.md), [utils/packs.mjs](../../utils/packs.mjs.md), [utils/extract.mjs](../../utils/extract.mjs.md), [module/item/witcherItem.js](../../module/item/witcherItem.js.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json](../witcher-lifepath/Witcher_Lifepath__Risky_Outcome_R6BzlpXysvPx6O5c.json.md), [packsJson/witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json](../witcher-lifepath/Witcher_Lifepath__Dangers_QDAhRAIL7LNz9gME.json.md).
