...
Собственная новая проблема не зарегистрирована. [docs/issues/closed/issue-00033.md](../../../../../../../issues/closed/issue-00033.md) относится к числовой формуле производителя, которую этот фрагмент не вычисляет.
