...
Исходник и связи сопоставлены в TASK-0004.010. Реальный DOM/выбор Actor, запись статуса и правило оглушения после успешной защиты не подтверждены. Остаток: [U010-03](../../../../../cross-check-0002.md#u010-03), [U010-06](../../../../../cross-check-0002.md#u010-06), [U010-07](../../../../../cross-check-0002.md#u010-07). Прежние опыты сохраняют свои даты и фасады; нового исполнения нет.
...
Кнопка появляется при переданном stun для torso/head, независимо от исхода защиты. Modifier выводится текстом, но consumer читает message.system.attackWeaponProperties.stun, не текст и не system.stun.modifier. После клика выбирается Actor и запускается отдельный stunSave; появление кнопки не является наложением статуса.

Сопоставленные определения и потребители: [module/actor/mixins/defenseMixin.js](../../../../module/actor/mixins/defenseMixin.js.md), [module/data/item/templates/combat/damagePropertiesData.js](../../../../module/data/item/templates/combat/damagePropertiesData.js.md), [lang/en.json](../../../../lang/en.json.md), [lang/ru.json](../../../../lang/ru.json.md), [module/scripts/combat/combat.js](../../../../module/scripts/combat/combat.js.md), [module/data/chatMessage/defenseMessageData.js](../../../../module/data/chatMessage/defenseMessageData.js.md), [styles/chat.css](../../../../styles/chat.css.md).

[Протокол и границы](../../../../../review-log.md#task-0004010) — TASK-0004.010; процессы [R010-11](../../../../../cross-check-0002.md#r010-11), [R010-12](../../../../../cross-check-0002.md#r010-12). В этой порции выполнена статическая сверка; прежние опыты сохраняют свои даты и фасады. Новых поведенческих запусков нет; браузер, мир, сеть и запись в БД не запускались.
