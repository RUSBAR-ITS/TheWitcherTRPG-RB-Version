...
Исходник и связи сопоставлены в TASK-0004.010. Menu anchoring/DOM, права, живые клики и создание травмы не проверены; поздние .045/.057 дополняют процесс, а не снимают внешние границы. Остаток: [U010-03](../../../../../cross-check-0002.md#u010-03), [U010-05](../../../../../cross-check-0002.md#u010-05), [U010-06](../../../../../cross-check-0002.md#u010-06). Прежние опыты сохраняют свои даты и фасады; нового исполнения нет.

## Связанные проблемы

[docs/issues/closed/issue-00258.md](../../../../../../../issues/closed/issue-00258.md) — потеря critEffectModifier в модели сообщения; проблема не в отображении h3. [docs/issues/closed/issue-00185.md](../../../../../../../issues/closed/issue-00185.md) — отсутствующий получатель query может остановить производителя до рендера.
...
HBS получает локализуемую тяжесть crit, а полный raw crit идёт в system отдельно. .crit-taken служит маркером меню; меню читает очищенный DefenseMessageData без critEffectModifier. .crit-stun вызывает stunSave без аргумента у заново выбранного Actor. Это отделено от RNG критической локации и записи Item-травмы.

Сопоставленные определения и потребители: [module/actor/mixins/defenseMixin.js](../../../../module/actor/mixins/defenseMixin.js.md), [module/setup/config.js](../../../../module/setup/config.js.md), [lang/en.json](../../../../lang/en.json.md), [lang/ru.json](../../../../lang/ru.json.md), [styles/chat.css](../../../../styles/chat.css.md), [module/scripts/combat/combat.js](../../../../module/scripts/combat/combat.js.md), [module/data/chatMessage/defenseMessageData.js](../../../../module/data/chatMessage/defenseMessageData.js.md), [module/actor/mixins/damageMixin.js](../../../../module/actor/mixins/damageMixin.js.md).

[Протокол и границы](../../../../../review-log.md#task-0004010) — TASK-0004.010; процессы [R010-10](../../../../../cross-check-0002.md#r010-10), [R010-12](../../../../../cross-check-0002.md#r010-12). В этой порции выполнена статическая сверка; прежние опыты сохраняют свои даты и фасады. Новых поведенческих запусков нет; браузер, мир, сеть и запись в БД не запускались.
