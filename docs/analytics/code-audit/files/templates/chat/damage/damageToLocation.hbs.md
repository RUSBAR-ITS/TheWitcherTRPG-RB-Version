...
Контракты обоих callers и issue287 установлены. .016/.018 — настоящий HBS/HTML/CSS/санитизация ([U011-03](../../../../cross-check-0002.md#u011-03)), .018 — порядок сообщения и HP ([U011-02](../../../../cross-check-0002.md#u011-02)). Локальные строки .044 не доказывают видимое сообщение в мире.
...
Одиночный producer подготавливает строки стадий через DamageInstance; allLocations передаёт raw result без этих строк. Флаги properties теряются ещё в одиночном producer из-за обращения к damageResult.damageProperties. Triple braces предназначены для готовых деталей, обычные поля экранируются. displaySP не является числом во всех ветвях.

Сопоставленные определения и потребители: [module/actor/mixins/damageMixin.js](../../../module/actor/mixins/damageMixin.js.md), [module/scripts/damageInstance.js](../../../module/scripts/damageInstance.js.md), [templates/chat/damage/damageToAllLocations.hbs](damageToAllLocations.hbs.md).
