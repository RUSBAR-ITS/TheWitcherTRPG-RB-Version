...
Оба уровня HBS и producer сверены; локальная компиляция .044 сохраняет дату. .016/.018 — реальный partial/HTTP/стили/санитизация ([U011-03](../../../../cross-check-0002.md#u011-03)); .018 — готовое сообщение и сохранение HP ([U011-02](../../../../cross-check-0002.md#u011-02)).
...
allLocations producer передаёт totalAppliedDamage и raw results; partial damageToLocation ожидает строки, которые собираются только одиночным message producer. Это причина пропусков отчёта287. Shared DamageInstance во всех results — отдельная причина численного итога285. Await сообщения до HP в этой ветви не изолирует общие порции.

Сопоставленные определения и потребители: [module/actor/mixins/damageMixin.js](../../../module/actor/mixins/damageMixin.js.md), [module/scripts/damageInstance.js](../../../module/scripts/damageInstance.js.md), [templates/chat/damage/damageToLocation.hbs](damageToLocation.hbs.md).

[Протокол и границы](../../../../review-log.md#task-0004011) — TASK-0004.011; процессы [R011-15](../../../../cross-check-0002.md#r011-15), [R011-19](../../../../cross-check-0002.md#r011-19). В этой порции выполнена статическая сверка; прежние опыты сохраняют свои даты и фасады. Новых поведенческих запусков нет; браузер, мир, сеть и запись в БД не запускались.
