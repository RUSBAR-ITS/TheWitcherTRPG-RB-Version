...
В TASK-0004.007 текущие определения и потребители сопоставлены; прежние опыты TASK-0003.015/.016/.017 (2026-09-10) и .034 (2026-09-11) сохраняют собственные входы и фасады. Браузер, мир, сеть и запись в БД не запускались. Точные оставшиеся вопросы и ответственные блоки: [U007-02](../../../../cross-check-0002.md#u007-02), [U007-05](../../../../cross-check-0002.md#u007-05), [U007-07](../../../../cross-check-0002.md#u007-07). Для этого файла установлены процессы R007-20, R007-19, а не полный клиентский lifecycle.
...
2026-09-11, `rusbar-main`, `74322e91edac106c82668f4a47eef53ce1889dc1`; исходники прежние. request-repair содержит data-owner=data.actor.id и data-item=data.item.id. onRepairRequest сначала выбирает artisan, потом ищет world-owner в game.actors и embedded Item. Текущая кнопка текстовая, без вложенной иконки. Вложенный target проверен как граничный сценарий адаптера DOM: атрибуты с кнопки не читаются, owner отсутствует. Реальный render HBS и передача существующих ID сверены; полный repair/запись не выполнялись.

Сопоставленные исходники: [module/scripts/chat.js](../../../../../../../module/scripts/chat.js). Полные новые описания: [chat.js](../../../module/scripts/chat.js.md).
...
Repair HBS получает контекст обычного сообщения/запроса; owner/item id используются chat-handler. ShowComponents игнорирует unknown-only и скрывает их вместе с ценой заказа. Missing damagedLocations здесь даёт пустой список; JS guard отдельно падает. Missing owner в обработчике — issue108, synthetic владельцы не проверены.

Сопоставленные определения и потребители: [module/item/systems/repair.js](../../../module/item/systems/repair.js.md), [module/scripts/chat.js](../../../module/scripts/chat.js.md), [module/scripts/helper.js](../../../module/scripts/helper.js.md), [module/TheWitcherTRPG.js](../../../module/TheWitcherTRPG.js.md), [module/setup/handlebars.js](../../../module/setup/handlebars.js.md), [lang/en.json](../../../lang/en.json.md), [lang/ru.json](../../../lang/ru.json.md), [styles/chat.css](../../../styles/chat.css.md).

[Протокол и границы](../../../../review-log.md#task-0004007) — TASK-0004.007; процессы [R007-20](../../../../cross-check-0002.md#r007-20), [R007-19](../../../../cross-check-0002.md#r007-19). В этой порции выполнена статическая сверка; прежние опыты сохраняют свои даты и фасады. Единственный новый запуск N007-01 проверяет producer/HBS alchemyComponentsList на заданном контексте; его границы не распространяются на остальные процессы.
