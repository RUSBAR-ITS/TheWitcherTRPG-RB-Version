...
Текущая статическая сверка завершена; прежние пофайловые опыты сохраняют свои даты и фасады. Producer даёт prepared item/type/config; корень включает пять partial без смены контекста и оставляет header/пустые wrappers для неизвестного типа. Await renderTemplate отделён от не ожидаемого ChatMessage.create. Непроверенные границы и следующий критерий: [U016-06](../../../../cross-check-0002.md#u016-06). Полный браузерный цикл, мир, HTTP и запись в БД не выполнялись; смысл перевода/игровых правил не оценивался.

## Связанные проблемы

[docs/issues/potential/issue-00175.md](../../../../../../issues/potential/issue-00175.md), [docs/issues/closed/issue-00178.md](../../../../../../issues/closed/issue-00178.md), [docs/issues/potential/issue-00306.md](../../../../../../issues/potential/issue-00306.md), [docs/issues/potential/issue-00307.md](../../../../../../issues/potential/issue-00307.md), [docs/issues/potential/issue-00308.md](../../../../../../issues/potential/issue-00308.md), [docs/issues/potential/issue-00310.md](../../../../../../issues/potential/issue-00310.md). Наблюдения остаются potential; подтверждения и исправления не выполнялись.
...
Producer даёт prepared item/type/config; корень включает пять partial без смены контекста и оставляет header/пустые wrappers для неизвестного типа. Await renderTemplate отделён от не ожидаемого ChatMessage.create.

Сопоставленные определения и потребители: [module/actor/sheets/mixins/itemMixin.js](../../../module/actor/sheets/mixins/itemMixin.js.md), [module/setup/handlebars.js](../../../module/setup/handlebars.js.md).

[Протокол и границы](../../../../review-log.md#task-0004016) — TASK-0004.016; процессы [R016-02](../../../../cross-check-0002.md#r016-02). В этой порции выполнена статическая сверка; прежние опыты сохраняют свои даты и фасады. Новых поведенческих запусков нет; браузер, мир, сеть и запись в БД не запускались.
