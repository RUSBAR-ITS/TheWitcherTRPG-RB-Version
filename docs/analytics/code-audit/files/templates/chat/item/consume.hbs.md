...
В TASK-0004.007 текущие определения и потребители сопоставлены; прежние опыты TASK-0003.015/.016/.017 (2026-09-10) и .034 (2026-09-11) сохраняют собственные входы и фасады. Браузер, мир, сеть и запись в БД не запускались. Точные оставшиеся вопросы и ответственные блоки: [U007-02](../../../../cross-check-0002.md#u007-02), [U007-07](../../../../cross-check-0002.md#u007-07). Для этого файла установлены процессы R007-06, а не полный клиентский lifecycle.
...
Consume HBS показывает лечение и добавляемые statusEffects из producer; снятые статусы не передаются для отображения. Имя/описание иконки требуют успешного lookup CONFIG; неизвестный статус даёт пустой src. Рендер/создание ChatMessage не подтверждают завершение HP, AE или удаления предмета.

Сопоставленные определения и потребители: [module/item/mixins/consumeMixin.js](../../../module/item/mixins/consumeMixin.js.md), [module/setup/config.js](../../../module/setup/config.js.md), [lang/ru.json](../../../lang/ru.json.md).

[Протокол и границы](../../../../review-log.md#task-0004007) — TASK-0004.007; процессы [R007-06](../../../../cross-check-0002.md#r007-06). В этой порции выполнена статическая сверка; прежние опыты сохраняют свои даты и фасады. Единственный новый запуск N007-01 проверяет producer/HBS alchemyComponentsList на заданном контексте; его границы не распространяются на остальные процессы.
