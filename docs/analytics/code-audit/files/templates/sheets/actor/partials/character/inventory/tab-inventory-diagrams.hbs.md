...
Историческое уточнение перед 14.3.1.00010: карта diagramTypeLabels покрывала 10 из 13 типов; отсутствовали potion/decoction/oil. В 14.3.1.00010 все 13 подписей добавлены и проверены в ru/en; шаблон и селекторы сохранены. Шаблон инвентаря обращается к карте и для этих формул. [Issue-00178](../../../../../../../../../issues/closed/issue-00178.md) закрыта после проверки 13 типов; прежняя проверка десяти подписей не покрывала все типы.
...
- `53`: `{{ localize (lookup ../config.diagramTypeLabels diagram.system.type) }}`

Новая зависимость подписи: config.diagramTypeLabels из module/setup/config.js; контекст config уже предоставляется WitcherActorSheet.
...
Исходник и текущие связи сопоставлены в TASK-0004.006. Прежние ссылки на будущий пофайловый разбор TASK-0003 больше не являются очередью: он завершён. Остались конкретные границы сквозной проверки: [U006-04](../../../../../../../cross-check-0002.md#u006-04); [U006-07](../../../../../../../cross-check-0002.md#u006-07). TYPES.Item.<subtype> не покрывает десять подтипов en; описание использует тройные скобки.

## Связанные проблемы

[issue-00080](../../../../../../../../../issues/potential/issue-00080.md), [issue-00101](../../../../../../../../../issues/potential/issue-00101.md), [issue-00176](../../../../../../../../../issues/potential/issue-00176.md), [issue-00178](../../../../../../../../../issues/closed/issue-00178.md). Наблюдения остаются potential. Прежние issues сопоставлены по конкретному маршруту; отсутствие новой карточки не означает проверки исправности всей подсистемы.
...
Рецепты используют prepared craftingComponents UUID→name/img и счётчик по имени Actor; алхимические вещества читаются из Character.alchemyComponentsList. Learned переключается отдельно; crafting-craft не меняется при isFormulae. TYPES.Item.<subtype> не покрывает десять подтипов en; описание использует тройные скобки.
