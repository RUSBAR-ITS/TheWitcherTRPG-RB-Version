...
Три HTMLField знаний получают formGroup с enriched=lore.*.value вместо подготовленного .enriched; все show-флаги прослежены от конфигурации. Пороговые number inputs имеют StringField хранения в MonsterData; UI и схема различены. Результат передачи raw фиксирует 00013; настоящий ProseMirror/UUID/сохранение — [U013-08](../../../../../../../../cross-check-0002.md#u013-08).

Сопоставленные определения и потребители: [module/actor/sheets/WitcherMonsterSheet.js](../../../../../../../module/actor/sheets/WitcherMonsterSheet.js.md), [templates/sheets/actor/configuration/monster/general.hbs](../../../../configuration/monster/general.hbs.md), [module/data/actor/monsterData.js](../../../../../../../module/data/actor/monsterData.js.md), [module/data/dataUtils.js](../../../../../../../module/data/dataUtils.js.md).

[Протокол и границы](../../../../../../../../review-log.md#task-0004013) — TASK-0004.013; процессы [R013-18](../../../../../../../../cross-check-0002.md#r013-18). В этой порции выполнена статическая сверка; прежние опыты сохраняют свои даты и фасады. Новых поведенческих запусков нет; браузер, мир, сеть и запись в БД не запускались.
