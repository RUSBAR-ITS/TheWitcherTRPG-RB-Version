...
Четыре текстовых особенности и multi-select statusEffectImmunities связаны с MonsterData; варианты поступают из 26 статусов CONFIG. Выбор иммунитета не запускает applyStatus сам и не доказывает одинаковую защиту разных путей статуса, ранее сведённых в .004. Custom element/сохранение/бой — [U013-02](../../../../../../../../cross-check-0002.md#u013-02), [U013-07](../../../../../../../../cross-check-0002.md#u013-07).

Сопоставленные определения и потребители: [module/data/actor/monsterData.js](../../../../../../../module/data/actor/monsterData.js.md), [module/setup/config.js](../../../../../../../module/setup/config.js.md), [module/actor/witcherActor.js](../../../../../../../module/actor/witcherActor.js.md), [module/scripts/statusEffects/applyStatusEffect.js](../../../../../../../module/scripts/statusEffects/applyStatusEffect.js.md).

[Протокол и границы](../../../../../../../../review-log.md#task-0004013) — TASK-0004.013; процессы [R013-19](../../../../../../../../cross-check-0002.md#r013-19). В этой порции выполнена статическая сверка; прежние опыты сохраняют свои даты и фасады. Новых поведенческих запусков нет; браузер, мир, сеть и запись в БД не запускались.
