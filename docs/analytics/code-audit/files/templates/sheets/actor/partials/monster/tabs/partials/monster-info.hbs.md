# templates/sheets/actor/partials/monster/tabs/partials/monster-info.hbs

| Поле | Значение |
| --- | --- |
| Исходный файл | [templates/sheets/actor/partials/monster/tabs/partials/monster-info.hbs](../../../../../../../../../../../templates/sheets/actor/partials/monster/tabs/partials/monster-info.hbs) |
...
Таблица пяти общих сведений монстра: рост, вес, среда обитания, интеллект и организация. Все 22 строки прочитаны.

## Условия использования

Подключается текущей lore-вкладкой tab-details; также находится в предзагрузке.

## Введённые сущности и действия с ними

| Сущность | Вид и место определения | Назначение | Доступность или регистрация | Действия и жизненный цикл |
| --- | --- | --- | --- | --- |
| Таблица .monster-info | 1–22 | Пять подписей и input | system.height/weight/environment/intelligence/organization | Каждое поле type=text; значения экранируются |
...
| CSS-селекторы | [styles/monster/details.css](../../../../../../../../../../../styles/monster/details.css) | оформление | .monster-info | Прочитаны нужные селекторы; полный CSS вне порции |
...
Все пять полей MonsterData — StringField, включая weight; это описание монстра, отдельное от массы Item/расчёта переносимого веса. Именованные поля передаются общей форме, специальных обработчиков нет.

## Проверки и доказательства

| Что проверено | Источник, команда или сценарий | Фактический результат | Ограничения |
| --- | --- | --- | --- |
| Рендер/payload | 09 | Пять ключей system.*, строка <weight> экранируется в HTML и сохраняется строкой payload | Сохранение в БД не проверялось |
...
[issue-00209](../../../../../../../../../../issues/potential/issue-00209.md). Категория/угроза/сложность/награда не редактируются и в этой таблице; отдельное наблюдение issue-00209.
...
Пять строковых полей MonsterData height/weight/environment/intelligence/organization поступают через detailTabs.lore. Weight здесь описательная строка, не расчёт массы Item. Экранирование/строковый payload исторического HBS подтверждает передачу, не настоящую БД. [U013-02](../../../../../../../../cross-check-0002.md#u013-02), [U013-07](../../../../../../../../cross-check-0002.md#u013-07).

Сопоставленные определения и потребители: [templates/sheets/actor/partials/monster/tabs/tab-details.hbs](../tab-details.hbs.md), [module/data/actor/monsterData.js](../../../../../../../module/data/actor/monsterData.js.md), [styles/monster/details.css](../../../../../../../styles/monster/details.css.md).
