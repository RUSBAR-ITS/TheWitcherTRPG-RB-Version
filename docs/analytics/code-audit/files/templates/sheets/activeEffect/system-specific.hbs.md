...
2026-09-18, TASK-0010.003. **Назначение:** Системная вкладка активного эффекта.

**Сущности, действия и зависимости:** При наличии схемы выводит effectTypeId/nonStacking; сохраняет прежние apply-флаги. Модели base/temporary и context.systemFields задают наличие полей.

[Исходник](../../../../../../../templates/sheets/activeEffect/system-specific.hbs), [проверки и границы](../../../../../task-0010-003-checks.md). Статическая проверка; игровая приёмка не проводилась. Численный контракт следующих стадий ещё не внедрён.

## Предыдущие датированные проверки

## Текущая реализация — issue-00334, 14.3.1.00022

Системные поля ActiveEffect с проверкой схемы. Изменение 2026-09-17 по [issue-00334](../../../../../../issues/closed/issue-00334.md); основание — исходники, а не новая браузерная приёмка.
...
[issue-00053](../../../../../../issues/closed/issue-00053.md) — отсутствующее поле временного улучшения; [issue-00043](../../../../../../issues/potential/issue-00043.md) — согласование флага с changes при частичном обновлении.
