...
[issue-00121](../../../../../../issues/closed/issue-00121.md), [issue-00122](../../../../../../issues/closed/issue-00122.md). Форма позволяет задать счётчик и ссылку, которые читаются описанными ветвями модели; отдельной подтверждённой ошибки разметки в этой порции не выявлено.
