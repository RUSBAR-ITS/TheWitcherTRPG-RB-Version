...
## Игровая проверка текущего шаблона — 2026-09-19, отчёт .00119

Код .00118 проверен в настоящем Foundry14.367: открытие component, сохранение пустых/выбранных/нестандартных кодов, смена категории с сохранением скрытой субстанции, инвентарный type=component, quantity/формула, ru/en и повторная загрузка. Настроенный материал корректно расходуется при ремонте. Прокрутка позволяет добраться до нижней таблицы в стандартном окне. [Результаты и пределы](../../../../../task-0011-browser-checks.md#component-00119). Игровой код в .00119 не менялся; ниже сохранены реализация и прежние границы её проверки.
...
[issue-00094](../../../../../../issues/closed/issue-00094.md). Ошибка совместимости helper подтверждена изолированным рендером.
