...
Начальный выбор браузера при attribute='' и полный ItemSheetV2 submit не выполнялись: [U004-01](../../../../cross-check-0002.md#u004-01)/[U004-03](../../../../cross-check-0002.md#u004-03). Допустимость выбора характеристик по правилам не устанавливалась.
...
Два именованных поля формы принадлежат Item: name и system.attribute. selectOptions получает девять origin=stats из WitcherSkillItemSheet; model attribute='' не ограничен choices. В форме нет уровня, label или флагов; отсутствие этих контролов не означает отсутствие соответствующих полей модели.

Сопоставленные определения и потребители: [module/item/sheets/WitcherSkillItemSheet.js](../../../module/item/sheets/WitcherSkillItemSheet.js.md), [module/data/item/skillItemData.js](../../../module/data/item/skillItemData.js.md), [templates/partials/character/tab-skills.hbs](../../partials/character/tab-skills.hbs.md).
