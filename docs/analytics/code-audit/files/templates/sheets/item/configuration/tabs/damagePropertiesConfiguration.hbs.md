...
Исходник и текущие связи сопоставлены в TASK-0004.006. Прежние ссылки на будущий пофайловый разбор TASK-0003 больше не являются очередью: он завершён. Остались конкретные границы сквозной проверки: [U006-01](../../../../../../cross-check-0002.md#u006-01); [U006-03](../../../../../../cross-check-0002.md#u006-03). Три незавершённых поля не получают расчёт только из-за наличия controls; oilEffect не имеет собственного formGroup.
...
Форма читает DamageProperties через systemFields, выбирает silverTrait/silverDamage по setting и условно cap/varEffect. Собственный TypedObject редактируется по id, воздействия улучшений disabled. Три незавершённых поля не получают расчёт только из-за наличия controls; oilEffect не имеет собственного formGroup.

Сопоставленные определения и потребители: [module/data/item/templates/itemEffectData.js](../../../../../module/data/item/templates/itemEffectData.js.md), [module/item/sheets/configurations/WitcherPropertiesConfigurationSheet.js](../../../../../module/item/sheets/configurations/WitcherPropertiesConfigurationSheet.js.md), [templates/sheets/item/armor-sheet.hbs](../../armor-sheet.hbs.md), [templates/sheets/item/enhancement-sheet.hbs](../../enhancement-sheet.hbs.md).
