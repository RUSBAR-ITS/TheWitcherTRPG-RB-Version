...
Исходник и текущие связи сопоставлены в TASK-0004.006. Прежние ссылки на будущий пофайловый разбор TASK-0003 больше не являются очередью: он завершён. Остались конкретные границы сквозной проверки: [U006-01](../../../../../../cross-check-0002.md#u006-01); [U006-06](../../../../../../cross-check-0002.md#u006-06). Этот PART не является списком itemEffect словаря.

## Связанные проблемы

[issue-00056](../../../../../../../../issues/closed/issue-00056.md) — ссылка раскрытия описания не имеет найденного Item-обработчика.
...
Вкладка передаёт общему effect-part контекст configuration и CSS активной вкладки. Управление встроенными ActiveEffect принадлежит WitcherConfigurationSheet; расчёт чисел и временных свойств вынесен в .005. Этот PART не является списком itemEffect словаря.

Сопоставленные определения и потребители: [module/item/sheets/configurations/WitcherConfigurationSheet.js](../../../../../module/item/sheets/configurations/WitcherConfigurationSheet.js.md), [templates/sheets/item/configuration/tabs/header.hbs](header.hbs.md), [templates/partials/effect-part.hbs](../../../../partials/effect-part.hbs.md), [module/activeEffect/witcherActiveEffect.js](../../../../../module/activeEffect/witcherActiveEffect.js.md).

[Протокол и границы](../../../../../../review-log.md#task-0004006) — TASK-0004.006; процессы [R006-03](../../../../../../cross-check-0002.md#r006-03). В этой порции выполнена статическая сверка; поведенческие опыты принадлежат датированным прежним протоколам, а не новому прогону.
