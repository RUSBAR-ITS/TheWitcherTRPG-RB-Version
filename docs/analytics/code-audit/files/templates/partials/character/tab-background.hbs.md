...
Генераторы биографии уже разобраны в TASK-0003.053–.056; найденного автоматического переноса в форму нет. Остаются [U013-08](../../../../cross-check-0002.md#u013-08), [U013-06](../../../../cross-check-0002.md#u013-06): указанные там динамические границы и критерии дальнейшей сверки. Нынешняя проверка статическая; прежние изолированные опыты .025/.031/.032/.033 сохраняют даты и фасады. Полный браузерный лист, Document.create/update в БД, внешние модули и несколько клиентов не запускались.
...
Полный разбор 41 witcher-lifepath JSON не установил автоматического переноса сообщений в редактор биографии :51–53 или событий :57–95. Шаблон хранит ручные поля; указания таблиц о возрасте, риске, союзниках и ранениях не создают здесь карточек. Ветка биографии ведьмака и четыре Decade вызваны изолированно как RollTable; настоящий UI формы не запускался.
...
Полностью проверены 13 основных генераторов и связи всех пяти биографических пакетов. Тексты не переносятся автоматически в поля биографии/событий этого HBS. Обычная ссылка на RollTable открывает её собственный лист; кнопка броска относится к Foundry RollTableSheet, а не к форме Actor. Фасады открытия/броска таблиц не являются проверкой сохранения данной формы.
...
Полностью сведены поля семи details/родины/пола/возраста/положения, background raw/enriched,20 событий по UI key и оба формата заметок. Character подготовка lifeEvents меняет prepared модель, eachLimit не ограничен её длиной. Старые .053–.056 уже разобрали генераторы биографии; автоматического переноса текста/бонусов в форму не найдено. Остаются текущая сквозная сверка таблиц .017, редактор/запись/переиндексация [U013-08](../../../../cross-check-0002.md#u013-08).

Сопоставленные определения и потребители: [module/actor/sheets/WitcherCharacterSheet.js](../../../module/actor/sheets/WitcherCharacterSheet.js.md), [module/data/actor/characterData.js](../../../module/data/actor/characterData.js.md), [module/data/actor/templates/character/generalData.js](../../../module/data/actor/templates/character/generalData.js.md), [module/data/item/homelandData.js](../../../module/data/item/homelandData.js.md), [module/data/dataUtils.js](../../../module/data/dataUtils.js.md), [module/actor/sheets/WitcherActorSheet.js](../../../module/actor/sheets/WitcherActorSheet.js.md), [module/actor/sheets/WitcherActorSheetV1.js](../../../module/actor/sheets/WitcherActorSheetV1.js.md), [module/setup/handlebars.js](../../../module/setup/handlebars.js.md).

[Протокол и границы](../../../../review-log.md#task-0004013) — TASK-0004.013; процессы [R013-24](../../../../cross-check-0002.md#r013-24), [R013-25](../../../../cross-check-0002.md#r013-25), [R013-26](../../../../cross-check-0002.md#r013-26), [R013-27](../../../../cross-check-0002.md#r013-27). В этой порции выполнена статическая сверка; прежние опыты сохраняют свои даты и фасады. Новых поведенческих запусков нет; браузер, мир, сеть и запись в БД не запускались.
