...
Бросок и модель уже сопоставлены; визуальный цикл и фактические переводы — [U004-01](../../../../cross-check-0002.md#u004-01)/[U004-06](../../../../cross-check-0002.md#u004-06). Правила игровых категорий флагов не интерпретировались.

## Связанные проблемы

[issue-00004](../../../../../../issues/closed/issue-00004.md), [issue-00015](../../../../../../issues/potential/issue-00015.md), [issue-00016](../../../../../../issues/closed/issue-00016.md), [issue-00018](../../../../../../issues/potential/issue-00018.md). Путь commonsp, подписи и видимость соотнесены с существующими issues; новых по одной этой строке не создавалось.
...
Родитель явно передаёт skill/name/stat, поэтому label/value берутся из встроенной модели. Показанное modifiedValue=value+activeEffectModifiers не равно полной формуле броска: характеристика, социальный статус, EC и группы добавляются Actor-методом. Текущий partial игнорирует isVisible, в отличие от старого monster partial; флаги определяют класс и независимые иконки.

Сопоставленные определения и потребители: [templates/partials/character/tab-skills.hbs](tab-skills.hbs.md), [module/actor/mixins/skillMixin.js](../../../module/actor/mixins/skillMixin.js.md), [templates/partials/monster/monster-skill-display.hbs](../monster/monster-skill-display.hbs.md), [module/data/actor/templates/common/skills/skillData.js](../../../module/data/actor/templates/common/skills/skillData.js.md).

[Протокол и границы](../../../../review-log.md#task-0004004) — TASK-0004.004; процессы [R004-01](../../../../cross-check-0002.md#r004-01), [R004-10](../../../../cross-check-0002.md#r004-10). В этой порции выполнена статическая сверка; поведенческие опыты принадлежат датированным прежним протоколам, а не новому прогону.
