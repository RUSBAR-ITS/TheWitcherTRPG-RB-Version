...
2026-09-16, dev, база aeb527c6e6402e8a5f940a2c3ad0020d7e5b35e4. Отображаемые placeholder/tooltip используют `WITCHER.Actor.focus.firstPlaceholder`, `WITCHER.Actor.focus.fourthPlaceholder`, `WITCHER.Actor.focus.secondPlaceholder`, `WITCHER.Actor.focus.thirdPlaceholder`. Привязки name/data-field, классы действий, условия шаблона и введённые имена сохранены.
...
[issue-00192](../../../../../../issues/closed/issue-00192.md). Общая вкладка дополнительно показывает магические IP, которых нет в схеме монстра; связь уточнена в прежней issue-00192 о полях развития персонажа в UI монстра. Браузерная запись этого поля не проверялась.
