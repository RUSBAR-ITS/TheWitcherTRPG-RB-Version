...
2026-09-16, dev, база aeb527c6e6402e8a5f940a2c3ad0020d7e5b35e4. Отображаемые placeholder/tooltip используют `WITCHER.Actor.deathSaves.add`, `WITCHER.Actor.deathSaves.reset`. Привязки name/data-field, классы действий, условия шаблона и введённые имена сохранены. Формирование ключей из пустых homeland/socialStanding не исправлялось.
