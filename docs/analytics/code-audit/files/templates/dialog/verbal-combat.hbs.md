...
2026-09-19, TASK-0011.003. Каждый input[name=verbalCombat] вложен в собственный label; глобальные id/for удалены. value и data-group заполняются из каждой записи CONFIG.WITCHER.verbalCombat, имена группы/модификатора и существующие checked сохранены. Потребитель Actor.verbalCombat читает button.form; подписи по-прежнему через localize.
...
[303](../../../../../issues/potential/issue-00303.md) — общий глобальный radio; [186](../../../../../issues/closed/issue-00186.md) — существующий пропуск русской подписи. Новых самостоятельных правил выбора/нумерации действий не вводилось.
