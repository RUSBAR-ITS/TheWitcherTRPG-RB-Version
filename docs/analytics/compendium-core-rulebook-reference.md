...
Вспомогательный первичный материал для [issue-00331](../issues/open/issue-00331.md) и [сравнения с JSON](compendium-core-rulebook-comparison.md). Это выписка из предоставленной книги, а не описание исправленной системы.
