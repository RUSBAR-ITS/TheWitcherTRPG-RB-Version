...
Дата: 2026-09-16. Ветка `dev`, HEAD `433060047ca195773d582cac782a6a83a5c91ade`; исходные данные версии `14.3.1.00013`, оформление `14.3.1.00014`. Основание — поручение пользователя извлечь правила из предоставленной английской книги, сравнить компедиумы и дополнить [issue-00331](../issues/open/issue-00331.md).
