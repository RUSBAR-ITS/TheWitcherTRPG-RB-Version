...
[issue-00320 и issue-00328 остаются в механиках](../issues/closed/issue-00332.md). Сборка, воспроизводимость и установка библиотек относятся к [issue-00333](../issues/closed/issue-00333.md).
