...
**Текущее состояние:** .006–.011 выполнены; [вторая очередь .012–.023](#second-wave) поставлена и ещё не выполнялась. Следующая — .012. B01–B20 служат учёту остатка, а не являются двадцатью задачами. Исторические таблицы .005 сохранены; фактическое покрытие указано отдельно.
...
2026-09-15 пользователь поручил оформить следующую очередь с приоритетом пользы справочника для понимания и точечных изменений системы. Срез планирования — rusbar-main, `2cda0cfed8fb21919c9f4e33bf90c682b295a6ac`. Ни одна новая задача пока не выполнялась; следующая — [TASK-0006.012](../../tasks/task-0006.012.md).

| Задача | Результат | Основных файлов | После | Статус |
| --- | --- | ---: | --- | --- |
| [TASK-0006.012](../../tasks/task-0006.012.md) | Общие документы Actor/Item и подготовка контекста | 9 | .011 | `planned` |
...
Историческая проверка .005: перечень 615/615, роли 23/13/579 и 62 границы соответствовали пилоту. После .011 те же 615/615 путей, роли 60/94/461 и 214 границ; раздельные сведения в inventory. .006–.011 выполнены; .012–.023 planned, остальные области требуют дальнейшего согласования. Постановка задач не изменила данные графа, роли, покрытие или результаты тестов .011. TASK-0006 остаётся in-progress.
