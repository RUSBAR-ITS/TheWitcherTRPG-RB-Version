...
**Текущий охват:** 4999 сущностей, 13817 отношений и 425 процессов (1391 шаг, 2596 переходов). Определения есть в 291/615 файлах: два словаря complete по строковым ключам, 289 файлов partial; роли 206 основных/85 смежных, 324 без определений. Отношения представлены в 295 файлах, локальные шаги процессов — в 145. .001–.030 выполнены; третья очередь продолжается с [TASK-0006.031](../../tasks/task-0006.031.md). .031–.034 planned, общий TASK-0006 in-progress, покрытие partial. [Учёт остатка](expansion-plan.md#third-wave).
...
[План и десять стыков](expansion-plan.md#third-wave): ручные ресурсы, хранение/улучшения Item, расы/профессии/развитие, магические данные, сотворение и регионы. Десять порций наполнения и завершающая сверка .034; .024–.030 done, .031–.034 planned. Следующая — [TASK-0006.031](../../tasks/task-0006.031.md). Существующие записи, формат/CLI и показатели .023 при постановке сохранены.
