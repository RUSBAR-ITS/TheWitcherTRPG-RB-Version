...
[issue-00330](../../issues/open/issue-00330.md): N01–N08 выполнены в 14.3.1.00010; закрыты все 20 исходных локализационных карточек. Сохранены прежние ключи; механики/компедиумы и ошибки пустых полей исключены. Адресные проверки успешны; живая приёмка остаётся пользователю.
