...
**Текущий охват:** 4634 сущности, 12075 связей и 363 процесса (1169 шагов, 2148 переходов). Определения есть в 254/615 файлах: два словаря complete по строковым ключам, 252 файла partial; роли 151 основной/103 смежных, 361 без определений. Отношения представлены в 258 файлах, локальные шаги процессов — в 114. .001–.024 выполнены; третья очередь продолжается с [TASK-0006.025](../../tasks/task-0006.025.md). .025–.034 planned, общий TASK-0006 in-progress, покрытие partial. [Учёт остатка](expansion-plan.md#third-wave).
...
| [Расширение](expansion-plan.md) / [полный перечень](expansion-inventory.json) | 615 файлов: исторические роли пилота и отдельное текущее покрытие; .006–.024 выполнены; .025–.034 planned, следующая .025; полный индекс partial |
...
[План и десять стыков](expansion-plan.md#third-wave): ручные ресурсы, хранение/улучшения Item, расы/профессии/развитие, магические данные, сотворение и регионы. Десять порций наполнения и завершающая сверка .034; .024 done, .025–.034 planned. Следующая — [TASK-0006.025](../../tasks/task-0006.025.md). Существующие записи, формат/CLI и показатели .023 при постановке сохранены.
