...
**Текущий охват:** 4700 сущностей, 12374 связи и 382 процесса (1236 шагов, 2276 переходов). Определения есть в 261/615 файлах: два словаря complete по строковым ключам, 259 файлов partial; роли 166 основных/95 смежных, 354 без определений. Отношения представлены в 265 файлах, локальные шаги процессов — в 128. .001–.026 выполнены; третья очередь продолжается с [TASK-0006.027](../../tasks/task-0006.027.md). .027–.034 planned, общий TASK-0006 in-progress, покрытие partial. [Учёт остатка](expansion-plan.md#third-wave).
...
[План и десять стыков](expansion-plan.md#third-wave): ручные ресурсы, хранение/улучшения Item, расы/профессии/развитие, магические данные, сотворение и регионы. Десять порций наполнения и завершающая сверка .034; .024–.026 done, .027–.034 planned. Следующая — [TASK-0006.027](../../tasks/task-0006.027.md). Существующие записи, формат/CLI и показатели .023 при постановке сохранены.
