...
**Текущий охват:** 4795 сущностей, 12708 связей и 393 процесса (1270 шагов, 2336 переходов). Определения есть в 273/615 файлах: два словаря complete по строковым ключам, 271 файл partial; роли 182 основных/91 смежный, 342 без определений. Отношения представлены в 277 файлах, локальные шаги процессов — в 133. .001–.027 выполнены; третья очередь продолжается с [TASK-0006.028](../../tasks/task-0006.028.md). .028–.034 planned, общий TASK-0006 in-progress, покрытие partial. [Учёт остатка](expansion-plan.md#third-wave).
