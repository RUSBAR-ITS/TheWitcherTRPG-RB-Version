...
Текущий UI-срез: [issue-00334](../../issues/open/issue-00334.md), 14.3.1.00022. Уточнены единственный список травм, уникальность Actor-категорий, Item-action описания и повторный рендер редактора/конвертера. Новые локальные маршруты: proc-000466–000468; удалённые определения/связи находятся в retired_ids. Игровая приёмка ожидает команды пользователя.
...
Согласованный состав работ по компедиумам: [контент](../../issues/closed/issue-00331.md), [механики](../../issues/open/issue-00332.md), [процессы](../../issues/open/issue-00333.md). Общие карточки содержат 9 / 15 / 11 исходных issues; нового покрытия кода или изменения механизма справочника этим оформлением нет.
