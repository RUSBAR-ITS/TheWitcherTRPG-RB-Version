...
**Текущий охват:** 5169 сущностей, 14419 отношений и 440 процессов (1436 шагов, 2701 переходов). Определения есть в 301/615 файлах: два словаря complete по строковым ключам, 299 файлов partial; роли 222 основных/79 смежных, 314 без определений. Отношения представлены в 305 файлах, локальные шаги процессов — в 154. .001–.031 выполнены; третья очередь продолжается с [TASK-0006.032](../../tasks/task-0006.032.md). .032–.034 planned, общий TASK-0006 in-progress, покрытие partial. [Учёт остатка](expansion-plan.md#third-wave).
...
[План и десять стыков](expansion-plan.md#third-wave): ручные ресурсы, хранение/улучшения Item, расы/профессии/развитие, магические данные, сотворение и регионы. Десять порций наполнения и завершающая сверка .034; .024–.031 done, .032–.034 planned. Следующая — [TASK-0006.032](../../tasks/task-0006.032.md). Существующие записи, формат/CLI и показатели .023 при постановке сохранены.
