...
**Текущий охват:** 4936 сущностей, 13603 связи и 416 процессов (1360 шагов, 2529 переходов). Определения есть в 284/615 файлах: два словаря complete по строковым ключам, 282 файла partial; роли 197 основных/87 смежных, 331 без определений. Отношения представлены в 288 файлах, локальные шаги процессов — в 139. .001–.029 выполнены; третья очередь продолжается с [TASK-0006.030](../../tasks/task-0006.030.md). .030–.034 planned, общий TASK-0006 in-progress, покрытие partial. [Учёт остатка](expansion-plan.md#third-wave).
...
[План и десять стыков](expansion-plan.md#third-wave): ручные ресурсы, хранение/улучшения Item, расы/профессии/развитие, магические данные, сотворение и регионы. Десять порций наполнения и завершающая сверка .034; .024–.029 done, .030–.034 planned. Следующая — [TASK-0006.030](../../tasks/task-0006.030.md). Существующие записи, формат/CLI и показатели .023 при постановке сохранены.
