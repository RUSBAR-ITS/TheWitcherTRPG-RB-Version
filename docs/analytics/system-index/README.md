...
[issue-00330](../../issues/open/issue-00330.md): в 14.3.1.00007 исправлены подписи ru/en; сверка 14.3.1.00008 закрыла 19 исходных карточек. Issue-00178 остаётся частичной (potion/decoction/oil); повторная проверка 14.3.1.00009 добавила план N01–N08, включая чертежи/формулы и непереведённые подписи. Общая issue остаётся open; ошибка пустой шапки отложена отдельно. Механики и компедиумы исключены; прежние ключи сохранены.
...
**Текущий охват:** 5366 сущностей, 15129 отношения и 465 процессов (1537 шагов, 2918 переходов). Определения есть в 305/615 файлах: два словаря complete по строковым ключам, 303 файла partial; роли 232 основных/73 смежных, 310 без определений. Отношения представлены в 309 файлах, локальные шаги процессов — в 160. .001–.034 выполнены; [сверка .034](coverage-034.md) завершила третью очередь. Общий TASK-0006 in-progress, покрытие partial. [Точный остаток](coverage-034.md#remaining).
