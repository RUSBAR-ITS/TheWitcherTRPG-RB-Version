...
**Текущий охват:** 4885 сущностей, 13350 связей и 408 процессов (1314 шагов, 2426 переходов). Определения есть в 283/615 файлах: два словаря complete по строковым ключам, 281 файл partial; роли 195 основных/88 смежных, 332 без определений. Отношения представлены в 287 файлах, локальные шаги процессов — в 139. .001–.028 выполнены; третья очередь продолжается с [TASK-0006.029](../../tasks/task-0006.029.md). .029–.034 planned, общий TASK-0006 in-progress, покрытие partial. [Учёт остатка](expansion-plan.md#third-wave).
...
[План и десять стыков](expansion-plan.md#third-wave): ручные ресурсы, хранение/улучшения Item, расы/профессии/развитие, магические данные, сотворение и регионы. Десять порций наполнения и завершающая сверка .034; .024–.028 done, .029–.034 planned. Следующая — [TASK-0006.029](../../tasks/task-0006.029.md). Существующие записи, формат/CLI и показатели .023 при постановке сохранены.
