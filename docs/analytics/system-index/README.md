...
[К01 / .00016](../../issues/open/issue-00331.md#implementation): актуализированы хеши 48 JSON и их пофайловые карточки после контентных исправлений. Эти источники не имеют отдельных определений/процессов в JSONL; три входящие ссылки на файлы сохранены. Объём покрытия, сущности, отношения и процессы не менялись.

Согласованный состав работ по компедиумам: [контент](../../issues/open/issue-00331.md), [механики](../../issues/open/issue-00332.md), [процессы](../../issues/open/issue-00333.md). Общие карточки содержат 9 / 15 / 11 исходных issues; нового покрытия кода или изменения механизма справочника этим оформлением нет.
...
**Текущий охват:** 5386 сущностей, 15239 отношений и 465 процессов (1537 шагов, 2918 переходов). Определения есть в 305/615 файлах: два словаря complete по строковым ключам, 303 файла partial; роли 232 основных/73 смежных, 310 без определений. Отношения представлены в 319 файлах, локальные шаги процессов — в 160. .001–.034 выполнены; [сверка .034](coverage-034.md) завершила третью очередь. Общий TASK-0006 in-progress, покрытие partial. [Точный остаток](coverage-034.md#remaining).
