...
[План 00332](../../issues/open/issue-00332.md#plan), .00025: по текущим сущностям/отношениям и процессам выделены девять блоков/12 issues. Нового покрытия графа на этапе плана нет; [TASK-0010](../../tasks/task-0010-parameter-limits.md) откладывает ограничения параметров. После реализации обновляются только затронутые записи, новые исходники и прямые связи.
...
Согласованный состав работ по компедиумам: [контент](../../issues/closed/issue-00331.md), [механики](../../issues/open/issue-00332.md), [процессы](../../issues/open/issue-00333.md). Общие карточки содержат 9 / 15 / 11 исходных issues; 2026-09-17 три из 15 механик (00121, 00288, 00289) отложены в [TASK-0009](../../tasks/task-0009-critical-wound-behavior.md), 12 остаются в текущем обсуждении; нового покрытия кода или изменения механизма справочника этим оформлением нет.
...
**Текущий охват:** 5392 сущностей, 15241 отношений и 468 процессов (1543 шагов, 2928 переходов). Определения есть в 305/615 файлах: два словаря complete по строковым ключам, 303 файла partial; роли 232 основных/73 смежных, 310 без определений. Отношения представлены в 319 файлах, локальные шаги процессов — в 161. .001–.034 выполнены; [сверка .034](coverage-034.md) завершила третью очередь. Общий TASK-0006 in-progress, покрытие partial. [Точный остаток](coverage-034.md#remaining).
