...
**Текущий срез .00035:** [issue-00333](../../issues/open/issue-00333.md#implementation-00035), 621 источник. Обновлены контейнерные пути и связанные контракты Item/ритуала; новые модули описаны в `data/{entities,relations,processes}/issue-00333.jsonl`. Статические/изолированные результаты — в [журнале](review-log.md); игровая приёмка ожидается. Датированные прежние показатели ниже относятся к указанным этапам.
