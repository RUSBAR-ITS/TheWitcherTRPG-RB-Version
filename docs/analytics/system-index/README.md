...
**Текущий охват:** 5328 сущностей, 14954 отношения и 465 процессов (1537 шагов, 2918 переходов). Определения есть в 305/615 файлах: два словаря complete по строковым ключам, 303 файла partial; роли 232 основных/73 смежных, 310 без определений. Отношения представлены в 309 файлах, локальные шаги процессов — в 160. .001–.033 выполнены; третья очередь продолжается с [TASK-0006.034](../../tasks/task-0006.034.md), итоговой сверки. Общий TASK-0006 in-progress, покрытие partial. [Учёт остатка](expansion-plan.md#third-wave).
