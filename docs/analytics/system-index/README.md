...
**Текущий охват:** 4670 сущностей, 12209 связей и 373 процесса (1204 шага, 2216 переходов). Определения есть в 257/615 файлах: два словаря complete по строковым ключам, 255 файлов partial; роли 158 основных/99 смежных, 358 без определений. Отношения представлены в 261 файле, локальные шаги процессов — в 122. .001–.025 выполнены; третья очередь продолжается с [TASK-0006.026](../../tasks/task-0006.026.md). .026–.034 planned, общий TASK-0006 in-progress, покрытие partial. [Учёт остатка](expansion-plan.md#third-wave).
...
[План и десять стыков](expansion-plan.md#third-wave): ручные ресурсы, хранение/улучшения Item, расы/профессии/развитие, магические данные, сотворение и регионы. Десять порций наполнения и завершающая сверка .034; .024–.025 done, .026–.034 planned. Следующая — [TASK-0006.026](../../tasks/task-0006.026.md). Существующие записи, формат/CLI и показатели .023 при постановке сохранены.
