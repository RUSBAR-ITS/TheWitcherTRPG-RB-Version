...
[issue-00330](../../issues/open/issue-00330.md) реализована в 14.3.1.00007: подписи ru/en, без удаления прежних ключей, изменения механик и компедиумов; живая приёмка остаётся пользователю.


Текущий технический срез обновлён после [issue-00001](../../issues/open/issue-00001.md): ID пакета и зависимые обращения — TheWitcherTRPG-RB-Version. Постоянные ID и объём покрытия сохранены. HEAD в snapshot — база рабочих изменений; source_hash фиксирует фактические исходники. Датированные coverage/протоколы прежних задач описывают прежние срезы.
