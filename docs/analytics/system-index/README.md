...
**Актуализация .00139 / TASK-0012:** временные ПЗ: настройки/ID навыков → вычислитель → сохранённая доставка → общий FIFO/снятие → локальный боевой срок. 651 источник; добавлены26 сущностей,89 прямых связей и один процесс, переписаны три процесса,68 устаревших локальных сущностей/связей зарезервированы в retired_ids. [79/79 проверок и границы](../task-0012-checks.md); .008 ещё не проводилась. Покрытие partial, полный прогон справочных сценариев не выполнялся.

**Актуализация .00109 / TASK-0011.009:** [итоговая статическая приёмка](../task-0011-static-checks.md#task-0011009),14 адресных проверок графа. Игровые связи/ID/645 исходников и partial-охват сохранены; актуализированы версия и документальные метаданные. B01–B09 ещё не выполнены.

**Актуализация .00108 / TASK-0011.008:** [потребители доставки](../task-0011-static-checks.md#task-0011008) направлены через общий сервис: профессия/Item-последствия → карточка, парирование → явная ссылка при отказе, крит → контролируемый адреналин после сообщения. Добавлен шаблон предупреждения, всего645 исходников. ID сохранены, исчезнувшие прямые query/вызовы retired, partial-охват и границы TASK-0012/B08 сохранены.

**Актуализация .00107 / TASK-0011.007:** [карточка доставки и castSpell](../task-0011-static-checks.md#task-0011007): общий снимок → preflight всех → сохранённое sending → ожидаемые результаты; waiting допускает ручную отправку, unknown требует проверки. Добавлен шаблон, всего644 исходника. Старые прямые связи castSpell с четырьмя обёртками заменены маршрутом через сервис; partial-охват сохранён, B07 впереди.

**Актуализация .00106 / TASK-0011.006:** [конечная доставка](../task-0011-static-checks.md#task-0011006): source → executor → local/query → JSON result. Два новых исходника,643 всего; обёртки и процессы обновлены. Групповая проверка/карточка ещё .007, потребители .008, игровая приёмка отдельно.

**14.3.1.00105, TASK-0011.005:** [хранение экипировки/EV](../task-0011-static-checks.md#task-0011005): существующие определения/процессы уточнены, шесть новых связей записи equipped, EV→isStored стал reads. Partial-охват сохранён; B05 впереди.

**14.3.1.00104, TASK-0011.004:** [алхимия и ремонт](../task-0011-static-checks.md#task-0011004): адресные getter/исполнители, query вместо emitForGM, ожидаемая цепочка и preflight. Добавлены 10 сущностей/26 связей, три устаревшие связи зарезервированы; partial-охват сохранён. 38 локальных сценариев, B04 впереди.

**14.3.1.00103, TASK-0011.003:** [меню и формы словесного боя](../task-0011-static-checks.md#task-0011003) приведены к native DOM/своему корню. Описания, guard/return двух процессов и адреса актуализированы; основная масса сдвигов — существующие ссылки ru/en (+2 строки). ID и partial-охват сохранены, 38 локальных и один адресный тест прошли; B03 впереди.

**14.3.1.00102, TASK-0011.002:** [локальная обёртка skillListener](../task-0011-static-checks.md#task-0011002), вызов внешнего `$` без записи в глобальную jQuery. Обновлены прямые связи и процессы регистрации; ID/объём покрытия сохранены. Браузер B02 ещё не запускался.

**14.3.1.00101, TASK-0011.001:** [REC и сердечко HP](../task-0011-static-checks.md#task-0011001) актуализированы по коду: min действующего STA.max, чтение hp.max, ожидание callbacks и зависимые адреса. Новых сущностей/процессов нет, IDs сохранены; общий охват partial.36 поведенческих и три адресных проверки прошли, игровая B01 впереди.

TASK-0010.011 выполнена в14.3.1.00070: [база criticalWounds установлена](../task-0010-011-pack-installation.md). Состав графа прежний (641/5824/15796/488); JSON .010 не менялись. Следующие стадии — итог .012 и мир .013.


TASK-0010.010 выполнена локально в14.3.1.00069;641 источник,5824 сущности,15796 связей,488 процессов. [Матрица контента](../task-0010-010-content-matrix.md); конфигурация статусов уточнена, источники/карточки обновлены. Состав графа не расширялся ради отдельных чисел JSON; сборка базы и мир впереди.


TASK-0010.009 выполнена локально в14.3.1.00068:641 источник,5824 сущности,15796 связей,488 процессов. [Доставка, семейства и пакетное истечение](../task-0010-009-checks.md). Компедиумы и браузерная приёмка впереди.

**Кнопка профессии .00067:** issue-00111 исправлена: действие removeEffectDamageProperties связано с обработчиком, element передаётся вторым аргументом. Актуализирован процесс402 и связанные узлы; [локальные проверки](../issue-00111-checks.md), браузерная граница сохранена.

**Потребители .00066:** TASK-0010.008 — prepareCheck, явные адреса Item/профессии, условный выбор до расходов. 638 источников, 5802 сущностей, 15752 связей, 485 процессов. [Проверки и оставшиеся UI-границы](../task-0010-008-checks.md). Покрытие partial; доставка/компедиумы/браузер впереди.

**Контекст броска .00065:** TASK-0010.007 — rollContext, conditionalModifiers и общий формат численных вкладов. Исправлены оба defense-входа и ядро сравнения порога.637 источников,5797 сущностей,15861 связь,477 процессов. [Локальные проверки и границы](../task-0010-007-checks.md). Подключение всех игровых потребителей — .008; общий охват остаётся partial.

**Сохраняемые операции .00064:** TASK-0010.006 — прокачка и коррекция приобретённой базы/ресурсов после завершённой смены воздействий. Новые входы: parameterAdvancement.purchaseParameter, parameterPersistence.withParameterChanges, WitcherActor.updateDocuments.633 источника,5786 сущностей,15826 связей,476 процессов. [Проверки и пределы](../task-0010-006-checks.md). Броски/несуммируемые эффекты/компедиумы ещё впереди.

**Текущий расчёт, .00063:** TASK-0010.003–.005 подключили модель/редактор, primary/builtin и производные с исключениями. 631 источник,5768 сущностей,15772 связи,474 процесса; покрытие остаётся частичным. [Результаты](../task-0010-005-checks.md). Для нового маршрута искать derivedPreparation.calculateDerivedParameter; дальнейшие записи/броски и компедиумы ещё в работе. Ниже — датированные срезы предыдущих изменений.
...
В **.00048** граф обновлён по [модели и редактору травм](../task-0009-002-checks.md): новые поля/getters/Drop и зависимости. Переходы/заживление описывают промежуточный код; .003–.005 ещё не завершены.

**Сверка проекта .00047:** [TASK-0009](../../tasks/task-0009-critical-wound-behavior.md#final-review-00047) финализирована по текущим источникам/входящим связям. Уточнены уже существующие await/return в rel-008006/011436/011470, ent-004495 и proc-000329.transition. Новые операции проекта не добавлены в граф как действующие; объём покрытия прежний.


**Уточнение планов .00039:** жизненный цикл травм относится к [TASK-0009](../../tasks/task-0009-critical-wound-behavior.md), общий расчёт эффектов и issue-00036 — к [TASK-0010](../../tasks/task-0010-parameter-limits.md#issue-00036). Код и покрытие графа не изменились; ниже сохранены датированные результаты прежних этапов.


В .00037 [issue-00333 и 16 связанных карточек закрыты](../../issues/closed/issue-00333.md#closure) по поручению пользователя. Ссылки перенесены в closed, IDs/семантика графа сохранены; два наблюдения остаются принятыми ограничениями, а не исправлениями.

**Текущий срез .00035:** [issue-00333](../../issues/closed/issue-00333.md#implementation-00035), 621 источник. Обновлены контейнерные пути и связанные контракты Item/ритуала; новые модули описаны в `data/{entities,relations,processes}/issue-00333.jsonl`. Статические/изолированные результаты — в [журнале](review-log.md); [Игровая приёмка](../../issues/closed/issue-00333.md#acceptance-00035) проведена; два наблюдения Б13/Б15 в .00036 приняты пользователем как [известные ограничения](../../documentation/known-limitations.md). Фактические пределы проверки сохранены. Датированные прежние показатели ниже относятся к указанным этапам.
