...
**Актуализация .00035:** затронутые контейнерные/ритуальные сущности, отношения, процессы и адресные тесты обновлены по [issue-00333](../../issues/open/issue-00333.md#implementation-00035). Описание ниже — исторический результат исходной порции; прежние отсутствие каскада/несогласованные записи контейнера и потеря UUID строки ритуала больше не описывают текущий код. Игровая приёмка нового поведения ожидается.
...
Прочитаны поздние R003-12, R006-12/13/14/15/17, R013-03/08. Основные [issue-00156](../../issues/potential/issue-00156.md)–[issue-00163](../../issues/potential/issue-00163.md) и [issue-00168](../../issues/potential/issue-00168.md) сохраняют даты и фасады прежних опытов. В этой задаче — чтение кода/графа; повторного исполнения JS/мира/БД нет. Новые issues не создавались, статусы/тексты аудита не менялись.
